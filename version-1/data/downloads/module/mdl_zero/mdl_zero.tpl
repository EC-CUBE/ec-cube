							...
							<tr>
								...
								<td bgcolor="#cccccc" >
									...
									<table width="442" border="0" cellspacing="1" cellpadding="8" summary=" ">
										<tr class="fs12n">
											<td bgcolor="#ffffff">
												ゼロ決済モジュールをご利用頂く為には、ユーザ様ご自身で
												株式会社ゼロ様とご契約を行っていただく必要があります。 <br/>
												お申し込みにつきましては、下記のページから、お申し込みを行って下さい。<br/><br/>
												<a href="#" onClick="win_open('http://www.zeroweb.co.jp/')" > ＞＞ ゼロ決済システムについて</a><br/>
												<a href="#" onClick="win_open('http://wiki.ec-cube.net/')" > ＞＞ ゼロ決済モジュール設定マニュアル</a>
											</td>
										</tr>
									</table>
									...
									<table width="442" border="0" cellspacing="1" cellpadding="8" summary=" ">
										<tr class="fs12n"><!--{assign var=key value="pc"}-->
											<td bgcolor="#f3f3f3" colspan="2"><input type="checkbox" name="<!--{$key}-->" style="<!--{$arrErr[$key]|sfGetErrorColor}-->" value="1" id="<!--{$key}-->" onClick="lfnChangeEnable(this);" <!--{if $arrForm[$key].value != ""}-->checked<!--{/if}-->><label for="<!--{$key}-->">PC版</label></td>
										</tr>
										<tr class="fs12n">
										...
										<tr class="fs12n">
											<td width="" bgcolor="#f3f3f3">番組コード<span class="red"> ※</span></td>
											<td width="300" bgcolor="#ffffff">
									...
									<table width="442" border="0" cellspacing="1" cellpadding="8" summary=" ">
										<tr class="fs12n"><!--{assign var=key value="mobile"}-->
											<td bgcolor="#f3f3f3" colspan="2"><input type="checkbox" name="<!--{$key}-->" style="<!--{$arrErr[$key]|sfGetErrorColor}-->" value="1" id="<!--{$key}-->" onClick="lfnChangeEnable(this);" <!--{if $arrForm[$key].value != ""}-->checked<!--{/if}-->><label for="<!--{$key}-->">携帯版</label></td>
										</tr>
										<tr class="fs12n">
											<td width="" bgcolor="#f3f3f3">加盟店コード<span class="red"> ※</span></td>
											<td width="300" bgcolor="#ffffff">
