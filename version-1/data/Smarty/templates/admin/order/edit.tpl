			...
			<tr>
				...
				<table width="706" border="0" cellspacing="0" cellpadding="0" summary=" ">
					...
					<tr>
						...
						<!--{* サイバーソース連携用 *}-->
						<!--{assign var=path value=`$smarty.const.MODULE_PATH`mdl_cybs/mdl_cybs_order_edit.tpl}-->
						<!--{if file_exists($path)}-->
							<!--{include file=$path}-->
						<!--{/if}-->
						...
						<table width="678" border="0" cellspacing="1" cellpadding="8" summary=" ">
							...
							<td bgcolor="#ffffff">
							  <input type="button" name="address_input" value="帳票の作成" onclick="win02('../pdf.d/input.php?order_id=<!--{$arrDisp.order_id}-->','pdf_input','500','650'); return false;" />
							</td>
							</tr>
						</table>
