...
*}-->
<!--{strip}-->
<body id="page_<!--{$smarty.server.PHP_SELF|basename|replace:".php":""}-->" class="<!--{$tpl_page_class_name|h}-->
<!--{" "}-->colnum<!--{$tpl_column_num|h}-->
<!--{if $tpl_column_num == 2}-->
	<!--{" "}--><!--{if $arrPageLayout.LeftNavi|@count == 0}-->main_left<!--{else}-->main_right<!--{/if}-->
<!--{/if}-->
">
	<!--{$GLOBAL_ERR}-->
	...
	<div id="top" class="frame_outer">
		...
		<div id="main_content">
			...
			<!--{if $arrPageLayout.LeftNavi|@count > 0}-->
				<div id="leftcolumn" class="side_column sidebar1">
					<!--{* ▼左ナビ *}-->
