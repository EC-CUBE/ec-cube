						...
						<td bgcolor="#cccccc">
							...
							<table width="678" border="0" cellspacing="1" cellpadding="8" summary=" " bgcolor="#cccccc">
								...
								<tr class="fs12n">
									...
									<input type="text" class="box60" name="reviewer_url" value="<!--{$arrReview.reviewer_url|escape}-->" style="<!--{$arrErr.reviewer_url|sfGetErrorColor}-->" size=30><span class="red12"></td>
								</tr>
								<tr class="fs12n">
