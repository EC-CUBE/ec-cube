							...
							<tr>
								...
								<table width="680" border="0" cellspacing="0" cellpadding="0" summary=" ">
									...
									<tr>
										...
										<td bgcolor="#636469" width="680" class="fs14n"><span class="white"><!--コンテンツタイトル-->メールテンプレート一覧</span></td>
				...
				<tr>
					...
					<table width="680" border="0" cellspacing="1" cellpadding="5" summary=" ">
						<tr bgcolor="#636469" align="center" class="fs12n">
							...
							<td width="60" ><span class="white">プレビュー</span></td>
						</tr>
						<!--{section name=data loop=$mail_list}-->
							...
							<tr bgcolor="#ffffff" class="fs12n">
								...
								<td align="center" ><span class="icon_edit"><a href="#" onclick="return fnEdit('<!--{$mail_list[data].template_code|escape}-->');">編集</a></span></td>
								<td align="center" ><span class="icon_delete"><a href="#" onclick="return fnDelete('<!--{$mail_list[data].template_code|escape}-->');">削除</a></span></td>
								<td align="center" ><span class="icon_delete"><a href="#" onclick="return fnDelete('<!--{$mail_list[data].template_code|escape}-->');">削除</a></span></td>
							</tr>
							<!--顧客<!--{$smarty.section.data.iteration}-->-->
						<!--{/section}-->
