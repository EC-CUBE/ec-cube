							...
							<tr>
								...
								<table width="678" border="0" cellspacing="0" cellpadding="0" summary=" ">
									...
									<tr>
										...
										<td bgcolor="#636469" width="638" class="fs14n"><span class="white"><!--コンテンツタイトル-->配信設定：配信内容設定</span><!--{if $arrBlaynEngine.now_version > 0 && $arrBlaynEngine.blayn_ip > 0}--></td><td align="right"><img src="<!--{$smarty.const.URL_DIR}-->img/contents/blayn_icon.jpg"><!--{/if}--></td>
