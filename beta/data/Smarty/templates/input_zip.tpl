...
<body bgcolor="#ffe9e6" text="#555555" link="#3a75af" vlink="#3a75af" alink="#3a75af" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onLoad="preLoadImg('<!--{$smarty.const.URL_DIR}-->'); <!--{$tpl_onload}--> <!--{$tpl_start}-->">
<noscript>
...
<table width="500" border="0" cellspacing="0" cellpadding="0" summary=" ">
	...
	<tr>
		...
		<table width="460" border="0" cellspacing="0" cellpadding="0" summary=" ">
			<tr><td height="15"></td></tr>
			<tr>
				<td><img src="<!--{$smarty.const.URL_DIR}-->img/common/zip_title.jpg" width="460" height="40" alt="½»½ê¸¡º÷"></td>
			</tr>
			...
			<tr><td height="20"></td></tr>
			<tr>
				<td align="center"><a href="javascript:window.close()" onmouseover="chgImg('<!--{$smarty.const.URL_DIR}-->img/common/b_close_on.gif','b_close');" onmouseout="chgImg('<!--{$smarty.const.URL_DIR}-->img/common/b_close.gif','b_close');"><img src="<!--{$smarty.const.URL_DIR}-->img/common/b_close.gif" width="140" height="30" alt="ÊÄ¤¸¤ë" border="0" name="b_close"></a></td>
			</tr>
