...
class LoggerLoggingEvent {
    ...
    * @param Logger &$logger The category of this event.
    * @param integer $level The level of this event.
    * @param mixed $message  The message of this event.
    * @param integer $timeStamp the timestamp of this logging event.
    * @param integer $timeStampMSecs the timestamp milliseconds of this logging event.
    */
