...
class CustomerControllerTest extends AbstractAdminWebTestCase
{
    ...
    public function testRoutingAdminCustomerCustomer()
    {
        $this->client->request('GET',
            $this->app->url('admin_customer')
        );
        $this->assertTrue($this->client->getResponse()->isSuccessful());
    }

    public function testRoutingAdminCustomerCustomerDelete()
    {
        // before
        ...
        $this->client->request('POST',
            $this->app->url('admin_customer_delete', array('id' => $test_customer_id))
        );
        $this->assertTrue($this->client->getResponse()->isSuccessful());
    ...
    public function testRoutingAdminCustomerCustomerResend()
    {
        ...
        // main
        $redirectUrl = $this->app->url('admin_customer');
        $this->client->request('POST',
            $this->app->url('admin_customer_resend', array('id' => $test_customer_id))
        );
