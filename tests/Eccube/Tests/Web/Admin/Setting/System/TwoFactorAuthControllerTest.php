...
class TwoFactorAuthControllerTest extends AbstractAdminWebTestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->twoFactorAuthService = self::$container->get(TwoFactorAuthService::class);
    ...
    public function testAuthSuccessWithRegisteredUser()
    {
        ...
        // フォームを取得して値を設定し送信
        $form = $crawler->selectButton('認証')->form();
        $form['admin_two_factor_auth[device_token]'] = (string) $validCode;
    ...
    public function testAuthFailureWithInvalidCode()
    {
        ...
        // フォームを取得して間違ったコードを設定し送信
        $form = $crawler->selectButton('認証')->form();
        $form['admin_two_factor_auth[device_token]'] = '000000'; // 無効なコード
