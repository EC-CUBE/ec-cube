...
class FormExtensionAutoWiringTest extends AbstractAutowiringTest
{
    ...
    {
        return new FormExtensionAutoWiring([__DIR__.'/../Test']);
    }
    ...
    public function testFormExtension()
    {
        ...
        self::assertInstanceOf(FormExtensionClass::class, $this->container[FormExtensionClass::class]);
    }
}
