...
class FormTypeAutoWiringTest extends AbstractAutowiringTest
{
    ...
    {
        return new FormTypeAutoWiring([__DIR__.'/../Test']);
    }
    ...
    public function testFormType()
    {
        ...
        self::assertInstanceOf(FormTypeClass::class, $this->container[FormTypeClass::class]);
    }
}
