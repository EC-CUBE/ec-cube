...
class MailTypeTest extends \Eccube\Tests\Form\Type\AbstractTypeTestCase
{
...
public function testInvalidTemplate_Blank()
{
    ...
    public function testInvalidHeader_NotBlank()
    {
    ...
    public function testInvalidHeader_MaxLengthValid()
    {
        $header = str_repeat('S', $this->app['config']['ltext_len']);
    ...
    public function testInvalidFooter_MaxLengthValid()
    {
        $footer = str_repeat('S', $this->app['config']['ltext_len']);
