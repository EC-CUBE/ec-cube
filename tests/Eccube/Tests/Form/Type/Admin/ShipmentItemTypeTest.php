...
/**
 * Class ShipmentItemTypeTest
 * @package Eccube\Tests\Form\Type\Admin
 */
class ShipmentItemTypeTest extends AbstractTypeTestCase
{
    ...
    public function setUp()
    {
        ...
        $this->form = $this->app['form.factory']
            ->createBuilder('shipment_item', null, array(
