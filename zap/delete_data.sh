...
delete from dtb_class_category where class_name_id in (select id from dtb_class_name where create_date between now() - interval '24:00' and now() - interval '00:10:00');
delete from dtb_class_name where create_date between now() - interval '24:00' and now() - interval '00:10:00';
