...
define ("MELMAGA_SEND_BLAYN", false);                   // メルマガ配信するとき、ブレインSMTPを経由する。（false:経由しない、true:経由する）
define ("MELMAGA_BATCH_MODE", true);					// メイルマガジンバッチモード(true:バッチで送信する ※要cron設定、false:リアルタイムで送信する)
