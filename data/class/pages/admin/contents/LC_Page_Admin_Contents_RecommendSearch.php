...
class LC_Page_Admin_Contents_RecommendSearch extends LC_Page_Admin_Ex {
    ...
    function lfInitParam(&$objFormParam) {
        $objFormParam->addParam(t('c_Product ID_01'), 'search_name', LTEXT_LEN, 'KVa', array('MAX_LENGTH_CHECK'));
        $objFormParam->addParam(t('c_Product ID_01'), 'search_category_id', INT_LEN, 'n', array('MAX_LENGTH_CHECK','NUM_CHECK'));
