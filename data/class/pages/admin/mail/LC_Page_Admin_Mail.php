        ...
        case 'template':
            ...
            if (empty($this->arrErr)) {
                ...
                if ( $this->list_data["mail_method"] == 3) {
                    ...
                    $objTemplate->arrFile = $objUpFile->getFormFileList(IMAGE_TEMP_URL_PATH, IMAGE_SAVE_URL_PATH);
                ...
                if ( $_POST['mode'] == 'regist_confirm'){
                    ...
                    if (MELMAGA_SEND) {
                        if (MELMAGA_BATCH_MODE) {
                            ...
                            $this->objDisplay->redirect('/' . ADMIN_DIR . 'mail/sendmail.php', array('mode' => 'now', 'send_id' => $sendId));
                        }
                        exit;
                    } else {
