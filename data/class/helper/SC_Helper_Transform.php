...
class SC_Helper_Transform {
    ...
    public function __construct($source) {
        ...
        if (!in_array($encoding, array('ASCII', 'UTF-8'))) {
            ...
            $msg = t('SC_Helper_Transform_002', array('T_FIELD' => $encoding));
    ...
    public function getHTML() {
        if (count($this->arrErr)) {
            ...
            // エラー画面表示
            SC_Utils_Ex::sfDispSiteError(FREE_ERROR_MSG, '', true, t('c_Template operation failed. T_FIELD_01', array('T_FIELD' => $err_msg)));
