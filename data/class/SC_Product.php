...
__EOS__;
    ...
    function setProductsClassByProductIds($arrProductId, $has_deleted = false) {
        ...
        foreach ($arrProductId as $productId) {
            ...
            $classCats1 = array();
            $classCats1['__unselected'] = SC_I18n_Ex::t('SC_PRODUCT_UNSELECTED');
            ...
            $classCategories['__unselected']['__unselected']['name'] = SC_I18n_Ex::t('SC_PRODUCT_UNSELECTED');
            ...
            foreach ($arrProductClasses as $arrProductsClass) {
                ...
                $arrClassCats2['name'] = $arrProductsClass['classcategory_name2'] . ($stock_find_class ? '' : ' '.SC_I18n_Ex::t('SC_PRODUCT_SOLDOUT'));
                ...
                if (!in_array($classcat_id1, $classCats1)) {
                    $classCats1[$classcategory_id1] = $arrProductsClass['classcategory_name1']
                        . ($classcategory_id2 == 0 && !$stock_find_class ? ' '.SC_I18n_Ex::t('SC_PRODUCT_SOLDOUT') : '');
                }
                ...
                $classCategories[$classcategory_id1]['#'] = array(
                    'classcategory_id2' => '',
                    'name' => SC_I18n_Ex::t('SC_PRODUCT_UNSELECTED'),
                );
