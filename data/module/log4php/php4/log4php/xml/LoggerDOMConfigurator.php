...
/*                
                if (isset($attribs['THRESHOLD']) and 
                    strtolower($attribs['THRESHOLD']) != 'null' and    
                    LoggerLevel::isLevel($attribs['THRESHOLD']) )
                {
                    $this->repository->setThreshold(LoggerLevel::toCode($attribs['THRESHOLD']));
                }
*/
            ...
            case LOG4PHP_LOGGER_DOM_CONFIGURATOR_XMLNS.':APPENDER_REF':
                ...
                if (isset($attribs['REF']) and !empty($attribs['REF'])) {
                    ...
                    LoggerLog::debug("LoggerDOMConfigurator::tagOpen() APPENDER_REF ref='$appenderName'");        
                    ...
                    if ($appender !== null) {
                        ...
                        LoggerLog::warn("LoggerDOMConfigurator::tagOpen() APPENDER_REF ref '$appenderName' points to a null appender");
                    }
                } else {
                    LoggerLog::warn("LoggerDOMConfigurator::tagOpen() APPENDER_REF ref not set or empty");            
                }
                break;
