...
namespace Eccube\Common\DB;

use Eccube\Common\Query;
use Eccube\Common\DB\DBFactory\MysqlDBFactory;
use Eccube\Common\DB\DBFactory\PgsqlDBFactory;
...
class DBFactory
{
     ...
     * @return \Eccube\Common\DB\DBFactory  DBFactory インスタンス
     */
