...
namespace Eccube\Common\DB\DBFactory;

use Eccube\Common\Query;
use Eccube\Common\DB\DBFactory;
 ...
 * 必ず \Eccube\Common\DB\DBFactory クラスを経由してインスタンス化する.
 * また, \Eccube\Common\DB\DBFactory クラスの関数を必ずオーバーライドしている必要がある.
 *
 * @package DB
