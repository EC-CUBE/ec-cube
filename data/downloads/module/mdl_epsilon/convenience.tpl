			...
			<tr>
				...
				<table width="700" border="0" cellspacing="1" cellpadding="10" summary=" ">
					<tr>
						...
						<td width="80%" bgcolor="#ffffff" class="fs12n"><span class="red"><!--{$arrErr.order_kana01}--><!--{$arrErr.order_kana02}--></span>セイ&nbsp;<input type="text" name="order_kana01" size="15" class="box15" value="<!--{$arrForm.order_kana01.value|escape}-->" maxlength="<!--{$smarty.const.STEXT_LEN}-->" style="<!--{$arrErr.order_kana01|sfGetErrorColor}-->; ime-mode: active;" />　メイ&nbsp;<input type="text" name="order_kana02" size="15" class="box15" value="<!--{$arrForm.order_kana02.value|escape}-->" maxlength="<!--{$smarty.const.STEXT_LEN}-->" style="<!--{$arrErr.order_kana02|sfGetErrorColor}-->; ime-mode: active;" /></td>
					</tr>
					<tr>
						<td bgcolor="#f0f0f0" class="fs12n">電話番号<span class="red">※</span></td>
						<td bgcolor="#ffffff" class="fs12n"><span class="red"><!--{$arrErr.order_tel01}--><!--{$arrErr.order_tel02}--><!--{$arrErr.order_tel03}--></span><input type="text" name="order_tel01" size="6" value="<!--{$arrForm.order_tel01.value|escape}-->" maxlength="<!--{$smarty.const.TEL_ITEM_LEN}-->" style="<!--{$arrErr.order_tel01|sfGetErrorColor}-->; ime-mode: disabled;" />&nbsp;-&nbsp;<input type="text" name="order_tel02" size="6" value="<!--{$arrForm.order_tel02.value|escape}-->" maxlength="<!--{$smarty.const.TEL_ITEM_LEN}-->" style="<!--{$arrErr.order_tel01|sfGetErrorColor}-->; ime-mode: disabled;" />&nbsp;-&nbsp;<input type="text" name="order_tel03" size="6" value="<!--{$arrForm.order_tel03.value|escape}-->" maxlength="<!--{$smarty.const.TEL_ITEM_LEN}-->" style="<!--{$arrErr.order_tel01|sfGetErrorColor}-->; ime-mode: disabled;" /></td>
					</tr>				
				</table>
				<!--お支払方法・お届け時間の指定・その他お問い合わせここまで-->
				</td>
