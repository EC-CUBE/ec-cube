		...
		<table width="700" border="0" cellspacing="0" cellpadding="0" summary=" ">
			...
			<tr>
				...
				<table width="700" border="0" cellspacing="1" cellpadding="10" summary=" ">
					<tr>
						<td width="50" align="center" bgcolor="#f0f0f0" class="fs12">選択</td>
						<td width="507" bgcolor="#f0f0f0" class="fs12">コンビニの種類</td>
					</tr>
					<!--{foreach key=key item=item from=$arrConv}-->
					<tr bgcolor="#ffffff" class="fs12n">
						<label for="<!--{$key}-->">
							<td align="center"><input type="radio" name="convenience" id="<!--{$key}-->" value="<!--{$key}-->" style="<!--{$arrErr.convenience|sfGetErrorColor}-->"></td>
