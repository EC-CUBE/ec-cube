							...
							<tr>
								...
								<td bgcolor="#cccccc">
									...
									<table width="440" border="0" cellspacing="1" cellpadding="8" summary=" ">
										<tr class="fs12n">
											<td width="90" bgcolor="#f3f3f3">ログインURL<span class="red">※</span></td>
										...
										<tr class="fs12n">
											<td width="90" bgcolor="#f3f3f3">EBiS引数<span class="red">※</span></td>
											<td width="337" bgcolor="#ffffff">
										...
										<tr class="fs12n">
											<td width="90" bgcolor="#f3f3f3">顧客ID</td>
											<td width="337" bgcolor="#ffffff">
											<!--{* 顧客ID、ebisタグでは"m1id" *}-->
										...
										<tr class="fs12n">
											<td width="90" bgcolor="#f3f3f3">購入金額</td>
											<td width="337" bgcolor="#ffffff">
											<!--{* 購入金額、ebisタグでは"a1id" *}-->
										...
										<tr class="fs12n">
											...
											<td width="90" bgcolor="#f3f3f3">任意項目<!--{$index}--></td>
											<td width="337" bgcolor="#ffffff">
											<!--{* 任意項目、ebisタグではo1id, o2id, o3id... *}-->
									...
									<table width="440" border="0" cellspacing="1" cellpadding="8" summary=" ">
										<tr class="fs12n">
											...
											<input type="button" onClick="fnModeSubmit('csv','','');document.form1.mode.value='edit';return false;" value="ページ登録CSVをダウンロード">
											</td>
										</tr>
									</table>
