...
function lfInitParam($objFormParam) {
    $objFormParam->addParam("発行者ID", "pubid", STEXT_LEN, "KVa", array("EXIST_CHECK", "MAX_LENGTH_CHECK", "SPTAB_CHECK"));	
    $objFormParam->addParam("パスワード", "pw", STEXT_LEN, "KVa", array("EXIST_CHECK", "MAX_LENGTH_CHECK", "SPTAB_CHECK"));	
    $objFormParam->addParam("メルマガID", "magid", STEXT_LEN, "KVa", array("EXIST_CHECK", "MAX_LENGTH_CHECK", "SPTAB_CHECK"));	
    return $objFormParam;
}
