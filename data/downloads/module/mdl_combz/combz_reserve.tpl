								...
								<td bgcolor="#cccccc" >
									<table width="442" border="0" cellspacing="0" cellpadding="0" summary=" ">
										...
										<tr>
											...
											<td bgcolor="#636469" width="402" class="fs14n"><span class="white"><!--コンテンツタイトル-->コンビーズ予約発行</span></td>
									...
									<table width="442" border="0" cellspacing="1" cellpadding="5" summary=" ">
										...
										<tr class="fs12n">
											<td width="" bgcolor="#f3f3f3">パスワード<span class="red"> ※</span></td>
											<td width="300" bgcolor="#ffffff">
										...
										<tr class="fs12n">
											<td width="" bgcolor="#f3f3f3">メルマガID<span class="red"> ※</span></td>
											<td width="300" bgcolor="#ffffff">
										...
										<tr class="fs12n">
											<td width="" bgcolor="#f3f3f3">メルマガ件名<span class="red"> ※</span></td>
											<td width="300" bgcolor="#ffffff">
										...
										<tr class="fs12n">
											<td width="" bgcolor="#f3f3f3">メルマガ本文<span class="red"> ※</span></td>
											<td width="300" bgcolor="#ffffff">
