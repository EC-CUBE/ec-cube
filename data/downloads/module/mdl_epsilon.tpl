								...
								<td bgcolor="#cccccc">
									...
									<table width="440" border="0" cellspacing="1" cellpadding="8" summary=" ">
										<tr class="fs12n">
											...
											<input type="text" name="<!--{$key}-->" style="<!--{$arrErr[$key]|sfGetErrorColor}-->" value="<!--{$arrForm[$key].value}-->" class="box8">
											</td>
										</tr>	
										<tr class="fs12n">
											...
											<span class="red12"><!--{$arrErr[$key]}--></span>
											<!--{html_checkboxes_ex name="$key" options=$arrPayment style=$arrErr[$key]|sfGetErrorColor}-->
											</td>
										</tr>
										<tr class="fs12n">
