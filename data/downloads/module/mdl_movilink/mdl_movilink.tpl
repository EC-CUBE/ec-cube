							...
							<tr>
								...
								<td bgcolor="#cccccc" >
									...
									<table width="442" border="0" cellspacing="1" cellpadding="8" summary=" ">
										<tr class="fs12n">
											<td bgcolor="#ffffff">
												ゼウス決済モジュールをご利用頂く為には、ユーザ様ご自身で
												株式会社ゼウス様とご契約を行っていただく必要があります。 <br/>
												お申し込みにつきましては、下記のページから、お申し込みを行って下さい。<br/><br/>
												<a href="#" onClick="win_open('http://www.cardservice.co.jp/')" > ＞＞ ゼウス決済システムについて</a>
											</td>
										</tr>
									</table>
									...
									<table width="442" border="0" cellspacing="1" cellpadding="8" summary=" ">
										...
										<tr class="fs12n">
											<td width="" bgcolor="#f3f3f3">ECサイトID<span class="red"> ※</span></td>
										...
										<tr>
											<td bgcolor="#f2f1ec" class="fs12n">ステータス<span class="red"> ※</span></td>
											<td bgcolor="#ffffff" class="fs12n"><input type="radio" name="status" value="1" <!--{if $arrForm.status.value == "1"}-->checked<!--{/if}-->/>有効　<input type="radio" name="status" value="2" <!--{if $arrForm.status.value == "2"}-->checked<!--{/if}--> />無効</td>
										</tr>
									</table>
