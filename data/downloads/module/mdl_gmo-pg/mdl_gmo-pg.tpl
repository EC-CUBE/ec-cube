							...
							<tr>
								...
								<td bgcolor="#cccccc" >
									...
									<table width="442" border="0" cellspacing="1" cellpadding="8" summary=" ">
										<tr class="fs12n">
											<td bgcolor="#ffffff">
												ＧＭＯペイメントゲートウェイ決済モジュールをご利用頂く為には、ユーザ様ご自身で
												ＧＭＯペイメントゲートウェイ株式会社様とご契約を行っていただく必要があります。 <br/>
												お申し込みにつきましては、下記のページから、お申し込みを行って下さい。<br/><br/>
												<a href="http://www.gmo-pg.com/" target="_blank"> ＞＞ ＧＭＯペイメントゲートウェイ決済システムについて</a>
											</td>
										</tr>
									</table>
									...
									<table width="442" border="0" cellspacing="1" cellpadding="8" summary=" ">
										...
										<tr class="fs12n">
											...
											<!--{assign var=key value="gmo_shopid"}-->
										...
										<tr class="fs12n">
											<td width="" bgcolor="#f3f3f3">ショップパスワード<span class="red"> ※</span></td>
											<td width="300" bgcolor="#ffffff">
											<!--{assign var=key value="gmo_shoppass"}-->
											<span class="red12"><!--{$arrErr[$key]}--></span>
											<input type="text" name="<!--{$key}-->" style="ime-mode:disabled; <!--{$arrErr[$key]|sfGetErrorColor}-->" value="<!--{$arrForm[$key].value}-->" class="box20" maxlength="<!--{$arrForm[$key].length}-->">
											</td>
										</tr>
										<tr class="fs12n">
											<td width="" bgcolor="#f3f3f3">店舗管理番号<span class="red"> ※</span></td>
											<td width="300" bgcolor="#ffffff">
											<!--{assign var=key value="gmo_tenantno"}-->
											<span class="red12"><!--{$arrErr[$key]}--></span>
											<input type="text" name="<!--{$key}-->" style="ime-mode:disabled; <!--{$arrErr[$key]|sfGetErrorColor}-->" value="<!--{$arrForm[$key].value}-->" class="box20" maxlength="<!--{$arrForm[$key].length}-->">
											</td>
										</tr>
