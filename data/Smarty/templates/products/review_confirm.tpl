...
<table width="550" border="0" cellspacing="0" cellpadding="0" summary=" ">
	...
	<tr>
		...
		<!--{/foreach}-->
			...
			<tr>
				<td align="center">
					<input type="image" onclick=" mode.value='return';" onmouseover="chgImgImageSubmit('/img/common/b_back_on.gif',this)" onmouseout="chgImgImageSubmit('/img/common/b_back.gif',this)" src="/img/common/b_back.gif" width="150" height="30" alt="戻る"  name="back" id="back" />
					<input type="image" onmouseover="chgImgImageSubmit('/img/common/b_send_on.gif',this)" onmouseout="chgImgImageSubmit('/img/common/b_send.gif',this)" src="/img/common/b_send.gif" width="150" height="30" alt="送信"  name="send" id="send" />
				</td>
			</tr>
