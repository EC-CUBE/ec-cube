					...
					<tr valign="top">
						...
						<table width="280" border="0" cellspacing="0" cellpadding="0" summary=" ">
							...
							<!--{if $tpl_stock_find}-->
								...
								<!--{/if}-->
								<tr>
									<td class="fs12"><span class="redst"><!--{$arrErr.quantity}--></span><br/><!--{/if}--><img src="../img/common/arrow_gray.gif" width="15" height="10" alt=""><!--{if $arrErr.quantity != ""}--><strong>個　数</strong>
