	...
	<tr>
		...
		<table cellspacing="0" cellpadding="0" summary=" ">
			<tr valign="top">
					...
					<tr valign="top">
						...
						<table width="290" border="0" cellspacing="0" cellpadding="0" summary=" ">	
							...
							<tr>
								<td>
								<!--{if $arrProduct.main_large_image != ""}-->
									<!--★拡大する★--><a href="<!--{$smarty.server.PHP_SELF}-->" onclick="win01('./detail_image.php?product_id=<!--{$arrProduct.product_id}-->&image=main_large_image<!--{if $smarty.get.admin == 'on'}-->&admin=on<!--{/if}-->','detail_image', '560', '580'); return false;" target="_blank"><img src="/img/products/b_expansion.gif" width="94" height="13" alt="画像を拡大する" /></a>
								<!--{/if}-->
								</td>
							</tr>
						</table>		
				...
				<table width="580" border="0" cellspacing="0" cellpadding="0" summary=" ">
					<tr>
						<td colspan=3 height="20"><img src="/img/products/title_recommend.jpg" width="580" height="1" alt="オススメ商品" /></td>
					</tr>
