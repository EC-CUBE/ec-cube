...
<table width="550" border="0" cellspacing="0" cellpadding="0" summary=" ">
	...
	<tr>
		...
		<table width="500" border="0" cellspacing="0" cellpadding="0" summary=" ">
			...
			<tr><td height="15"></td></tr>
			<tr>
				<td align="center"><a href="javascript:window.close()" onmouseover="chgImg('/img/common/b_close_on.gif','b_close');" onmouseout="chgImg('/img/common/b_close.gif','b_close');"><img src="<!--{$smarty.const.URL_DIR}-->img/common/b_close.gif" width="150" height="30" alt="閉じる" border="0" name="b_close"></a></td>
			</tr>
