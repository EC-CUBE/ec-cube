		...
		<table width="500" border="0" cellspacing="0" cellpadding="0" summary=" ">
			...
			<tr>
				...
				<table width="490" border="0" cellspacing="0" cellpadding="0" summary=" ">
					...
					<tr>
						<td align="center" height="200" bgcolor="#ffffff"><span class="fs14"><span class="redst">登録が完了しました。ご利用ありがとうございました。</span></span><br>
						<span class="fs12">弊社にて登録内容を確認させていただき、ホームページに反映させたいと思います。<br>
						今しばらくお待ちくださいませ。</span></td>
					</tr>
					<tr><td height="5"></td></tr>
				</table>
				</td>
			...
			<tr><td height="15"></td></tr>
			<tr>
				<td align="center"><a href="javascript:window.close()" onmouseover="chgImg('<!--{$smarty.const.URL_DIR}-->img/common/b_close_on.gif','b_close');" onmouseout="chgImg('<!--{$smarty.const.URL_DIR}-->img/common/b_close.gif','b_close');"><img src="<!--{$smarty.const.URL_DIR}-->img/common/b_close.gif" width="150" height="30" alt="閉じる" border="0" name="b_close"></a></td>
			</tr>
