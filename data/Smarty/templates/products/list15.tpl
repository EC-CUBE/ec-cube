						...
						<table width="420" border="0" cellspacing="0" cellpadding="0" summary=" ">
							...
							<tr>
								...
								<table width="440" border="0" cellspacing="0" cellpadding="0" summary=" ">
									...
									<tr>
										<td class="fs14"><!--★商品名★--><div id="title"><span class="fs14st"><a href="<!--{$smarty.const.DETAIL_P_HTML}--><!--{$arrProducts[cnt].product_id}-->"><!--商品名--><strong><!--{$arrProducts[cnt].name|escape}--></strong></a></span></div></td>
									</tr>
									<tr><td height="5"></td></tr>
								</table>
								</td>
							...
							<tr>
								<td colspan="2" class="fs12"><!--★コメント★--><!--{$arrProducts[cnt].main_list_comment|escape}--></td>
							</tr>
							<tr><td height="8"></td></tr>
							<tr>
								<td>
