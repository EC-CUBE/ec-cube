				...
				<table width="700" border="0" cellspacing="1" cellpadding="10" summary=" ">
					...
					<!--{section name=cnt loop=$arrAddr}-->		
						<tr class="fs12" bgcolor="#ffffff">
							...
							<td align="center">
								<!--{if !$smarty.section.cnt.first}--><a href="<!--{$smarty.const.URL_DIR}-->mypage/delivery_addr.php" onclick="win02('<!--{$smarty.server.URL_DIR}-->mypage/delivery_addr.php?page=<!--{$smarty.server.PHP_SELF|escape}-->&other_deliv_id=<!--{$arrAddr[cnt].other_deliv_id}-->','new_deiv','600','640'); return false;">変更</a><!--{/if}-->
							</td>
							<td align="center">
