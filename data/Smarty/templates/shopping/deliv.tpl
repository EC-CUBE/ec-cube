...
<table width="760" border="0" cellspacing="0" cellpadding="0" summary=" ">
	<tr>
		...
		<input type="hidden" name="other_deliv_id" value="">
			...
			<tr>
				<td>
					<a href="/mypage/delivery_addr.php" onclick="win02('/mypage/delivery_addr.php?page=<!--{$smarty.server.PHP_SELF}-->','new_deiv','680','600'); return false;" onmouseover="chgImg('/img/common/newadress_on.gif','addition');" onmouseout="chgImg('/img/common/newadress.gif','addition');"><img src="/img/common/newadress.gif" width="172" height="20" alt="新しいお届け先を追加する" name="addition" id="addition" /></a>
				</td>
			</tr>
