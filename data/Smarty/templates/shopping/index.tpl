				...
				<table width="630" border="0" cellspacing="0" cellpadding="0" summary=" ">
					...
					<tr>
						...
						<input type="hidden" name="mode" value="login">
							...
							<tr>
								<td class="fs10">パスワードを忘れた方は<a href="/forget/index.php" onclick="win01('/forgot/index.php','forget','580','320'); return false;" target="_blank">こちら</a>からパスワードの再発行を行ってください。<br>
								...
								<table width="490" border="0" cellspacing="0" cellpadding="0" summary=" ">
									...
									<tr>
										<td align="center">
											...
											<input type="image" onmouseover="chgImgImageSubmit('/img/login/b_buystep_on.gif',this)" onmouseout="chgImgImageSubmit('/img/login/b_buystep.gif',this)" src="/img/login/b_buystep.gif" width="130" height="30" alt="購入手続きへ" name="buystep" id="buystep" />
										</td>
									</tr>
									<tr><td height="20"></td></tr>
								</table>
