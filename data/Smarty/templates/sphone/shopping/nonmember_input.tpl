        ...
        <tr>
          ...
          <td>
           ...
           <!--{assign var=key2 value="deliv_zip02"}-->
            ...
            <p class="zipimg"><a href="<!--{$smarty.const.ROOT_URLPATH}-->address/<!--{$smarty.const.DIR_INDEX_URL}-->" onclick="fnCallAddress('<!--{$smarty.const.INPUT_ZIP_URLPATH}-->', 'deliv_zip01', 'deliv_zip02', 'deliv_pref', 'deliv_addr01'); return false;" target="_blank"><img src="<!--{$TPL_URLPATH}-->img/button/btn_address_input.gif" width="86" height="20" alt="住所自動入力" /></a>
              <span class="mini">&nbsp;<br />
              郵便番号を入力後、クリックしてください。</span></p>
          </td>
        </tr>
