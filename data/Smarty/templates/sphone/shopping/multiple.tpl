            ...
            <!--{section name=line loop=$arrForm.line_of_num.value}-->
                ...
                <div class="formBox">
                    ...
                    <div class="delivitemBox">
                        <img src="<!--{$smarty.const.IMAGE_SAVE_URLPATH}--><!--{$arrForm.main_list_image.value[$index]|sfNoImageMainList|h}-->" style="max-width: 80px;max-height: 80;" alt="<!--{$arrForm.name.value[$index]|h}-->" class="photoL" /></a>
