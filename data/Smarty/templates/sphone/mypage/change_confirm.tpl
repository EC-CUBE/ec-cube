...
<section id="mypagecolumn">
       ...
       <dl class="form_entry">
          ...
          <dt>住所</dt>
           <dd>〒<!--{$arrForm.zip01}-->-<!--{$arrForm.zip02}--><br />
               <!--{$arrPref[$arrForm.pref]}--><!--{$arrForm.addr01|h}--><!--{$arrForm.addr02|h}--></dd>

          <dt>電話番号</dt>
           <dd><!--{$arrForm.tel01|h}-->-<!--{$arrForm.tel02}-->-<!--{$arrForm.tel03}--></dd>

          <dt>FAX</dt>
           <dd><!--{if strlen($arrForm.fax01) > 0}--><!--{$arrForm.fax01}-->-<!--{$arrForm.fax02}-->-<!--{$arrForm.fax03}-->
                                                <!--{else}-->
                                                            未登録
                                                            <!--{/if}--></dd>
          ...
          <dt>携帯メールアドレス</dt>
           <dd><!--{if strlen($arrForm.email_mobile) > 0}--><a href="<!--{$arrForm.email_mobile|escape:'hex'}-->" rel="external"><!--{$arrForm.email_mobile|escape:'hexentity'}--></a>
               <!--{else}-->
               未登録
               <!--{/if}--></dd>
          ...
          <dt>生年月日</dt>
           <dd><!--{if strlen($arrForm.year) > 0 && strlen($arrForm.month) > 0 && strlen($arrForm.day) > 0}--><!--{$arrForm.year|h}-->年<!--{$arrForm.month|h}-->月<!--{$arrForm.day|h}-->日
                                                <!--{else}-->
                                                            未登録
                                                            <!--{/if}--></dd>
          ...
          <dt>パスワードを忘れた時のヒント</dt>
           <dd>質問：&nbsp;<!--{$arrReminder[$arrForm.reminder]|h}--><br />
               答え：&nbsp;<!--{$arrForm.reminder_answer|h}--></dd>
