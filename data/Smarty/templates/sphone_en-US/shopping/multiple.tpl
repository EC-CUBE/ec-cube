...
<section id="undercolumn">
    ...
    <div class="information end">
        <p>Select a delivery destination for each product.</p>
        <p>* Match the quantity with the quantity in your cart.</p>
    </div>

    <!--★ボタン★-->
    <!--{if $tpl_addrmax < $smarty.const.DELIV_ADDR_MAX}-->
        <div class="btn_area_top">
            <a rel="external" href="javascript:void(0);" class="btn_sub addbtn" onclick="win02('<!--{$smarty.const.ROOT_URLPATH}-->mypage/delivery_addr.php?page=<!--{$smarty.server.SCRIPT_NAME|h}-->','new_deiv','600','640'); return false;">Add new delivery destination</a>
        </div>
    <!--{/if}-->
    ...
    <div class="form_area">
        <form name="form1" id="form1" method="post" action="<!--{$smarty.const.ROOT_URLPATH}-->shopping/multiple.php">
            ...
            <ul class="btn_btm">
                <li><a rel="external" href="javascript:void(document.form1.submit());" class="btn bt_wide">Send to the selected delivery destination</a></li>
