    ...
    <div class="form_area">
        ...
        <div class="formBox">
            ...
            <div class="total_area">
                ...
                <div><span class="mini">Points added at this time:</span><!--{$tpl_arrOrderData.add_point|number_format|default:0}-->  <!--{if $tpl_arrOrderData.add_point == 1}-->pt<!--{else}-->pts<!--{/if}--></div>
            </div>
        </div><!-- /.formBox -->
