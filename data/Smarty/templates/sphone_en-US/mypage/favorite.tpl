...
<section id="mypagecolumn">
    ...
    <!--{if $tpl_linemax > 0}-->
        ...
        <div class="information">
            <p>There are <span class="attention"><span id="productscount"><!--{$tpl_linemax}--></span> items</span> in your favorites.</p>
        </div>
            ...
            <form name="form1" id="form1" method="post" action="<!--{$smarty.const.ROOT_URLPATH}-->mypage/favorite.php">
                        ...
                        <div class="favoriteBox">
                            ...
                            <div class="favoriteContents clearfix">
                                ...
                                <p><span class="mini productPrice"><!--{$smarty.const.SALE_PRICE_TITLE}-->:&#036; <!--{if $arrFavorite[cnt].price02_min_inctax == $arrFavorite[cnt].price02_max_inctax}-->
                                    ...
                                    <!--{/if}--></span></p>
                                <p class="btn_delete"><img src="<!--{$TPL_URLPATH}-->img/button/btn_delete.png" width="21" height="20" alt="Delete" onclick="javascript:fnModeSubmit('delete_favorite','product_id','<!--{$product_id|h}-->');" class="pointer" /></p>
                            </div>
                        </div><!--▲商品 -->
                    <!--{/section}-->
                </div><!-- /.formBox -->
                ...
                <!--{if $stock_find_count > 0 && $customer_rank < 51}-->
                    <div class="product-btn">
                        <a rel="external" href="javascript:void(document.form1.submit())" class="btn-cart">Place in cart</a>
                    </div>
                <!--{/if}-->
            </form>
        </div><!-- /.form_area -->
        ...
        <div class="btn_area">
            <!--{if $tpl_linemax > $dispNumber}-->
                <p><a rel="external" href="javascript: void(0);" class="btn_more" id="btn_more_product" onclick="getProducts(5); return false;">View more (+<!--{$dispNumber}--> items)</a></p>
            <!--{/if}-->
        </div>
