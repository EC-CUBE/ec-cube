...
<section id="undercolumn">
    ...
    <!--{if $smarty.const.USE_POINT !== false}-->
        ...
        <div class="information">
            ...
            <!--{if $tpl_login}-->
                <p class="point_announce"><span class="user_name"><!--{$tpl_name|h}--></span>, you currently have "<span class="point"><!--{$tpl_user_point|number_format|default:0}--> <!--{if $tpl_user_point == 1}-->pt<!--{else}-->pts<!--{/if}-->.</span>"<br />
                        ...
                        <div class="total_area">
                            ...
                            <!--{if $smarty.const.USE_POINT !== false}-->
                                <!--{if $arrData[$key].birth_point > 0}-->
                                    <div><span class="mini">Birthday points:</span> <!--{$arrData[$key].birth_point|number_format}--> <!--{if $arrData[$key].birth_point == 1}-->pt<!--{else}-->pts<!--{/if}--></div>
                                <!--{/if}-->
                                <div><span class="mini">Points added at this time:</span> <!--{$arrData[$key].add_point|number_format}--> <!--{if $arrData[$key].add_point == 1}-->pt<!--{else}-->pts<!--{/if}--></div>
                            <!--{/if}-->
                        </div>
                        <!--{if strlen($tpl_error) == 0}-->
