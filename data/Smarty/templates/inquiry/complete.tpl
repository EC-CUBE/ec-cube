...
<table width="760" border="0" cellspacing="0" cellpadding="0" summary=" ">
	<tr>
		...
		<table width="710" border="0" cellspacing="0" cellpadding="0" summary=" ">
			<tr>
				...
				<td height="30"width="695" class="red"><strong><span class="fs18n">アンケートタイトル</span></strong></td>
			</tr>
		</table>
		</td>
	</tr>
	...
	<tr>
		...
		<form name="form1" id="form1" method="post" action="">
			<tr>
				<td bgcolor="#ffffff" height="250" align="center" class="fs12">アンケートの送信が完了いたしました。<br>
				ご協力ありがとうございました。<br><br><br>

				<input type="submit" name="subm1" value="閉じる" onClick="window.close()"></td>
			</tr>
		</form>
		</table>
		</td>
