            ...
            <div id="detailrightblock">
                ...
                <div class="product_detail">
                    ...
                    <p class="product_code">
                        <span class="mini">Product code:</span>
                    ...
                    <!--★関連カテゴリ★-->
                    <p class="relative_cat"><span class="mini">Related categories:</span>
                    ...
                    <p class="sale_price">
                        ...
                        <span class="price"><span id="price02_default">
                            ...
                            <!--{/if}-->
                        </span><span id="price02_dynamic"></span></span>
                    </p>

                    <!--★ポイント★-->
                    <!--{if $smarty.const.USE_POINT !== false}-->
                        <p class="sale_price"><span class="mini">Points:</span><span id="point_default">
                    ...
                    <!--{if $arrProduct.comment1|strlen >= 1}-->
                        <p class="sale_price">
                            <span class="mini">Manufacturer URL:</span><span>
                ...
                <!--{if $tpl_stock_find}-->
                    ...
                    <div class="cartin_btn">
                        ...
                        <div id="cartbtn_default">
                            <a rel="external" href="javascript:void(document.form1.submit());" class="btn cartbtn_default">Place in cart</a>
                        </div>
                ...
                <!--{if $tpl_login}-->
                    <!--{if !$is_favorite}-->
                        <div class="btn_favorite">
                            <p><a rel="external" href="javascript:void(0);" onclick="fnAddFavoriteSphone(<!--{$arrProduct.product_id|h}-->); return false;" class="btn_sub">Add to Favorites</a></p>
                        </div>
                    <!--{else}-->
                        <div class="btn_favorite">
                            <p>Registered in Favorites</p>
                        </div>
                    <!--{/if}-->
                <!--{/if}-->
            </div>
