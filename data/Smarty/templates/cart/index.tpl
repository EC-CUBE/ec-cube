					...
					<!--ご注文内容ここから-->
						...
						<tr bgcolor="#ffffff" class="fs12n">
							...
							<!--{if $arrProductsClass[cnt].price02 != ""}-->
								<!--{$arrProductsClass[cnt].price02|sfPreTax:$arrSiteInfo.tax:$arrSiteInfo.tax_rule|number_format}-->円
							<!--{else}-->
								<!--{$arrProductsClass[cnt].price01|sfPreTax:$arrSiteInfo.tax:$arrSiteInfo.tax_rule|number_format}-->円
							<!--{/if}-->						
							</td>
							<td align="center" >
						...
						<tr align="right">
							...
							<td class="fs12st" bgcolor="#ffffff"><!--{$arrData.total|number_format}-->円</td>
						</tr>
						<!--{if $arrData.birth_point > 0}-->
						<tr align="right">
							<td colspan="5" class="fs12n" bgcolor="#f0f0f0">お誕生月ポイント</td>
							<td class="fs12st" bgcolor="#ffffff"><!--{$arrData.birth_point}-->pt</td>
						</tr>
						<!--{/if}-->
						<tr align="right">
							<td colspan="5" class="fs12n" bgcolor="#f0f0f0">今回加算ポイント</td>
							<td class="fs12st" bgcolor="#ffffff"><!--{$arrData.add_point}-->pt</td>
						</tr>
					</table>
				</td>
			</tr>
