				...
				<td bgcolor="#cccccc" align="center">
					...
					<!--ご注文内容ここから-->
						...
						<tr bgcolor="#ffffff" class="fs12n">
							...
							<td ><a href="<!--{$smarty.server.PHP_SELF|escape}-->" onclick="win01('../products/detail_image.php?product_id=<!--{$arrProductsClass[cnt].product_id}-->&image=main_image','detail_image','<!--{$arrProductsClass[cnt].tpl_image_width}-->','<!--{`$arrProductsClass[cnt].tpl_image_height`+100}-->'); return false;" target="_blank">
