	...
	<tr>
		...
		<table width="700" border="0" cellspacing="0" cellpadding="0" summary=" ">
			...
			<tr>
				<td align="center">
					<!--{if $tpl_prev_url != ""}-->
					<a href="<!--{$tpl_prev_url|escape}-->" onmouseOver="chgImg('<!--{$smarty.const.URL_DIR}-->img/cart/b_continue_on.gif','back');" onmouseOut="chgImg('<!--{$smarty.const.URL_DIR}-->img/cart/b_continue.gif','back');"><img src="<!--{$smarty.const.URL_DIR}-->img/cart/b_continue.gif" width="150" height="30" alt="買い物を続ける" name="back" id="back" /></a>　
					<!--{/if}-->
