					...
					<tr>
						...
						<table width="150" cellspacing="0" cellpadding="0" summary=" " border="0">
							...
							<tr>
								...
								<td>
									<img src="<!--{$smarty.const.URL_DIR}-->img/_.gif" width="3" height="22"/><td align="center"><a href="#" onclick="document.search_form.submit();return false;"><img src="<!--{$smarty.const.URL_DIR}-->img/left/search_button_mini.gif" width="35" height="22" alt="¸¡º÷" /></a></td>
								</td>								
							</tr>							
