		...
		<table width="700" border="0" cellspacing="0" cellpadding="0" summary=" ">
			<tr valign="top">
				...
				<table width="515" border="0" cellspacing="0" cellpadding="0" summary=" ">
					<tr>
						<td><!--★タイトル--><img src="/img/mypage/subtitle05.gif" width="515" height="32" alt="購入履歴詳細"></td>
					</tr>
					<tr><td height="15"></td></tr>
					<tr>
					...
					<tr>
						...
						<table width="515" border="0" cellspacing="1" cellpadding="10" summary=" ">
							...
							<tr bgcolor="#ffffff">
								...
								<td align="right" class="fs12"><!--{$price|sfPreTax:$arrInfo.tax:$arrInfo.tax_rule|sfMultiply:$quantity|number_format}-->円</td>
							</tr>
							<!--{/section}-->
					...
					<tr>
						<td align="center">
							<a href="./index.php" onmouseover="chgImg('/img/common/b_back_on.gif','change');" onmouseout="chgImg('/img/common/b_back.gif','change');"><img src="/img/common/b_back.gif" width="150" height="30" alt="戻る" name="change" id="change" /></a>
						</td>
					</tr>
				</form>
				</table>
