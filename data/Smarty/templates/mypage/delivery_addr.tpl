						...
						<td bgcolor="#ffffff">
							<table cellspacing="0" cellpadding="0" summary=" ">
								<tr>
									...
									<td>
										&nbsp;&nbsp;<a href="../address/index.php" onclick="fnCallAddress('<!--{$smarty.const.URL_INPUT_ZIP}-->', 'zip01', 'zip02', 'pref', 'addr01'); return false;" target="_blank"><img src="../img/button/address.gif" width="86" height="20" alt="住所自動入力" /></a></td>
									</td>
								</tr>
