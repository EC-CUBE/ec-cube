...
<link rel="stylesheet" href="/css/layout/mypage/new_deliv.css" type="text/css" media="all" />
			...
			<tr>
				...
				<table width="500" border="0" cellspacing="1" cellpadding="10" summary=" ">
					...
					<tr>
						...
						<td bgcolor="#ffffff" class="fs12"><span class="red"><!--{$arrErr.kana01}--><!--{$arrErr.kana02}--></span>
						...
						<td bgcolor="#ffffff">
							<table cellspacing="0" cellpadding="0" summary=" ">
								<tr>
									...
									<td>
										&nbsp;&nbsp;<a href="../address/index.php" onclick="fnCallAddress('<!--{$smarty.const.URL_INPUT_ZIP}-->', 'zip01', 'zip02', 'pref', 'addr01'); return false;" target="_blank"><img src="../img/button/address.gif" width="95" height="20" alt="住所自動入力" /></a></td>
									</td>
								</tr>
