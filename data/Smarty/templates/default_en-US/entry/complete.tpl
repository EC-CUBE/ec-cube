...
<div id="undercolumn">
    <div id="undercolumn_entry">
        ...
        <div id="complete_area">
            <p class="message">Member registration has been received.</p>
            <p>You are currently <span class="attention">a temporary member</span>.<br />
            ...
            <div class="shop_information">
                ...
                <p>TEL:<!--{$arrSiteInfo.tel01}-->-<!--{$arrSiteInfo.tel02}-->-<!--{$arrSiteInfo.tel03}-->
                    <!--{if $arrSiteInfo.business_hour != ""}-->(Time of receipt/<!--{$arrSiteInfo.business_hour}-->)<!--{/if}--><br />
