				...
				<table width="580" border="0" cellspacing="1" cellpadding="10" summary=" ">
					...
					<tr>
						...
						<table border="0" cellspacing="0" cellpadding="0" summary=" ">
							...
							<tr>
								<td><a href="/address/index.php" onclick="fnCallAddress('<!--{$smarty.const.URL_INPUT_ZIP}-->', 'zip01', 'zip02', 'pref', 'addr01'); return false;" target="_blank"><img src="/img/common/address.gif" width="95" height="20" alt="住所自動入力" /></a></td>
					...
					<tr>
						...
						<table border="0" cellspacing="0" cellpadding="0" summary=" ">
							<tr>
								<td><span class="red"><span class="red12"><!--{$arrErr.pref}--><!--{$arrErr.addr01}--><!--{$arrErr.addr02}--></span>
					...
					<tr>
						...
						<td bgcolor="#ffffff" class="fs12n"><span class="red"><!--{$arrErr.tel01}--><!--{$arrErr.tel02}--><!--{$arrErr.tel03}--></span><input type="text" name="tel01" size="6" value="<!--{$tel01|escape}-->" maxlength="<!--{$smarty.const.TEL_ITEM_LEN}-->" style="<!--{$arrErr.tel01|sfGetErrorColor}-->; ime-mode: disabled;" />&nbsp;-&nbsp;<input type="text" name="tel02" size="6" value="<!--{$tel02|escape}-->" maxlength="<!--{$smarty.const.TEL_ITEM_LEN}-->" style="<!--{$arrErr.tel01|sfGetErrorColor}-->; ime-mode: disabled;" />&nbsp;-&nbsp;<input type="text" name="tel03" size="6" value="<!--{$tel03|escape}-->" maxlength="<!--{$smarty.const.TEL_ITEM_LEN}-->" style="<!--{$arrErr.tel01|sfGetErrorColor}-->; ime-mode: disabled;" /></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td bgcolor="#ffffff">
						<table border="0" cellspacing="0" cellpadding="0" summary=" ">
							<tr><span class="red12"><!--{$arrErr.email}--><!--{$arrErr.email02}--></span>
					...
					<tr>
						...
						<td bgcolor="#ffffff">
						<table cellspacing="0" cellpadding="0" summary=" ">
							<tr><span class="red12"><!--{$arrErr.password}--><!--{$arrErr.password02}--></span>
								<td><input type="password" name="password" value="<!--{$arrForm.password}-->"size="15" class="box15"  style="<!--{$arrErr.password|sfGetErrorColor}-->"/></td>
							</tr>
							<tr><td height="2"></td></tr>
							<tr>
					...
					<tr>
						...
						<td bgcolor="#ffffff"><span class="red12"><!--{$arrErr.reminder}--><!--{$arrErr.reminder_answer}--></span>
						<table cellspacing="0" cellpadding="0" summary=" ">
							<tr>
					...
					<tr>
						...
						<td bgcolor="#ffffff" class="fs12"><span class="red12"><!--{$arrErr.mail_flag}--></span>
						<input type="radio" name="mail_flag" id="html" value="1" style="<!--{$arrErr.mail_flag|sfGetErrorColor}-->" <!--{if $mail_flag eq 1 || $mail_flag eq ""}-->checked<!--{/if}--> /><label for="html">HTMLメール＋テキストメールを受け取る</label><br>
						<input type="radio" name="mail_flag" id="text"value="2" style="<!--{$arrErr.mail_flag|sfGetErrorColor}-->" <!--{if $mail_flag eq 2}-->checked<!--{/if}--> /><label for="text">テキストメールを受け取る</label><br>
						<input type="radio" name="mail_flag" id="no" value="3" style="<!--{$arrErr.mail_flag|sfGetErrorColor}-->" <!--{if $mail_flag eq 3}-->checked<!--{/if}--> /><label for="no">受け取らない</label></td>
					</tr>
				</table>
				<!--入力フォームここまで-->
				</td>
