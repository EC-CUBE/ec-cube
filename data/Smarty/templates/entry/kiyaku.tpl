 ...
 *}-->
		...
		<table width="580" border="0" cellspacing="0" cellpadding="0" summary=" ">
			...
			<tr align="center">
				<td><a href="<!--{$smarty.const.URL_ENTRY_TOP}-->" onmouseover="chgImg('../img/entry/b_noagree_on.gif','b_noagree');" onmouseout="chgImg('../img/entry/b_noagree.gif','b_noagree');"><img src="<!--{$smarty.const.URL_DIR}-->img/entry/b_noagree.gif" width="180" height="30" alt="同意しない" border="0" name="b_noagree"></a>　 
