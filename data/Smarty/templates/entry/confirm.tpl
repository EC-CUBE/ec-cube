...
<table width="" border="0" cellspacing="0" cellpadding="0" summary=" ">
	<tr valign="top">
		...
		<table width="580" border="0" cellspacing="0" cellpadding="0" summary=" ">
			...
			<tr align="center">
				<td>
					<a href="<!--{$smarty.server.PHP_SELF}-->" onclick="fnModeSubmit('return', '', ''); return false;" onmouseover="chgImg('/img/common/b_back_on.gif','back')" onmouseout="chgImg('/img/common/b_back.gif','back')"><img src="/img/common/b_back.gif" width="150" height="30" alt="戻る" border="0" name="back" id="back" /></a>
					<img src="/img/_.gif" width="20" height="" alt="" />
					<input type="image" onmouseover="chgImgImageSubmit('/img/entry/b_entrycomp_on.gif',this)" onmouseout="chgImgImageSubmit('/img/entry/b_entrycomp.gif',this)" src="/img/entry/b_entrycomp.gif" width="150" height="30" alt="送信" border="0" name="send" id="send" />
				</td>
			</tr>
		</form>
		</table>
