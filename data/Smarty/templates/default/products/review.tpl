...
<div id="window_area">
    ...
    <form name="form1" method="post" action="?">
        ...
        <div class="btn_area">
            <ul>
                <li><input type="image" onmouseover="eccube.common.chgImgImageSubmit('<!--{$TPL_URLPATH}-->img/button/btn_confirm_on.jpg',this)" onmouseout="eccube.common.chgImgImageSubmit('<!--{$TPL_URLPATH}-->img/button/btn_confirm.jpg',this)" src="<!--{$TPL_URLPATH}-->img/button/btn_confirm.jpg" alt="確認ページへ" name="conf" id="conf" /></li>
            </ul>
        </div>
    </form>
</div>
