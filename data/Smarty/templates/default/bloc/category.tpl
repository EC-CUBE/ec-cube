...
<table width="166" border="0" cellspacing="0" cellpadding="0" summary=" ">
	<tr>
		<td colspan="3"><img src="<!--{$TPL_DIR}-->img/side/title_cat.jpg" width="166" height="35" alt="商品カテゴリー"></td>
	</tr>
	<tr>
		...
		<td align="center" bgcolor="#fff1e3">
			<table width="146" border="0" cellspacing="0" cellpadding="0" summary=" ">
				<tr>
					<td height="10"><img src="<!--{$TPL_DIR}-->img/common/_.gif" width="15" height="1" alt=""></td>
					<td><img src="<!--{$TPL_DIR}-->img/common/_.gif" width="131" height="1" alt=""></td>
				</tr>
				...
				<tr><td colspan="2" height="15"><img src="<!--{$TPL_DIR}-->img/side/line_146.gif" width="146" height="1" alt=""></td></tr>
				<!--{/if}-->
				<!--{* カテゴリ名表示 *}-->
				...
				<tr>
					<td colspan="2" class="fs12">
						<!--{if $tpl_category_id == $arrTree[cnt].category_id || $root_parent_id == $arrTree[cnt].category_id}-->
							<!--{section name=n loop=`$level-1`}-->&nbsp;&nbsp;<!--{/section}--><!--{if $level == 1}--><img src="<!--{$TPL_DIR}-->img/common/arrow_red.gif" width="11" height="14" alt=""><!--{/if}-->
						<!--{else}-->
							<!--{section name=n loop=`$level-1`}-->&nbsp;&nbsp;<!--{/section}--><!--{if $level == 1}--><img src="<!--{$TPL_DIR}-->img/common/arrow_blue.gif" width="11" height="14" alt=""><!--{/if}-->
						<!--{/if}-->
	...
	<tr>
		<td colspan="3"><img src="<!--{$TPL_DIR}-->img/side/flame_bottom02.gif" width="166" height="15" alt=""></td>
	</tr>
