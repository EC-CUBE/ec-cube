...
<div id="window_area">
    ...
    <form action="?" method="post" name="form1">
        ...
        <div class="btn_area">
            <ul>
                <li><a href="javascript:window.close()" onmouseover="eccube.common.chgImg('<!--{$TPL_URLPATH}-->img/button/btn_close_on.jpg','close');" onmouseout="eccube.common.chgImg('<!--{$TPL_URLPATH}-->img/button/btn_close.jpg','close');"><img src="<!--{$TPL_URLPATH}-->img/button/btn_close.jpg" alt="閉じる" name="close" id="close" /></a></li>
            </ul>
        </div>
    </form>
</div>
