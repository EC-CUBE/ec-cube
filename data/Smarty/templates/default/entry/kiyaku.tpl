    ...
    <div id="undercolumn_entry">
        ...
        <form name="form1" id="form1" method="post" action="?">
            ...
            <div class="btn_area">
                <ul>
                    <li>
                        <a href="<!--{$smarty.const.TOP_URLPATH}-->" onmouseover="eccube.common.chgImg('<!--{$TPL_URLPATH}-->img/button/btn_entry_cannot_on.jpg','b_noagree');" onmouseout="eccube.common.chgImg('<!--{$TPL_URLPATH}-->img/button/btn_entry_cannot.jpg','b_noagree');">
                            <img src="<!--{$TPL_URLPATH}-->img/button/btn_entry_cannot.jpg" alt="同意しない" border="0" name="b_noagree" /></a>
                    </li>
                    <li>
                        <a href="<!--{$smarty.const.ENTRY_URL}-->" onmouseover="eccube.common.chgImg('<!--{$TPL_URLPATH}-->img/button/btn_entry_agree_on.jpg','b_agree');" onmouseout="eccube.common.chgImg('<!--{$TPL_URLPATH}-->img/button/btn_entry_agree.jpg','b_agree');">
