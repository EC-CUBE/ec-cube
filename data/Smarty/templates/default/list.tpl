	...
	<tr>
		...
		<table cellspacing="0" cellpadding="0" summary=" " id="container">
			<tr valign="top">
				...
				<table width="" border="0" cellspacing="0" cellpadding="0" summary=" ">
					<tr><td><img src="<!--{$TPL_DIR}-->img/products/flame_top.gif" width="580" height="8" alt=""></td></tr>
					<tr>
						<td align="center" bgcolor="#f3f3f3">
						<table width="" border="0" cellspacing="0" cellpadding="0" summary=" ">
							<tr bgcolor="#9e9e9e">
								<td rowspan="3"><img src="<!--{$TPL_DIR}-->img/common/_.gif" width="1" height="10" alt=""></td>
								<td bgcolor="#9e9e9e"><img src="<!--{$TPL_DIR}-->img/common/_.gif" width="558" height="1" alt=""></td>
								<td rowspan="3"><img src="<!--{$TPL_DIR}-->img/common/_.gif" width="1" height="10" alt=""></td>
							</tr>
							<tr>
							...
							<tr><td bgcolor="#9e9e9e"><img src="<!--{$TPL_DIR}-->img/common/_.gif" width="558" height="1" alt=""></td></tr>
						</table>
						</td>
					</tr>
					<tr><td><img src="<!--{$TPL_DIR}-->img/products/flame_top.gif" width="580" height="8" alt=""></td></tr>
				...
				<tr valign="top">
					...
					<td align="right">
						<table width="420" border="0" cellspacing="0" cellpadding="0" summary=" ">
							...
							<tr><td colspan="2" bgcolor="#ebebd6"><img src="<!--{$TPL_DIR}-->img/common/_.gif" width="1" height="2" alt=""></td></tr>
							<tr><td height="8"></td></tr>
							<tr>
							...
							<tr>
								...
								<td align="right"><a href="<!--{$smarty.const.DETAIL_P_HTML}--><!--{$arrProducts[cnt].product_id}-->" onmouseover="chgImg('<!--{$TPL_DIR}-->img/products/b_detail_on.gif','<!--{$name}-->');" onmouseout="chgImg('<!--{$TPL_DIR}-->img/products/b_detail.gif','<!--{$name}-->');"><img src="<!--{$TPL_DIR}-->img/products/b_detail.gif" width="115" height="25" alt="詳しくはこちら" name="<!--{$name}-->" id="<!--{$name}-->" /></a></td>
							</tr>
				...
				<tr><td colspan=3 height="40"><img src="<!--{$TPL_DIR}-->img/common/line_580.gif" width="580" height="1" alt=""></td></tr>
				<!--{/section}-->
				</table>
