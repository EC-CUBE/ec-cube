								...
								<table width="465" border="0" cellspacing="0" cellpadding="0" summary=" ">
									...
									<tr>
										<td align="center">
											...
											<input type="image" onmouseover="chgImgImageSubmit('<!--{$TPL_DIR}-->img/mypage/b_yes_on.gif',this);" onmouseout="chgImgImageSubmit('<!--{$TPL_DIR}-->img/mypage/b_yes.gif',this);" src="<!--{$TPL_DIR}-->img/mypage/b_yes.gif" width="180" height="30" alt="はい、はい、退会します" name="refusal_yes" id="refusal_yes" />
										</td>
									</tr>
