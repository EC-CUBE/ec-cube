						...
						<table width="505" border="0" cellspacing="0" cellpadding="0" summary=" ">
							...
							<tr>
								...
								<table width="465" border="0" cellspacing="0" cellpadding="0" summary=" ">
									...
									<tr>
										<td align="center">
											<input type="image" onmouseover="chgImgImageSubmit('<!--{$TPL_DIR}-->img/mypage/b_refuse_on.gif',this);" onmouseout="chgImgImageSubmit('<!--{$TPL_DIR}-->img/mypage/b_refuse.gif',this);" src="<!--{$TPL_DIR}-->img/mypage/b_refuse.gif" width="180" height="30" alt="会員退会を行う" name="refusal" id="refusal" />
										</td>
									</tr>
