    ...
    <div id="mycontents_area">
        ...
        <table>
            ...
            <tr class="center">
                ...
                <td><a href="#" onclick="eccube.win02('./mail_view.php?send_id=<!--{$tpl_arrMailHistory[cnt].send_id}-->','mail_view','650','800'); return false;"><!--{$tpl_arrMailHistory[cnt].subject|h}--></a></td>
            </tr>
            <!--{/section}-->
        </table>
