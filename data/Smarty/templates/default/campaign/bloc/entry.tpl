...
<div id="undercolumn">
  <div id="undercolumn_entry">
    <div id="undertitle"><h2><!--★タイトル★-->会員登録</h2></div>
    ...
    <form name="form1" id="form1" method="post" action="<!--{$smarty.server.PHP_SELF|escape}-->">
     ...
     <input type="hidden" name="mode" value="confirm" />
      ...
      <table summary="会員登録フォーム">
        ...
        <tr>
          ...
          <td>
            ...
            <p>〒&nbsp;<input type="text" name="zip01" value="<!--{if $zip01 == ""}--><!--{$arrOtherDeliv.zip01|escape}--><!--{else}--><!--{$zip01|escape}--><!--{/if}-->" maxlength="<!--{$smarty.const.ZIP01_LEN}-->" style="<!--{$arrErr.zip01|sfGetErrorColor}-->; ime-mode: disabled;" size="6" class="box60" />&nbsp;-&nbsp;<input type="text" name="zip02" value="<!--{if $zip02 == ""}--><!--{$arrOtherDeliv.zip02|escape}--><!--{else}--><!--{$zip02|escape}--><!--{/if}-->" maxlength="<!--{$smarty.const.ZIP02_LEN}-->" style="<!--{$arrErr.zip02|sfGetErrorColor}-->; ime-mode: disabled;" size="6" class="box60" />&nbsp;
              <a href="http://search.post.japanpost.jp/zipcode/" target="_blank">郵便番号検索</a></p>
              <p class="zipimg">
                <a href="<!--{$smarty.const.URL_DIR}-->address/index.php" onclick="fnCallAddress('<!--{$smarty.const.URL_INPUT_ZIP}-->', 'zip01', 'zip02', 'pref', 'addr01'); return false;" target="_blank"><img src="<!--{$TPL_DIR}-->img/common/address.jpg" width="78" height="22" alt="住所自動入力" />
                </a>
        ...
        <tr>
          ...
          <td><span class="attention"><!--{$arrErr.pref}--><!--{$arrErr.addr01}--><!--{$arrErr.addr02}--></span>
            ...
            <p class="mini02">住所は2つに分けてご記入いただけます。マンション名は必ず記入してください。</p>
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>
            ...
            <p class="mini02">確認のため2度入力してください。</p>
          </td>
        </tr>
        <tr>
      ...
      <div class="tblareabtn">
        <input type="image" onmouseover="chgImgImageSubmit('<!--{$TPL_DIR}-->img/common/b_confirm_on.jpg',this)" onmouseout="chgImgImageSubmit('<!--{$TPL_DIR}-->img/common/b_confirm.jpg',this)" src="<!--{$TPL_DIR}-->img/common/b_confirm.jpg" class="box150" alt="確認ページへ" name="confirm" id="confirm" />
      </div>
    </form>
  </div>
</div>
