...
<div id="undercolumn">
  ...
  <div id="undercolumn_contact">
    ...
    <table summary="お問い合わせ">
      ...
      <tr>
        ...
        <td>
          ...
          <!--{/if}-->
          <input type="text" class="box380" name="email02" value="<!--{$arrForm.email02.value|h}-->" maxlength="<!--{$smarty.const.MTEXT_LEN}-->" style="<!--{$arrErr.email02|sfGetErrorColor}-->; ime-mode: disabled;" /><br />
    ...
    <div class="btn_area">
            <ul>
                <li>
                      <input type="image" onmouseover="chgImgImageSubmit('<!--{$TPL_URLPATH}-->img/button/btn_confirm_on.jpg', this)" onmouseout="chgImgImageSubmit('<!--{$TPL_URLPATH}-->img/button/btn_confirm.jpg', this)" src="<!--{$TPL_URLPATH}-->img/button/btn_confirm.jpg" style=" alt="確認ページへ" name="confirm" />
                </li>
            </ul>
    </div>
