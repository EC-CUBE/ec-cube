        ...
        <table summary="お問い合わせ">
            ...
            <tr>
                ...
                <td>
                    ...
                    <!--{/if}-->
                    <input type="text" class="box380" name="email02" value="<!--{$arrForm.email02.value|h|default:$email02}-->" maxlength="<!--{$smarty.const.MTEXT_LEN}-->" style="<!--{$arrErr.email02|sfGetErrorColor}-->; ime-mode: disabled;" /><br />
