  ...
  <div id="under02column_shopping">
    ...
    <form name="form1" id="form1" method="post" action="?">
      ...
      <table summary="ご注文内容確認">
        ...
        <tr>
          <td class="phototd">
            <a href="?" onclick="win01('<!--{$smarty.const.URL_DIR}-->products/detail_image.php?product_id=<!--{$arrProductsClass[cnt].product_id}-->&amp;image=main_image','detail_image','<!--{$arrProductsClass[cnt].tpl_image_width}-->','<!--{$arrProductsClass[cnt].tpl_image_height}-->'); return false;" target="_blank">
              <img src="<!--{$smarty.const.URL_DIR}-->resize_image.php?image=<!--{$arrProductsClass[cnt].main_list_image|sfNoImageMainList|escape}-->&amp;width=65&amp;height=65" alt="<!--{$arrProductsClass[cnt].name|escape}-->" />
            </a>
          </td>
          <td>
            <ul>
