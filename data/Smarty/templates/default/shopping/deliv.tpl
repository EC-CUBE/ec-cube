        ...
        <form name="form1" id="form1" method="post" action="?">
            ...
            <table summary="お届け先の指定">
                ...
                <tr>
                    ...
                    <td class="centertd">
                        <!--{if !$smarty.section.cnt.first}-->
                            <a href="<!--{$smarty.const.URL_PATH}-->mypage/delivery_addr.php" onclick="win02('<!--{$smarty.const.URL_PATH}-->mypage/delivery_addr.php?page=<!--{$smarty.server.PHP_SELF|h}-->&amp;other_deliv_id=<!--{$arrAddr[cnt].other_deliv_id}-->','new_deiv','600','640'); return false;">変更</a>
                        <!--{/if}-->
                    </td>
                    <td class="centertd">
                        <!--{if !$smarty.section.cnt.first}-->
