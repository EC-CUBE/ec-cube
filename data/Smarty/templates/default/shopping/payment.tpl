    ...
    <div id="undercolumn_shopping">
        ...
        <form name="form1" id="form1" method="post" action="?">
                ...
                <div class="point_area">
                    <h3>ポイント使用の指定</h3>
                        ...
                        <div class="point_announce">
                            ...
                            <ul>
                                <li>
                                <input type="radio" id="point_on" name="point_check" value="1" <!--{$arrForm.point_check.value|sfGetChecked:1}--> onclick="eccube.common.togglePointForm();" /><label for="point_on">ポイントを使用する</label>
                                ...
                                <li><input type="radio" id="point_off" name="point_check" value="2" <!--{$arrForm.point_check.value|sfGetChecked:2}--> onclick="eccube.common.togglePointForm();" /><label for="point_off">ポイントを使用しない</label></li>
                            </ul>
                    </div>
                </div>
            <!--{/if}-->
            ...
            <div class="btn_area">
                <ul>
                    <li>
                    <a href="?mode=return" onmouseover="eccube.common.chgImg('<!--{$TPL_URLPATH}-->img/button/btn_back_on.jpg','back03')" onmouseout="eccube.common.chgImg('<!--{$TPL_URLPATH}-->img/button/btn_back.jpg','back03')">
                        <img src="<!--{$TPL_URLPATH}-->img/button/btn_back.jpg" alt="戻る" border="0" name="back03" id="back03" /></a>
                    </li>
                    <li>
                        <input type="image" onmouseover="eccube.common.chgImgImageSubmit('<!--{$TPL_URLPATH}-->img/button/btn_next_on.jpg',this)" onmouseout="eccube.common.chgImgImageSubmit('<!--{$TPL_URLPATH}-->img/button/btn_next.jpg',this)" src="<!--{$TPL_URLPATH}-->img/button/btn_next.jpg" alt="次へ" name="next" id="next" />
                    </li>
                </ul>
            </div>
        </form>
