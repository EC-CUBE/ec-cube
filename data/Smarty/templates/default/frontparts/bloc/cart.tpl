    ...
    <div class="block_outer">
        ...
        <h2 class="cart"><span class="title"><img src="<!--{$TPL_URLPATH}-->img/title/tit_bloc_cart.gif" alt="現在のカゴの中" /></span></h2>
            <div class="block_body">
                ...
                <div class="btn">
                    <a href="<!--{$smarty.const.CART_URLPATH}-->" onmouseover="eccube.common.chgImg('<!--{$TPL_URLPATH}-->img/button/btn_bloc_cart_on.jpg','button_cart');" onmouseout="eccube.common.chgImg('<!--{$TPL_URLPATH}-->img/button/btn_bloc_cart.jpg','button_cart');"><img src="<!--{$TPL_URLPATH}-->img/button/btn_bloc_cart.jpg" alt="カゴの中を見る" border="0" name="button_cart" id="button_cart" /></a>
                </div>
            </div>
        </div>
    </div>
