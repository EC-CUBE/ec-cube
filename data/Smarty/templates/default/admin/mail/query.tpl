				...
				<tr>
					<td align="center">
						<table width="660" border="0" cellspacing="0" cellpadding="0" summary=" ">
							...
							<tr>
								<td colspan="3"><img src="<!--{$TPL_DIR}-->img/contents/main_top.jpg" width="668" height="14" alt=""></td>
							</tr>
							<tr>
								...
								<td bgcolor="#cccccc">
									<table width="640" border="0" cellspacing="0" cellpadding="0" summary=" ">
										<tr>
											<td colspan="3"><img src="<!--{$TPL_DIR}-->img/contents/contents_title_top.gif" width="640" height="7" alt=""></td>
										</tr>
										<tr>
										...
										<tr>
											<td colspan="3"><img src="<!--{$TPL_DIR}-->img/contents/contents_title_bottom.gif" width="640" height="7" alt=""></td>
										</tr>
										<tr>
											<td colspan="3"><img src="<!--{$TPL_DIR}-->img/contents/main_bar.jpg" width="640" height="10" alt=""></td>
										</tr>
									</table>
									...
									<table width="640" border="0" cellspacing="0" cellpadding="0" summary=" ">
										<tr>
											...
											<td><img src="<!--{$TPL_DIR}-->img/contents/tbl_top.gif" width="638" height="7" alt=""></td>
											<td bgcolor="#cccccc"><img src="<!--{$TPL_DIR}-->img/common/_.gif" width="1" height="5" alt=""></td>
										</tr>
										<tr>
										...
										<tr>
											<td colspan="3"><img src="<!--{$TPL_DIR}-->img/contents/tbl_bottom.gif" width="640" height="8" alt=""></td>
										</tr>
									</table>
								</td>
							...
							<tr>
								<td colspan="3"><img src="<!--{$TPL_DIR}-->img/contents/main_bottom.jpg" width="668" height="14" alt=""></td>
							</tr>
