...
<table width="141" border="0" cellspacing="0" cellpadding="0" summary=" " id="menu_navi">
	...
	<tr><td class=<!--{if $tpl_subno != 'update'}-->"navi"<!--{else}-->"navi-on"<!--{/if}-->><a href="./update.php" onMouseOver="naviStyleChange('update', '#a5a5a5')" <!--{if $tpl_subno != 'update'}-->onMouseOut="naviStyleChange('update', '#636469')"<!--{/if}--> id="update"><img src="<!--{$TPL_DIR}-->img/contents/icon.jpg" width="15" height="9" alt="" border="0"><span class="navi_text">アップデート管理</span></a></td></tr>
	<tr><td><img src="<!--{$TPL_DIR}-->img/contents/navi_line.gif" width="140" height="2" alt=""></td></tr>
	<tr><td class=<!--{if $tpl_subno != 'module'}-->"navi"<!--{else}-->"navi-on"<!--{/if}-->><a href="./module.php" onMouseOver="naviStyleChange('module', '#a5a5a5')" <!--{if $tpl_subno != 'module'}-->onMouseOut="naviStyleChange('module', '#636469')"<!--{/if}--> id="module"><img src="<!--{$TPL_DIR}-->img/contents/icon.jpg" width="15" height="9" alt="" border="0"><span class="navi_text">モジュール管理</span></a></td></tr>
	<tr><td><img src="<!--{$TPL_DIR}-->img/contents/navi_line.gif" width="140" height="2" alt=""></td></tr>
