								...
								<!--{if count($arrClassCat) > 0}-->
									...
									<table width="678" border="0" cellspacing="1" cellpadding="8" summary=" ">
										...
										<tr bgcolor="#f2f1ec" align="center" class="fs12n">
											...
											<td width="160">在庫(個)<span class="red">*</span></td>
											<td width="100"><!--{$smarty.const.NORMAL_PRICE_TITLE}-->(円)</td>
											<td width="100"><!--{$smarty.const.SALE_PRICE_TITLE}-->(円)<span class="red">*</span></td>
										</tr>
