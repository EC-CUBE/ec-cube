...
<form name="form1" id="form1" method="post" action="./maker.php">
				...
				<table width="706" border="0" cellspacing="0" cellpadding="0" summary=" ">
					...
					<tr>
						...
						<table width="678" border="0" cellspacing="1" cellpadding="8" summary=" ">
							<tr>
								<td bgcolor="#f2f1ec" width="160" class="fs12n">メーカー名<span class="red"> *</span></td>
						...
						<table width="678" border="0" cellspacing="1" cellpadding="8" summary=" ">
							<tr bgcolor="#f2f1ec" align="center" class="fs12n">
								<td width="471">メーカー</td>
								<td width="50">編集</td>
								<td width="50">削除</td>
								<td width="70">移動</td>
							</tr>
							<!--{section name=cnt loop=$arrMaker}-->
							<tr bgcolor="<!--{if $tpl_class_id != $arrMaker[cnt].maker_id}-->#ffffff<!--{else}--><!--{$smarty.const.SELECT_RGB}--><!--{/if}-->" class="fs12">
								<!--{assign var=maker_id value=$arrMaker[cnt].maker_id}-->
								<td><!--{* 規格名 *}--><!--{$arrMaker[cnt].name|escape}--></td>
								<td align="center">
