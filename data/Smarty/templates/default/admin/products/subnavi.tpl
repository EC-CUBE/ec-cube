...
<table width="141" border="0" cellspacing="0" cellpadding="0" summary=" " id="menu_navi">
	...
	<tr><td><img src="<!--{$TPL_DIR}-->img/contents/navi_line.gif" width="140" height="2" alt=""></td></tr>
	<tr><td class=<!--{if $tpl_subno != 'maker'}-->"navi"<!--{else}-->"navi-on"<!--{/if}-->><a href="./maker.php" onMouseOver="naviStyleChange('maker', '#a5a5a5')" <!--{if $tpl_subno != 'maker'}-->onMouseOut="naviStyleChange('maker', '#636469')"<!--{/if}--> id="maker"><img src="<!--{$TPL_DIR}-->img/contents/icon.jpg" width="15" height="9" alt="" border="0"><span class="navi_text">メーカー管理</span></a></td></tr>
    <tr><td><img src="<!--{$TPL_DIR}-->img/contents/navi_line.gif" width="140" height="2" alt=""></td></tr>
