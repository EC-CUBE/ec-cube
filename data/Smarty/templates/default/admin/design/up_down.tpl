								...
								<table width="678" border="0" cellspacing="0" cellpadding="0" summary=" ">
									...
									<tr>
										...
										<table border="0" cellspacing="0" cellpadding="0" summary=" ">
											<tr>
												<td>
													<a href="" onClick="confirmSubmit('download', 'ダウンロードを行います。');return false;"><img onMouseover="chgImgImageSubmit('<!--{$TPL_DIR}-->img/contents/btn_download_on.jpg',this)" onMouseout="chgImgImageSubmit('<!--{$TPL_DIR}-->img/contents/btn_download.jpg',this)" src="<!--{$TPL_DIR}-->img/contents/btn_download.jpg" width="123" height="24" alt="ダウンロード" border="0" name="subm"></a>
												</td>
											</tr>
										</table>
										</td>
