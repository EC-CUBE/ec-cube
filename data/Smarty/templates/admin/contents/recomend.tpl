  ...
  <table class="list center" id="recommend-table">
    ...
    <tr>
      ...
      <td>
        ...
        <!--{if $arrItems[$smarty.section.cnt.iteration].product_id}-->
        <br /><a class="btn-action" href="javascript:;" onclick="return lfnCheckSubmit(document.form<!--{$smarty.section.cnt.iteration}-->); return false;"><span class="btn-next">登録する</span></a>
        <!--{/if}-->
        </form>
      </td>
    </tr>
