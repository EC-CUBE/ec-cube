...
<form name="form1" id="form1" method="post" action="?">
    ...
    <div id="admin-contents" class="contents-main">
            ...
            <table id="contents-csv-sqllist" class="list center">
                <!--{foreach key=key item=item from=$arrSqlList}-->
                    <tr style="background-color:<!--{if $item.sql_id == $arrForm.sql_id}--><!--{$smarty.const.SELECT_RGB}--><!--{else}-->#ffffff<!--{/if}-->;">
                        ...
                        <td>
                            <div class="btn">
                                <a class="btn-normal" href="javascript:;" name='csv' onclick="fnTargetSelf(); eccube.common.fnFormModeSubmit('form1','csv_output','csv_output_id',<!--{$item.sql_id}-->); return false;"><span>CSV出力</span></a>
                                <a class="btn-normal" href="javascript:;" name='del' onclick="fnTargetSelf(); eccube.common.fnFormModeSubmit('form1','delete','sql_id',<!--{$item.sql_id}-->); return false;"><span>削除</span></a>
                            </div>
                        </td>
                    </tr>
                <!--{/foreach}-->
        ...
        <div class="btn addnew">
            <a class="btn-normal" href="javascript:;" name='subm' onclick="fnTargetSelf(); eccube.common.fnFormModeSubmit('form1','new_page','',''); return false;"><span>SQLを新規入力</span></a>
        </div>
        ...
        <div class="btn-area">
            <ul>
                <li><a class="btn-action" href="javascript:;" name="subm" onclick="fnTargetSelf(); eccube.common.fnFormModeSubmit('form1', 'confirm', '', '')"><span class="btn-next">この内容で登録する</span></a></li>
            </ul>
        </div>
