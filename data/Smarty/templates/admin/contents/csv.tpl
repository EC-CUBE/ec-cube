										...
										<tr class="fs12n">
												...
												<table width="270" border="1" cellspacing="0" cellpadding="3" summary=" ">
													...
													<tr class="fs12n">
														<td bgcolor="#ffffff" align="center">
															...
															<select multiple name="output_list[]" size="30" style="<!--{$arrErr.output_list|sfGetErrorColor}-->; width:250px; height:4250px;">
											...
											<td bgcolor="#ffffff" align="right">
												<table width="270" border="1" cellspacing="0" cellpadding="3" summary=" ">
													...
													<tr class="fs12n">
														<td bgcolor="#ffffff" align="center">
															<select multiple name="choice_list[]" size="30" style="width:250px; height:400px;">
