										...
										<td><span class="red"><!--{$arrErr.select_file}--></span>
											<div id="file_view">
												<table border="0" cellspacing="0" cellpadding="2" summary=" ">
													...
													<!--{if !$tpl_is_top_dir}-->
													<tr class="fs12n" id="parent_dir" onclick="fnSetFormVal('form1', 'select_file', '<!--{$tpl_parent_dir|escape}-->');fnSelectFile('parent_dir', '#808080');" onDblClick="fnDbClick(arrTree, '<!--{$tpl_parent_dir|escape}-->', true, '<!--{$tpl_now_dir|escape}-->', 1)" style="" onMouseOver="fnChangeBgColor('parent_dir', '#808080');" onMouseOut="fnChangeBgColor('parent_dir', '');">
														<td>
