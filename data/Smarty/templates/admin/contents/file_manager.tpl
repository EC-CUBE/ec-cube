										...
										<td><span class="red"><!--{$arrErr.select_file}--></span>
											<div id="file_view">
												<table border="0" cellspacing="0" cellpadding="5" summary=" ">
													...
													<tr class="fs12n" id="<!--{$id}-->" onclick="fnSetFormVal('form1', 'select_file', '<!--{$arrFileList[cnt].file_path|escape}-->');fnSelectFile('<!--{$id}-->', '#808080');" <!--{if $arrFileList[cnt].is_dir}-->onDblClick="fnFolderOpen('<!--{$arrFileList[cnt].file_path|escape}-->')"<!--{/if}--> style="" onMouseOver="fnChangeBgColor('<!--{$id}-->', '#808080');" onMouseOut="fnChangeBgColor('<!--{$id}-->', '');">
														<td>
