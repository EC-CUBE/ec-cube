						...
						<table width="706" border="0" cellspacing="0" cellpadding="0" summary=" ">
							...
							<tr>
								...
								<table width="678" border="1" cellspacing="1" cellpadding="8" summary=" ">
									<tr class="fs12n">
										<td width="150">現在のディレクトリ：</td>
										<td width="528"><!--{$tpl_now_dir}--></td>
									</tr>
								</table>
								<table width="678" border="0" cellspacing="1" cellpadding="8" summary=" ">
									<tr class="fs12n">
										<td bgcolor="#f2f1ec">ファイルのアップロード</td>
										<td bgcolor="#ffffff"><input type="file" name="upload_file" class="box60"><input type="button" onclick="setTreeStatus('tree_status');fnModeSubmit('upload','',''); return false;" value="アップロード"></td>
									</tr>
									<tr class="fs12n">
										<td bgcolor="#f2f1ec">フォルダ作成</td>
										<td bgcolor="#ffffff"><input type="text" name="create_file" value="" class="box68"><input type="button" onclick="setTreeStatus('tree_status');fnModeSubmit('create','',''); return false;" value="作成"></td>
									</tr>
									<thead>
								</table>
								</form>
