    ...
    <div id="admin-contents" class="contents-main">
        ...
        <div id="contents-filemanager-right">
            <table class="now_dir">
                <tr>
                    ...
                    <td>
                        ...
                        <input type="file" name="upload_file" size="40" <!--{if $arrErr.upload_file}-->style="background-color:<!--{$smarty.const.ERR_COLOR|h}-->"<!--{/if}--> /><a class="btn-normal" href="javascript:;" onclick="setTreeStatus('tree_status');eccube.common.setModeAndSubmit('upload','',''); return false;">アップロード</a>
                    </td>
                </tr>
                <tr>
                    <th>フォルダ作成</th>
                    <td>
                        ...
                        <input type="text" name="create_file" value="" style="width:336px;<!--{if $arrErr.create_file}--> background-color:<!--{$smarty.const.ERR_COLOR|h}--><!--{/if}-->" /><a class="btn-normal" href="javascript:;" onclick="setTreeStatus('tree_status');eccube.common.setModeAndSubmit('create','',''); return false;">作成</a>
                    </td>
                </tr>
            </table>
            <h2><!--{* jQuery で挿入される *}--></h2>
            <table class="list">
                ...
                <!--{if !$tpl_is_top_dir}-->
                    <tr id="parent_dir" onclick="eccube.common.setValue('select_file', '<!--{$tpl_parent_dir|h}-->', 'form1');fnSelectFile('parent_dir', '#808080');" onDblClick="setTreeStatus('tree_status');fnDbClick(arrTree, '<!--{$tpl_parent_dir|h}-->', true, '<!--{$tpl_now_dir|h}-->', true)" style="">
                        <td>
                ...
                <!--{section name=cnt loop=$arrFileList}-->
                    ...
                    <tr id="<!--{$id}-->" style="">
                        ...
                        <!--{if $arrFileList[cnt].is_dir}-->
                            <td class="center">
                                <a href="javascript:;" onclick="eccube.common.setValue('tree_select_file', '<!--{$arrFileList[cnt].file_path}-->', 'form1');fnSelectFile('<!--{$id}-->', '#808080');eccube.common.setModeAndSubmit('move','',''); return false;">表示</a>
                            </td>
                        <!--{else}-->
                            <td class="center">
                                <a href="javascript:;" onclick="eccube.common.setValue('select_file', '<!--{$arrFileList[cnt].file_path|h}-->', 'form1');fnSelectFile('<!--{$id}-->', '#808080');eccube.common.setModeAndSubmit('view','',''); return false;">表示</a>
                            </td>
                        <!--{/if}-->
                        <!--{if $arrFileList[cnt].is_dir}-->
                            <!--{* ディレクトリはダウンロード不可 *}-->
                        ...
                        <!--{else}-->
                            <td class="center">
                                <a href="javascript:;" onclick="eccube.common.setValue('select_file', '<!--{$arrFileList[cnt].file_path|h}-->', 'form1');fnSelectFile('<!--{$id}-->', '#808080');setTreeStatus('tree_status');eccube.common.setModeAndSubmit('download','',''); return false;">ダウンロード</a>
                            </td>
                        <!--{/if}-->
                        <td class="center">
                            <a href="javascript:;" onclick="eccube.common.setValue('select_file', '<!--{$arrFileList[cnt].file_path|h}-->', 'form1');fnSelectFile('<!--{$id}-->', '#808080');setTreeStatus('tree_status');eccube.common.setModeAndSubmit('delete','',''); return false;">削除</a>
                        </td>
                    </tr>
                <!--{/section}-->
            </table>
