							...
							<tr valign="top">
								...
								<table width="678" border="0" cellspacing="1" cellpadding="8" summary=" ">
									...
									<tr class="fs12n">
										...
										<td bgcolor="#ffffff"><span class="red"><!--{$arrErr.create_file}--></span><input type="text" name="create_file" value="" style="width:359px;<!--{if $arrErr.create_file}--> background-color:<!--{$smarty.const.ERR_COLOR|escape}--><!--{/if}-->"><input type="button" onclick="setTreeStatus('tree_status');fnModeSubmit('create','',''); return false;" value="作成"></td>
									</tr>
									<thead>
								</table>
								<!--▲ファイル管理テーブルここまで-->
