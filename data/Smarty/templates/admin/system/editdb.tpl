...
<form name="index_form" method="post" action="?">
    ...
    <div class="btn">
        <a class="btn-action" href="javascript:;" onclick="eccube.common.fnFormModeSubmit('index_form', 'confirm', '', '');"><span class="btn-next">変更する</span></a>
    </div>
    <table class="list">
        <col width="5%" />
        <col width="5%" />
    ...
    <a class="btn-action" href="javascript:;" onclick="eccube.common.fnFormModeSubmit('index_form', 'confirm', '', ''); return false;"><span class="btn-next">変更する</span></a>
</form>
