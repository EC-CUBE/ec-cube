...
<form name="form1" id="form1" method="post" action="">
    ...
    <div class="btn-area">
        <ul>
            <li><a class="btn-action" href="javascript:;" onclick="if (!fnConfirm()) return false; eccube.fnFormModeSubmit('form1', '<!--{$tpl_mode|h}-->', '', ''); return false;"><span class="btn-next">この内容で登録する</span></a></li>
        </ul>
    </div>
</form>
