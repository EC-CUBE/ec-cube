								...
								<table width="678" border="0" cellspacing="1" cellpadding="4" summary=" ">
									...
									<tr bgcolor="#ffffff" class="fs12">
										...
										<!--{if $arrUpdate[cnt].now_version != ""}-->
											<span class="icon_confirm"><a href="#" onclick="win01('./load_module.php?module_id=<!--{$arrUpdate[cnt].module_id}-->','module<!--{$arrUpdate[cnt].module_id}-->','<!--{$arrUpdate[cnt].module_x}-->','<!--{$arrUpdate[cnt].module_y}-->'); return false;">実行</a></span>
										<!--{else}-->
											-
										<!--{/if}-->
										</td>
