...
<form name="form1" id="form1" method="post" action="">
    ...
    <div id="system" class="contents-main">
        ...
        <div class="btn">
            <a class="btn-action" href="javascript:;" onclick="eccube.common.win02('./input.php','input','620','450'); return false;"><span class="btn-next">メンバーを新規入力</span></a>
        </div>
        <!--▼メンバー一覧ここから-->
        <table class="list">
            <col width="15%" />
            ...
            <tr>
                ...
                <td align="center"><a href="#" onclick="eccube.common.win02('./input.php?id=<!--{$list_data[data].member_id}-->&amp;pageno=<!--{$tpl_disppage}-->','member_edit','620','450'); return false;">編集</a></td>
