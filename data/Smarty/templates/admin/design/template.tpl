						...
						<table width="706" border="0" cellspacing="0" cellpadding="0" summary=" ">
							...
							<tr>
								...
								<table width="678" border="0" cellspacing="1" cellpadding="8" summary=" ">
									...
									<tr class="fs12n">
										<td bgcolor="#ffffff" align="center"><img height=500 width=500 src=<!--{$arrTemplate.image[$MainImage]}--> name="main_img" ></td>
									</tr>
								</table>
								...
								<table width="678" border="0" cellspacing="1" cellpadding="8" summary=" ">
									...
									<!--{*foreach key=key item=item from=$arrTemplate.image*}-->
										...
										<td bgcolor="#ffffff" align="center"><!--{$arrTemplate[template]}-->
											<label for="radio<!--{$key}-->"><img height=200 wight=200 src="<!--{$image}-->" name="1"></label><br>
