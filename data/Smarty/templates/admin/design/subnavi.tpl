...
<ul class="level1">
  <li><a><span>PC</span></a>
    <ul class="level2">
      ...
      <li<!--{if $tpl_subno == 'header'}--> class="on"<!--{/if}--> id="navi-design-header"><a href="<!--{$smarty.const.URL_DIR}-->admin/design/header.php?device_type_id=<!--{$smarty.const.DEVICE_TYPE_PC}-->"><span>ﾍｯﾀﾞｰ/ﾌｯﾀｰ設定</span></a></li>
