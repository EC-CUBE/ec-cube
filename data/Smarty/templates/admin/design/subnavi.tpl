...
<table width="141" border="0" cellspacing="0" cellpadding="0" summary=" " id="menu_navi">
	...
	<!--{if $tpl_subno == 'template'}-->
		...
		<tr><td><img src="<!--{$smarty.const.URL_DIR}-->img/contents/navi_subline.gif" width="140" height="2" alt=""></td></tr>
		<tr><td class=<!--{if $tpl_subno_template != 'upload'}-->"subnavi"<!--{else}-->"subnavi-on"<!--{/if}-->><a href="./template.php?tpl_subno_template=<!--{$arrSubnavi.title.5}-->"	onMouseOver="naviStyleChange('upload', '#b7b7b7')" <!--{if $tpl_subno_template != 'upload'}-->onMouseOut="naviStyleChange('upload', '#818287')"<!--{/if}--> id="upload"><span class="subnavi_text">アップロード</span></a></td></tr>
		<tr><td><img src="<!--{$smarty.const.URL_DIR}-->img/contents/navi_subline.gif" width="140" height="2" alt=""></td></tr>
	<!--{/if}-->
