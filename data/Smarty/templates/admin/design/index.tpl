...
<form name="form1" id="form1" method="post" action="?">
    ...
    <div id="design" class="contents-main">
        ...
        <div style="float: left; width: 25%;" align="center">
            ...
            <div class="btn"><a class="btn-normal" href="javascript:;" onclick="fnTargetSelf(); eccube.common.fnFormModeSubmit('form1','new_bloc','',''); return false;"><span>ブロックを新規入力</span></a></div>
        </div>
        <!--{* ▲未使用ブロックここまで *}-->
            <div class="btn-area">
                <ul>
                ...
                <!--{/if}-->
                    <li><a class="btn-action" href="javascript:;" name='subm' onclick="fnTargetSelf(); eccube.common.fnFormModeSubmit('form1','confirm','',''); return false;"><span class="btn-next">登録する</span></a></li>
                </ul>
            </div>
        <!--▲レイアウト編集　ここまで-->
        ...
        <div class="btn addnew">
            <a class="btn-normal" href="javascript:;" onclick="fnTargetSelf(); eccube.common.fnFormModeSubmit('form1','new_page','',''); return false;"><span>ページを新規入力</span></a>
        </div>
        <table class="list">
        <tr>
            <th>名称</th>
        ...
        <!--{foreach key=key item=item from=$arrEditPage}-->
            <tr style="background-color:<!--{if $item.page_id == $page_id}--><!--{$smarty.const.SELECT_RGB}--><!--{else}-->#ffffff<!--{/if}-->;">
                ...
                <td class="center">
                    <!--{if $item.edit_flg == 1}-->
                        <a href="#" onclick="fnTargetSelf(); eccube.common.fnFormModeSubmit('form1','delete','page_id','<!--{$item.page_id|h}-->'); return false;">削除</a>
                    <!--{/if}-->
                </td>
            </tr>
        <!--{/foreach}-->
