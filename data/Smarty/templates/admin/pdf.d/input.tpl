								...
								<td bgcolor="#cccccc">
									...
									<table width="440" border="0" cellspacing="1" cellpadding="8" summary=" ">
										...
										<tr class="fs12">
											...
											1行目：<input type="text" name="chohyo_msg1" size="40" value="<!--{$arrForm.chohyo_msg1}-->" maxlength="<!--{$smarty.const.STEXT_LEN*3/5}-->"/><br />
											<!--{if $arrErr.chohyo_msg2}--><span class="red"><!--{$arrErr.chohyo_msg1}--></span><!--{/if}-->
											2行目：<input type="text" name="chohyo_msg2" size="40" value="<!--{$arrForm.chohyo_msg2}-->" maxlength="<!--{$smarty.const.STEXT_LEN*3/5}-->"/><br />
											<!--{if $arrErr.chohyo_msg3}--><span class="red"><!--{$arrErr.chohyo_msg3}--></span><!--{/if}-->
											3行目：<input type="text" name="chohyo_msg3" size="40" value="<!--{$arrForm.chohyo_msg3}-->" maxlength="<!--{$smarty.const.STEXT_LEN*3/5}-->"/><br />
									...
									<table width="440" border="0" cellspacing="0" cellpadding="0" summary=" ">
										...
										<tr>
											...
											<table border="0" cellspacing="0" cellpadding="0" summary=" ">
												<tr>
													<td><input type="button" name="pdf_input" value="この内容で作成する" onclick="return lfPopwinSubmit('form1');" /></td>
												</tr>
											</table>
											</td>
											<td bgcolor="#cccccc"><img src="<!--{$smarty.const.URL_DIR}-->img/common/_.gif" width="1" height="10" alt=""></td>
