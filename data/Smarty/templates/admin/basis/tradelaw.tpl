...
<div id="basis" class="contents-main">
  <table class="form">
    ...
    <tr>
      ...
      <a class="btn-normal" href="javascript:;" name="address_input" onclick="fnCallAddress('<!--{$smarty.const.INPUT_ZIP_URL_PATH}-->', 'law_zip01', 'law_zip02', 'law_pref', 'law_addr01');">住所入力</a>
      </td>
    </tr>
    <tr>
  ...
  <div class="btn-area">
    <ul>
      <li><a class="btn-action" href="javascript:;" onclick="fnFormModeSubmit('form1', '<!--{$tpl_mode}-->', '', '');"><span class="btn-next">この内容で登録する</span></a></li>
    </ul>
  </div>
</div>
</form>
