						...
						<table width="706" border="0" cellspacing="0" cellpadding="0" summary=" ">
							...
							<tr>
								...
								<table width="678" border="0" cellspacing="1" cellpadding="8" summary=" ">
									<tr>
										<td bgcolor="#f2f1ec" width="160" class="fs12n">販売業者<span class="red"> *</span></td>
									...
									<tr>
										<td bgcolor="#f2f1ec" width="160" class="fs12n">運営責任者<span class="red"> *</span></td>
										<td bgcolor="#ffffff" width="557" class="fs10n">
									...
									<tr>
										<td bgcolor="#f2f1ec" width="160" class="fs12">所在地<span class="red"> *</span></td>
										<td bgcolor="#ffffff" width="557">
									...
									<tr>
										<td bgcolor="#f2f1ec" width="160" class="fs12n">メールアドレス<span class="red"> *</span></td>
										<td bgcolor="#ffffff" width="557" class="fs10n">
									...
									<tr>
										<td bgcolor="#f2f1ec" width="160" class="fs12n">URL<span class="red"> *</span></td>
										<td bgcolor="#ffffff" width="557" class="fs10n">
									...
									<tr>
										<td bgcolor="#f2f1ec" width="160" class="fs12n">商品代金以外の必要料金<span class="red"> *</span></td>
										<td bgcolor="#ffffff" width="557" class="fs10n">
									...
									<tr>
										<td bgcolor="#f2f1ec" width="160" class="fs12n">注文方法<span class="red"> *</span></td>
										<td bgcolor="#ffffff" width="557" class="fs10n">
									...
									<tr>
										<td bgcolor="#f2f1ec" width="160" class="fs12n">支払方法<span class="red"> *</span></td>
										<td bgcolor="#ffffff" width="557" class="fs10n">
									...
									<tr>
										<td bgcolor="#f2f1ec" width="160" class="fs12n">支払期限<span class="red"> *</span></td>
										<td bgcolor="#ffffff" width="557" class="fs10n">
									...
									<tr>
										<td bgcolor="#f2f1ec" width="160" class="fs12n">引き渡し時期<span class="red"> *</span></td>
										<td bgcolor="#ffffff" width="557" class="fs10n">
									...
									<tr>
										<td bgcolor="#f2f1ec" width="160" class="fs12n">返品・交換について<span class="red"> *</span></td>
										<td bgcolor="#ffffff" width="557" class="fs10n">
