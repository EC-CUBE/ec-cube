...
<form name="form1" id="form1" method="post" action="">
    ...
    <div id="basis" class="contents-main">
        <table class="form">
            ...
            <tr>
                ...
                <td>
                    ...
                    <a class="btn-normal" href="javascript:;" name="address_input" onclick="eccube.common.getAddress('<!--{$smarty.const.INPUT_ZIP_URLPATH}-->', 'law_zip01', 'law_zip02', 'law_pref', 'law_addr01'); return false;">所在地入力</a>
                </td>
            </tr>
            <tr>
        ...
        <div class="btn-area">
            <ul>
                <li><a class="btn-action" href="javascript:;" onclick="eccube.common.fnFormModeSubmit('form1', '<!--{$tpl_mode}-->', '', ''); return false;"><span class="btn-next">この内容で登録する</span></a></li>
            </ul>
        </div>
    </div>
</form>
