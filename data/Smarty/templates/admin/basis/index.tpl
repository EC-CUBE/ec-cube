							...
							<tr>
								...
								<table width="678" border="0" cellspacing="1" cellpadding="8" summary=" ">
									...
									<tr class="fs12n">
										...
										少数第<input type="text" name="tax" value="<!--{$arrForm.digit|escape}-->" maxlength="<!--{$smarty.const.INT_LEN}-->" size="3" class="box3" style="<!--{if $arrErr.digit != ""}-->background-color: <!--{$smarty.const.ERR_COLOR}--><!--{/if}-->" /> 位</td>
									</tr>
									<tr class="fs12n">
