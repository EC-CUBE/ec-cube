...
<form name="form1" id="form1" method="post" action="?">
    ...
    <div id="basis" class="contents-main">
        ...
        <table summary="基本情報" id="basis-index-basis">
            ...
            <tr>
                ...
                <td>
                    ...
                    <a class="btn-normal" href="javascript:;" name="address_input" onclick="eccube.common.getAddress('<!--{$smarty.const.INPUT_ZIP_URLPATH}-->', 'zip01', 'zip02', 'pref', 'addr01'); return false;">所在地入力</a>
                </td>
            </tr>
            <tr>
        ...
        <div class="btn-area">
            <ul>
                <li><a class="btn-action" href="javascript:;" onclick="eccube.common.submitForm(); return false;"><span class="btn-next">確認ページへ</span></a></li>
            </ul>
        </div>
    </div>
