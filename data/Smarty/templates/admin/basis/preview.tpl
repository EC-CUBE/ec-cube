							...
							<tr>
								...
								<table width="678" border="0" cellspacing="1" cellpadding="8" summary=" ">
									...
									<tr>
										...
										<textarea  name="body" maxlength="<!--{$arrForm[$key].length}-->" style="<!--{$arrErr[$key]|sfGetErrorColor}-->" cols="60" rows="12" class="area75" disabled="true"><!--{$list_data.body|escape}--></textarea></td>
									</tr>						
								</table>
