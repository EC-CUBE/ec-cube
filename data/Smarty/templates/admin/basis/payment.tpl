							...
							<tr>
								...
								<table width="678" border="0" cellspacing="1" cellpadding="8" summary=" ">
									...
									<tr bgcolor="#ffffff" class="fs12n">
										...
										<td align="center"><!--{if $arrPayment[cnt].fix != 1}--><a href="<!--{$smarty.server.PHP_SELF}-->" onclick="win03('./payment_input.php?mode=pre_edit&payment_id=<!--{$arrPaymentListFree[cnt].payment_id}-->','payment_input','530','400'); return false;">編集</a><!--{/if}--></td>
