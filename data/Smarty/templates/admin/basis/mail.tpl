    ...
    <div id="basis" class="contents-main">
        <table>
            ...
            <tr>
                ...
                <div>
                    <a class="btn-normal" href="javascript:;" onclick="eccube.common.countChars('form1','header','cnt_header'); return false;"><span>文字数カウント</span></a>
                    今までに入力したのは
            ...
            <tr>
                ...
                <div>
                    <a class="btn-normal" href="javascript:;" onclick="eccube.common.countChars('form1','footer','cnt_footer'); return false;"><span>文字数カウント</span></a>
                    今までに入力したのは
        ...
        <div class="btn-area">
            <ul>
                <li><a class="btn-action" href="javascript:;" onclick="eccube.common.fnFormModeSubmit('form1', 'regist', '', ''); return false;"><span class="btn-next">この内容で登録する</span></a></li>
            </ul>
        </div>
    </div>
</form>
