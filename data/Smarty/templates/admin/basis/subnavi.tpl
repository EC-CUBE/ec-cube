...
<table width="141" border="0" cellspacing="0" cellpadding="0" summary=" ">
	...
	<tr><td class=<!--{if $tpl_subno != 'tradelaw'}-->"navi"<!--{else}-->"navi-on"<!--{/if}--> ><a href="./tradelaw.php"><img src="/img/contents/icon.jpg" width="15" height="9" alt="" border="0" OnMouseOver="document.bgColor='#FFFFFF'"><span class="navi_text">特定商取引法</span></a></td></tr>
	<tr><td><img src="/img/contents/navi_line.gif" width="140" height="2" alt=""></td></tr>
