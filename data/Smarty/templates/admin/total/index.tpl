  ...
  <tr>
    ...
    <td>
      <form name="search_form1" id="search_form1" method="post" action="?">
        ...
        <a class="btn-normal" href="javascript:;" onclick="fnFormModeSubmit('search_form1', 'search', '', '');" name="subm">月度で集計する</a>
      </form>
    </td>
  </tr>
  <tr>
    ...
    <td>
      <form name="search_form2" id="search_form2" method="post" action="?">
        ...
        <a class="btn-normal" href="javascript:;" onclick="fnFormModeSubmit('search_form2', 'search', '', '');" name="subm">期間で集計する</a>
      </form>
    </td>
  </tr>
</table>
...
<!--{/foreach}-->  
  ...
  <div class="btn">
    <a class="btn-normal" href="javascript:;" onclick="fnModeSubmit('csv','','');"><span>CSVダウンロード</span></a>
  </div>
