		...
		<table width="534" border="0" cellspacing="0" cellpadding="0" summary=" ">
			<tr>
				...
				<table width="" border="0" cellspacing="0" cellpadding="0" summary=" ">
					...
					<tr>
						<td align="center"><input type="image" onMouseover="chgImgImageSubmit('/img/contents/btn_back_on.jpg',this)" onMouseout="chgImgImageSubmit('/img/contents/btn_back.jpg',this)" src="/img/contents/btn_back.jpg" width="123" height="24" alt="ログインページにページに戻る" border="0" name="back" onclick="location.href='<!--{$smarty.const.URL_LOGIN}-->';"></td>
					</tr>
					<tr><td height="60"></td></tr>
				</table>
				</td>
