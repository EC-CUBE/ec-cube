...
<!--{/foreach}-->
	<tr valign="top">
		<td background=contents/navi_bg.gif" height="402">
			<!-- サブナビ -->
		...
		<table width="737" border="0" cellspacing="0" cellpadding="0" summary=" ">
			...
			<tr>
				...
				<table width="706" border="0" cellspacing="0" cellpadding="0" summary=" ">
					...
					<tr>
						<td colspan="3"><img src=contents/main_top.jpg" width="706" height="14" alt=""></td>
					</tr>
					<tr>
						<td background=contents/main_left.jpg"><img src=common/_.gif" width="14" height="1" alt=""></td>
						<td bgcolor="#cccccc">
						<table width="678" border="0" cellspacing="0" cellpadding="0" summary=" ">
							<tr>
								<td colspan="3"><img src=contents/contents_title_top.gif" width="678" height="7" alt=""></td>
							</tr>
							<tr>
								<td background=contents/contents_title_left_bg.gif"><img src=contents/contents_title_left.gif" width="22" height="12" alt=""></td>
								<td bgcolor="#636469" width="638" class="fs14n"><span class="white"><!--コンテンツタイトル-->検索条件設定</span></td>
								<td background=contents/contents_title_right_bg.gif"><img src=common/_.gif" width="18" height="1" alt=""></td>
							</tr>
							<tr>
								<td colspan="3"><img src=contents/contents_title_bottom.gif" width="678" height="7" alt=""></td>
							</tr>
							<tr>
								<td colspan="3"><img src=contents/main_bar.jpg" width="678" height="10" alt=""></td>
							</tr>
						</table>
						<!--検索条件設定テーブルここから-->
						...
						<table width="678" border="0" cellspacing="0" cellpadding="0" summary=" ">
							<tr>
								<td bgcolor="#cccccc"><img src=common/_.gif" width="1" height="5" alt=""></td>
								<td><img src=contents/tbl_top.gif" width="676" height="7" alt=""></td>
								<td bgcolor="#cccccc"><img src=common/_.gif" width="1" height="5" alt=""></td>
							</tr>
							<tr>
								<td bgcolor="#cccccc"><img src=common/_.gif" width="1" height="10" alt=""></td>
								...
								<table border="0" cellspacing="0" cellpadding="0" summary=" ">
									<tr>
										...
										<td><img src=common/_.gif" width="10" height="1" alt=""></td>
										<td><input type="image" name="subm" onMouseover="chgImgImageSubmit('../../img/contents/btn_search_on.jpg',this)" onMouseout="chgImgImageSubmit('../../img/contents/btn_search.jpg',this)" src=contents/btn_search.jpg" width="123" height="24" alt="この条件で検索する" border="0" onClick="submit();" ></td>
									</tr>
								</table>
								</td>
								<td bgcolor="#cccccc"><img src=common/_.gif" width="1" height="10" alt=""></td>
							...
							<tr>
								<td colspan="3"><img src=contents/tbl_bottom.gif" width="678" height="8" alt=""></td>
							</tr>
						</table>
						<!--検索条件設定テーブルここまで-->
						</td>
						<td background=contents/main_right.jpg"><img src=common/_.gif" width="14" height="1" alt=""></td>
					</tr>
					<tr>
						<td colspan="3"><img src=contents/main_bottom.jpg" width="706" height="14" alt=""></td>
					</tr>
...
<input type="hidden" name="<!--{$key}-->" value="<!--{$item|escape}-->">
<!--{/foreach}-->		
	<tr><td colspan="2"><img src=contents/search_line.jpg" width="878" height="12" alt=""></td></tr>
	<tr bgcolor="cbcbcb">
		<td>
		<table border="0" cellspacing="0" cellpadding="0" summary=" ">
			<tr>
				<td><img src=contents/search_left.gif" width="19" height="22" alt=""></td>
				<td>
				<!--検索結果-->
				<table border="0" cellspacing="0" cellpadding="0" summary=" ">
					<tr>
						<td><img src=contents/reselt_left_top.gif" width="22" height="5" alt=""></td>
						<td background=contents/reselt_top_bg.gif"><img src=common/_.gif" width="1" height="5" alt=""></td>
						<td><img src=contents/reselt_right_top.gif" width="22" height="5" alt=""></td>
					</tr>
					<tr>
						<td background=contents/reselt_left_bg.gif"><img src=contents/reselt_left_middle.gif" width="22" height="12" alt=""></td>
						<td bgcolor="#393a48" class="white10">検索結果一覧　<span class="reselt"><!--検索結果数--><!--{$tpl_linemax}-->件</span>&nbsp;が該当しました。</td>
						<td background=contents/reselt_right_bg.gif"><img src=common/_.gif" width="22" height="8" alt=""></td>
					</tr>
					<tr>
						<td><img src=contents/reselt_left_bottom.gif" width="22" height="5" alt=""></td>
						<td background=contents/reselt_bottom_bg.gif"><img src=common/_.gif" width="1" height="5" alt=""></td>
						<td><img src=contents/reselt_right_bottom.gif" width="22" height="5" alt=""></td>
					</tr>
				</table>
				<!--検索結果-->
				...
				<td><img src=common/_.gif" width="8" height="1" alt=""></td>
				<td><a href="#" onmouseover="chgImg('../../img/contents/btn_csv_on.jpg','btn_csv');" onmouseout="chgImg('../../img/contents/btn_csv.jpg','btn_csv');"  onclick="fnModeSubmit('csv','','');" ><img src=contents/btn_csv.jpg" width="99" height="22" alt="CSV DOWNLOAD" border="0" name="btn_csv" id="btn_csv"></a></td>
				<td><img src=common/_.gif" width="8" height="1" alt=""></td>
	...
	<tr><td bgcolor="cbcbcb" colspan="2"><img src=common/_.gif" width="1" height="5" alt=""></td></tr>
</table>
