							...
							<tr>
								...
								<table border="0" cellspacing="0" cellpadding="0" summary=" ">
									<tr>
										...
										<td><input type="image" name="subm" onMouseover="chgImgImageSubmit('contents/btn_search_on.jpg',this)" onMouseout="chgImgImageSubmit('contents/btn_search.jpg',this)" src="contents/btn_search.jpg" width="123" height="24" alt="この条件で検索する" border="0" onClick="submit();" ></td>
									</tr>
								</table>
								</td>
								<td bgcolor="#cccccc"><img src="common/_.gif" width="1" height="10" alt=""></td>
	...
	<tr bgcolor="cbcbcb">
		...
		<table border="0" cellspacing="0" cellpadding="0" summary=" ">
			<tr>
				...
				<td><a href="#" onmouseover="chgImg('contents/btn_csv_on.jpg','btn_csv');" onmouseout="chgImg('contents/btn_csv.jpg','btn_csv');"  onclick="fnModeSubmit('csv','','');" ><img src="contents/btn_csv.jpg" width="99" height="22" alt="CSV DOWNLOAD" border="0" name="btn_csv" id="btn_csv"></a></td>
				<td><img src="common/_.gif" width="8" height="1" alt=""></td>
