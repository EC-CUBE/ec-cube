    ...
    <form name="search_form" method="post" action="?" >
        ...
        <div class="btn">
            ...
            <div class="btn-area">
                <ul>
                    <li>
                        <a class="btn-action" href="javascript:;" onclick="eccube.common.fnFormModeSubmit('search_form', 'search', '', ''); return false;"><span class="btn-next">この条件で検索する</span></a></li>
                </ul>
            </div>
        </div>
    </form>
    ...
    <!--{if count($arrErr) == 0 and ($smarty.post.mode == 'search' or $smarty.post.mode == 'delete')}-->
        ...
        <form name="form1" id="form1" method="post" action="?">
            ...
            <div class="btn">
                ...
                <!--{/if}-->
                <a class="btn-normal" href="javascript:;" onclick="eccube.common.setModeAndSubmit('csv','',''); return false;"><span>CSV ダウンロード</span></a>
            </div>
                ...
                <table id="products-review-result" class="list">
                    ...
                    <!--{section name=cnt loop=$arrReview}-->
                        <tr>
                            ...
                            <td class="menu"><a href="javascript:;" onclick="eccube.common.changeAction('./review_edit.php'); eccube.common.setModeAndSubmit('','review_id','<!--{$arrReview[cnt].review_id}-->'); return false;">編集</a></td>
                            <td class="menu"><a href="javascript:;" onclick="eccube.common.setModeAndSubmit('delete','review_id','<!--{$arrReview[cnt].review_id}-->'); return false;">削除</a></td>
                        </tr>
                    <!--{/section}-->
                </table>
                <!--検索結果表示テーブル-->
