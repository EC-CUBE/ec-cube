					...
					<tr>
						...
						<table width="678" border="0" cellspacing="1" cellpadding="8" summary=" ">
							<tr class="fs12">
								...
								<td bgcolor="#ffffff" width="195"><span class="red"><!--{$arrErr.search_product_class_id}--></span><input type="text" name="search_product_class_id" value="<!--{$arrForm.search_product_class_id|escape}-->" size="30" class="box30" /></td>
							</tr>
							<tr class="fs12">
