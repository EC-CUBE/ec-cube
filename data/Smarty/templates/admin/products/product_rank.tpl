            ...
            <table class="list" id="categoryTable">
                ...
                <!--{section name=cnt loop=$arrProductsList}-->
                    <tr>
                        ...
                        <input type="text" name="pos-<!--{$arrProductsList[cnt].product_id}-->" size="3" class="box3" /><!--{t string="tpl_The first_01tpl_The first_01"}--><a href="?" onclick="fnModeSubmit('move','product_id', '<!--{$arrProductsList[cnt].product_id}-->'); return false;"><!--{t string="tpl_Move_01"}--></a><br />
                        <!--{/if}-->
