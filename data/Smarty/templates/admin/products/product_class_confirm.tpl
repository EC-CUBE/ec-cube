								...
								<table width="678" border="0" cellspacing="0" cellpadding="0" summary=" ">
									...
									<tr>
										...
										<table border="0" cellspacing="0" cellpadding="0" summary=" ">
											<tr>
												<td><a href="#" onmouseover="chgImg('/img/install/back_on.jpg','return')" onmouseout="chgImg('/img/install/back.jpg','return')" onclick="fnModeSubmit('confirm_return','',''); return false" /><img  width="123" src="/img/install/back.jpg"  height="24" alt="Á°¤ØÌá¤ë" border="0" name="return"></a>
												<!--{if $tpl_check > 0}-->
