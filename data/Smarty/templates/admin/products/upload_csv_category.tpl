...
<!--★★メインコンテンツ★★-->
<form name="form1" id="form1" method="post" action="?" enctype="multipart/form-data" onSubmit="eccube.common.winSubmit('','form1', 'upload', 500, 400)">
    ...
    <div id="products" class="contents-main">
        ...
        <div class="btn-area">
            <ul>
                <li><a class="btn-action" href="javascript:;" onclick="eccube.common.fnFormModeSubmit('form1', 'csv_upload', '', ''); return false;"><span class="btn-next">この内容で登録する</span></a></li>
            </ul>
        </div>
        <!--{if $arrRowErr}-->
        <table class="form">
