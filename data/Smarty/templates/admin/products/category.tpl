    ...
    <div id="products" class="contents-main">
        ...
        <div id="products-category-right">
            ...
            <div class="now_dir">
                    ...
                    <a class="btn-normal" href="javascript:;" onclick="eccube.common.setModeAndSubmit('edit','',''); return false;"><span class="btn-next">登録</span></a><span class="attention">&nbsp;（上限<!--{$smarty.const.STEXT_LEN}-->文字）</span>
            </div>
            ...
            <table class="list" id="categoryTable">
                ...
                <tr id="<!--{$arrList[cnt].category_id}-->" style="background:<!--{if $arrForm.category_id != $arrList[cnt].category_id}-->#ffffff<!--{else}--><!--{$smarty.const.SELECT_RGB}--><!--{/if}-->;" align="left">
                    ...
                    <!--{if $arrList[cnt].level != $smarty.const.LEVEL_MAX}-->
                        <a href="?" onclick="eccube.common.setModeAndSubmit('tree', 'parent_category_id', <!--{$arrList[cnt].category_id}-->); return false"><!--{$arrList[cnt].category_name|h}--></a>
                    <!--{else}-->
                    ...
                    <td class="center">
                        ...
                        <a href="?" onclick="eccube.common.setModeAndSubmit('pre_edit', 'category_id', <!--{$arrList[cnt].category_id}-->); return false;">編集</a>
                        <!--{else}-->
                        編集中
                        <!--{/if}-->
                    </td>
                    <td class="center">
                        <a href="?" onclick="eccube.common.setModeAndSubmit('delete', 'category_id', <!--{$arrList[cnt].category_id}-->); return false;">削除</a>
                    </td>
                    <td class="center">
                    <!--{* 移動 *}-->
                    <!--{if $smarty.section.cnt.iteration != 1}-->
                    <a href="?" onclick="eccube.common.setModeAndSubmit('up','category_id', <!--{$arrList[cnt].category_id}-->); return false;">上へ</a>
                    <!--{/if}-->
                    <!--{if $smarty.section.cnt.iteration != $smarty.section.cnt.last}-->
                    <a href="?" onclick="eccube.common.setModeAndSubmit('down','category_id', <!--{$arrList[cnt].category_id}-->); return false;">下へ</a>
                    <!--{/if}-->
                    </td>
