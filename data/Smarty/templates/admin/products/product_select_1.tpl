...
function func_submit( id ){
    window.opener.document.form1['recommend_id<!--{$smarty.get.no}-->'].value = id;
    window.opener.document.form1['mode'].value = 'recommend_select';
    window.opener.document.form1['anchor_key'].value = 'recommend_no<!--{$smarty.get.no}-->';
