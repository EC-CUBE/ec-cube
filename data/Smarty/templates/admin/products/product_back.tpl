...
<input type="hidden" name="recommend_product_id" value="" />
<input type="hidden" name="recommend_no" value="" />
...
<div id="products" class="contents-main">
                ...
                <table class="layout">
                    <tr>
                        ...
                        <td style="padding: 15px;">
                            ...
                            <a class="btn-normal" href="javascript:;" name="un_select" onclick="fnMoveSelect('category_id','category_id_unselect'); return false;">&nbsp;&nbsp;削除&nbsp;-&gt;&nbsp;&nbsp</a>
                        </td>
                        <td>
    ...
    <div id="recommend_select" style="<!--{if count($arrForm.arrRecommend) == 0}-->display:none<!--{/if}-->">
    <h2>関連商品</h2>
    <table class="form">
        <!--▼関連商品-->
        ...
        <tr>
            <th>関連商品(<!--{$num}-->)<br />
                <!--{if $arrForm.arrRecommend[$index].recommend_product_id}-->
                    <img src="<!--{$smarty.const.ROOT_URLPATH}-->resize_image.php?image=<!--{$arrForm.arrRecommend[$index].main_list_image|sfNoImageMainList|h}-->&width=65&height=65" alt="<!--{$arrForm.arrRecommend[$index].name|h}-->" />
                <!--{/if}-->
            </th>
            <td>
                <a name="recommend_no<!--{$num}-->"></a><!--{* アンカー *}-->
                <input type="hidden" name="recommend_product_id<!--{$num}-->" value="<!--{$arrForm.arrRecommend[$index].recommend_product_id|h}-->" />
                <input type="hidden" name="recommend_name<!--{$num}-->" value="<!--{$arrForm.arrRecommend[$index].name|h}-->" />
                <input type="hidden" name="recommend_product_code_min<!--{$num}-->" value="<!--{$arrForm.arrRecommend[$index].product_code_min|h}-->" />
                <input type="hidden" name="recommend_main_list_image<!--{$num}-->" value="<!--{$arrForm.arrRecommend[$index].main_list_image|h}-->" />
                ...
                <input type="checkbox" name="recommend_delete<!--{$num}-->" value="1" />削除<br />
                商品コード:<!--{$arrForm.arrRecommend[$index].product_code_min|h}--><br />
                商品名:<!--{$arrForm.arrRecommend[$index].name|h}--><br />
                <!--{assign var=key value="recommend_comment`$num`"}-->
                <span class="attention"><!--{$arrErr[$key]}--></span>
                <textarea name="<!--{$key}-->" cols="60" rows="8" class="area60" style="<!--{$arrErr[$key]|sfGetErrorColor}-->" ><!--{$arrForm.arrRecommend[$index].comment|h}--></textarea><br />
