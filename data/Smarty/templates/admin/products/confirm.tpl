						...
						<tr>
							...
							<table width="678" border="0" cellspacing="1" cellpadding="8" summary=" ">				
								...
								*}-->
								...
								<!--{if $tpl_movilink_flg}-->
									<tr class="fs12n">
										<td bgcolor="#f2f1ec" width="160">広告主様商品コード</td>
										<td bgcolor="#ffffff" width="557">
										<!--{assign var=key value="movilink_code1"}-->
										<!--{$arrForm[$key]}--><!--{if $arrForm[$key] != ""}--><!--{/if}--></td>
									</tr>
									<tr class="fs12n">
										<td bgcolor="#f2f1ec" width="160">商品名(フリガナ)</td>
										<td bgcolor="#ffffff" width="557">
										<!--{assign var=key value="movilink_kana"}-->
										<!--{$arrForm[$key]}--><!--{if $arrForm[$key] != ""}--><!--{/if}--></td>
									</tr>
									<tr class="fs12n">
										<td bgcolor="#f2f1ec" width="160">商品価格</td>
										<td bgcolor="#ffffff" width="557">
										<!--{assign var=key value="movilink_price"}-->
										<!--{$arrForm[$key]}--><!--{if $arrForm[$key] != ""}-->円<!--{/if}--></td>
									</tr>
									<tr class="fs12n">
										<td bgcolor="#f2f1ec" width="160">商品報酬率</td>
										<td bgcolor="#ffffff" width="557">
										<!--{assign var=key value="movilink_net_percent"}-->
										<!--{$arrForm[$key]}--><!--{if $arrForm[$key] != ""}-->％<!--{/if}--></td>
									</tr>
									<tr class="fs12n">
										<td bgcolor="#f2f1ec" width="160">商品報酬額</td>
										<td bgcolor="#ffffff" width="557">
										<!--{assign var=key value="movilink_net_fix"}-->
										<!--{$arrForm[$key]}--><!--{if $arrForm[$key] != ""}-->円<!--{/if}--></td>									</tr>
									<tr class="fs12n">
										<td bgcolor="#f2f1ec" width="160">広告タグ原稿</td>
										<td bgcolor="#ffffff" width="557">
