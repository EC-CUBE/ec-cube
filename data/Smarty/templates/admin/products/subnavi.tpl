...
*}-->
<ul class="level1">
<li<!--{if $tpl_subno == 'index'}--> class="on"<!--{/if}--> id="navi-products-index"><a href="<!--{$smarty.const.ROOT_URLPATH}--><!--{$smarty.const.ADMIN_DIR}-->products/<!--{$smarty.const.DIR_INDEX_PATH}-->"><span>商品マスタ</span></a></li>
...
<li<!--{if $tpl_subno == 'upload_csv_class'}--> class="on"<!--{/if}--> id="navi-products-uploadcsvclass"><a href="<!--{$smarty.const.ROOT_URLPATH}--><!--{$smarty.const.ADMIN_DIR}-->products/upload_csv_class.php"><span>規格登録CSV</span></a></li>
<!--{/if}-->
...
<li<!--{if $tpl_subno == 'upload_csv_productcategory'}--> class="on"<!--{/if}--> id="navi-products-upload-csv-productcategory"><a href="<!--{$smarty.const.ROOT_URLPATH}--><!--{$smarty.const.ADMIN_DIR}-->products/upload_csv_productcategory.php"><span>商品カテゴリ登録CSV</span></a></li>
