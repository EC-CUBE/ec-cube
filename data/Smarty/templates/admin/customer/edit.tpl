    ...
    <div id="customer" class="contents-main">
        <table class="form">
            ...
            <tr>
                ...
                <td>
                    ...
                    <a class="btn-normal" href="javascript:;" name="address_input" onclick="eccube.common.getAddress('<!--{$smarty.const.INPUT_ZIP_URLPATH}-->', 'zip01', 'zip02', 'pref', 'addr01'); return false;">住所入力</a>
                </td>
            </tr>
            <tr>
        ...
        <div class="btn-area">
            <ul>
                ...
                <li><a class="btn-action" href="javascript:;" onclick="eccube.common.setValueAndSubmit('form1', 'mode', 'confirm'); return false;"><span class="btn-next">確認ページへ</span></a></li>
            </ul>
        </div>
