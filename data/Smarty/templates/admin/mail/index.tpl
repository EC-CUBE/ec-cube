					...
					<tr>
						...
						<table width="678" border="0" cellspacing="0" cellpadding="0" summary=" ">
							...
							<tr>
								...
								<td bgcolor="#636469" width="638" class="fs14n"><span class="white"><!--コンテンツタイトル-->配信先検索条件設定<!--{if $arrIP > 0}--> (ブレインエンジン設定済み)<!--{/if}--></span></td>
...
<!--{if count($arrErr) == 2 and ($smarty.post.mode == 'search' or $smarty.post.mode == 'delete' or $smarty.post.mode == 'back') }-->
				...
				<tr>
					...
					<table width="840" border="0" cellspacing="1" cellpadding="5" summary=" ">
						...
						<tr bgcolor="#FFFFFF" class="fs12n">
							...
							<td align="center">-</td>
							<!--{else}-->
							<td align="center"><a href="<!--{$smarty.server.PHP_SELF|escape}-->" onclick="fnFormModeSubmit('form1','delete','result_email','<!--{$arrResults[i].email|escape}-->'); return false;">削除</a></td>	
							<!--{/if}-->
						</tr>
						<!--{/section}-->
					</table>
