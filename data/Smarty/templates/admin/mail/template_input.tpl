...
<div id="mail" class="contents-main">
    <table class="form">
        <tr>
            <th><!--{t string="tpl_352"}--><span class="attention"> *</span></th>
            <td>
    ...
    <div class="btn-area">
        <ul>
            <li><a class="btn-action" href="javascript:;" onclick="fnFormModeSubmit('form1', '<!--{$mode}-->', '', ''); return false;"><span class="btn-next"><!--{t string="tpl_021"}--></span></a></li>
        </ul>
    </div>
</div>
</form>
