										...
										<table border="0" cellspacing="0" cellpadding="0" summary=" ">
											<tr>
												<td>
													...
													<input type="image" onMouseover="chgImgImageSubmit('/img/contents/btn_search_back_on.jpg',this)" onMouseout="chgImgImageSubmit('/img/contents/btn_search_back.jpg',this)" src="/img/contents/btn_search_back.jpg" width="123" height="24" alt="検索画面に戻る" border="0" name="subm02" onClick="return fnInsertValAndSubmit( document.form1, 'mode', 'back', '' )">
													<input type="image" onMouseover="chgImgImageSubmit('/img/contents/btn_confirm_on.jpg',this)" onMouseout="chgImgImageSubmit('/img/contents/btn_confirm.jpg',this)" src="/img/contents/btn_confirm.jpg" width="123" height="24" alt="確認ページへ" border="0" name="subm03" onClick="return fnInsertValAndSubmit( document.form1, 'mode', 'regist_confirm', '' )" <!--{$list_data.template_id|sfGetEnabled}-->>
												</td>
											</tr>
										</table>
										</td>
