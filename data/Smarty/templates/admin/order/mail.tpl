					...
					<tr>
						...
						<table width="678" border="0" cellspacing="1" cellpadding="8" summary=" ">
							<tr>
							    ...
							    <td bgcolor="#ffffff" width="557" class="fs10n"><!--{$list_data.name01|escape}--> <!--{$list_data.name02|escape}--></td>
							</tr>
							<tr>
							    <td bgcolor="#f2f1ec" width="160" class="fs12n">メールアドレス</td>
							    <td bgcolor="#ffffff" width="557" class="fs10n"><!--{$list_data.email|escape}--></td>
							</tr>
							<tr>
