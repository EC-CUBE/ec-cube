    ...
    <div id="order" class="contents-main">
        ...
        <!--{if $tpl_linemax > 0}-->
            ...
            <table class="list">
                ...
                <col width="12%" />
                <tr>
                    <th><label for="move_check">選択<br /></label> <input type="checkbox" name="move_check" id="move_check" onclick="fnAllCheck(this, 'input[name=move[]]')" /></th>
                    <th>対応状況</th>
                    <th>注文番号</th>
                    <th>受注日</th>
                    <th>お名前</th>
                ...
                <tr style="background:<!--{$arrORDERSTATUS_COLOR[$status]}-->;">
                    ...
                    <td class="center"><a href="#" onclick="eccube.common.openWindow('./disp.php?order_id=<!--{$arrStatus[cnt].order_id}-->','order_disp','800','900'); return false;" ><!--{$arrStatus[cnt].order_id}--></a></td>
