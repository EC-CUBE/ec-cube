...
<div id="order" class="contents-main">
        ...
        <tr>
            ...
            <td>
                ...
                <!--{if $smarty.get.mode != 'add'}-->
                    <span class="attention"><!--{t string="tpl_* When %s1 is selected, restore the inventory count manually._01" %s1=$arrORDERSTATUS[$smarty.const.ORDER_CANCEL]}--></span>
                <!--{/if}-->
            </td>
        </tr>
        <tr>
    ...
    <table class="list" id="order-edit-products">
        ...
        <tr>
            ...
            <td class="right"><!--{t string="tpl_&#36; %s1_01" escape="none" %s1=$price|sfCalcIncTax|sfMultiply:$quantity|number_format}--></td>
        </tr>
        <!--{/section}-->
        <tr>
            <th colspan="5" class="column right"><!--{t string="tpl_Subtotal_01"}--></th>
            <td class="right"><!--{t string="tpl_&#36; %s1_01" escape="none" %s1=$arrForm.subtotal.value|number_format}--></td>
        </tr>
        <tr>
                    ...
                    <!--{section name=item loop=$arrShipping.shipment_product_class_id|@count}-->
                        ...
                        <tr>
                            ...
                            <td class="right">
                                ...
                                <!--{t string="tpl_&#36; %s1_01" escape="none" %s1=$arrShipping[$key][$item_index]|sfCalcIncTax|number_format}-->
                                <input type="hidden" name="<!--{$key}-->[<!--{$shipping_index}-->][<!--{$item_index}-->]" value="<!--{$arrShipping[$key][$item_index]|h}-->" />
                            </td>
                            <td class="right">
    ...
    <table class="form">
        ...
        <tr>
            ...
            <td>
                ...
                <!--{if $key != "title"}--><!--{if $item.name != ""}--><!--{t string="tpl_%s1:_01" %s1=$item.name}--><!--{/if}--><!--{$item.value}--><br/><!--{/if}-->
                <!--{/foreach}-->
            </td>
        </tr>
        <!--{/if}-->
