					...
					<table width="840" border="0" cellspacing="1" cellpadding="5" summary=" ">
						...
						<tr bgcolor="#636469" align="center" class="fs12n">
							...
							<tr bgcolor="<!--{$arrORDERSTATUS_COLOR[$status]}-->" class="fs12n">
								...
								<td align="center"><a href="./" onClick="win02('../pdf.d/input.php?order_id=<!--{$arrResults[cnt].order_id}-->','pdf_input','500','650'); return false;"><span class="icon_class">帳票</span></a><br /></td>
