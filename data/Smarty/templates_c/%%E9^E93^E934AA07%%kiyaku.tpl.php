...
img/entry/agree_title.jpg" width="580" height="40" alt="ご利用規約"></td>
			</tr>
...
img/entry/b_noagree.gif" width="180" height="30" alt="同意しない" border="0" name="b_noagree"></a>　 
				<?php else: ?>
...
img/entry/b_agree.gif" width="180" height="30" alt="規約に同意して会員登録" border="0" name="b_agree"></a>
                </td>
			</tr>
		</form>
		</table>
