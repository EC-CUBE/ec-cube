<?php /* Smarty version 2.6.13, created on 2007-01-18 09:23:39
         compiled from basis/delivery.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'basis/delivery.tpl', 10, false),)), $this); ?>
<!--★★メインコンテンツ★★-->
...
$this->_sections['cnt']['loop'] = is_array($_loop=$this->_tpl_vars['arrDelivList']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
?>
										<tr bgcolor="#ffffff" class="fs12n">
											<td><?php echo ((is_array($_tmp=$this->_tpl_vars['arrDelivList'][$this->_sections['cnt']['index']]['name'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</td>
											<td><?php echo ((is_array($_tmp=$this->_tpl_vars['arrDelivList'][$this->_sections['cnt']['index']]['service_name'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</td>
											<td align="center"><a href="<?php echo @URL_DIR; ?>
" onclick="fnChangeAction('./delivery_input.php'); fnModeSubmit('pre_edit', 'deliv_id', <?php echo $this->_tpl_vars['arrDelivList'][$this->_sections['cnt']['index']]['deliv_id']; ?>
...
" onclick="fnModeSubmit('delete', 'deliv_id', <?php echo $this->_tpl_vars['arrDelivList'][$this->_sections['cnt']['index']]['deliv_id']; ?>
...
" onclick="fnModeSubmit('up','deliv_id', '<?php echo $this->_tpl_vars['arrDelivList'][$this->_sections['cnt']['index']]['deliv_id']; ?>
'); return false;">上へ</a>
											<?php endif; ?>
											<?php if ($this->_sections['cnt']['iteration'] != $this->_sections['cnt']['last']): ?>
											<a href="<?php echo ((is_array($_tmp=$_SERVER['PHP_SELF'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
" onclick="fnModeSubmit('down','deliv_id', '<?php echo $this->_tpl_vars['arrDelivList'][$this->_sections['cnt']['index']]['deliv_id']; ?>
'); return false;">下へ</a>
											<?php endif; ?>
											</td>
										</tr>
...
img/common/_.gif" width="1" height="10" alt=""></td>
										...
										<table border="0" cellspacing="0" cellpadding="0" summary=" ">
											<tr>
												<td><input type="button" name="subm2" value="配送業者<?php if (@INPUT_DELIV_FEE): ?>・配送料<?php endif; ?>を追加" onclick="fnChangeAction('./delivery_input.php'); fnModeSubmit('pre_edit','','');" /></td>
											</tr>
										</table>
										</td>
										<td bgcolor="#cccccc"><img src="<?php echo @URL_DIR; ?>
