<?php /* Smarty version 2.6.13, created on 2007-01-19 12:59:10
         compiled from contents/csv.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'contents/csv.tpl', 156, false),array('modifier', 'sfGetErrorColor', 'contents/csv.tpl', 211, false),array('function', 'html_options', 'contents/csv.tpl', 212, false),)), $this); ?>
...
" onsubmit="lfnCheckList('output_list[]')">
<input type="hidden" name="mode" value="confirm">
<input type="hidden" name="tpl_subno_csv" value="<?php echo $this->_tpl_vars['tpl_subno_csv']; ?>
">
	<tr valign="top">
...
img/contents/contents_title_left.gif" width="22" height="12" alt=""></td>
											<td bgcolor="#636469" width="638" class="fs14n"><span class="white"><!--コンテンツタイトル--><?php echo $this->_tpl_vars['SubnaviName']; ?>
</span></td>
											<td background="<?php echo @URL_DIR; ?>
												...
												<table width="270" border="1" cellspacing="0" cellpadding="3" summary=" ">
													...
													<tr class="fs12n">
														<td bgcolor="#ffffff" align="center">
															<span class="red12"><?php echo $this->_tpl_vars['arrErr']['output_list']; ?>
</span>
															<select multiple name="output_list[]" size="30" style="<?php echo ((is_array($_tmp=$this->_tpl_vars['arrErr']['output_list'])) ? $this->_run_mod_handler('sfGetErrorColor', true, $_tmp) : sfGetErrorColor($_tmp)); ?>
; width:250px; height:425px;">
															<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['arrOutput']), $this);?>
												...
												<table width="270" border="1" cellspacing="0" cellpadding="3" summary=" ">
													...
													<tr class="fs12n">
														<td bgcolor="#ffffff" align="center">
															...
															<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['arrChoice']), $this);?>
