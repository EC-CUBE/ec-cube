...
final class EccubeEvents
{
     ...
     */
    // index
    const BLOCK_SEARCHPRODUCT_INDEX_INITIALIZE = 'block.searchproduct.index.initialize';
    const BLOCK_SEARCHPRODUCT_INDEX_COMPLETE = 'block.searchproduct.index.complete';
    /**
