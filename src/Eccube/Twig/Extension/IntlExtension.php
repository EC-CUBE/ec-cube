...
class IntlExtension extends AbstractExtension
{
    ...
    /**
     * format_date('medium', 'none')のショートカット.
     *
    ...
    public function date_day(Environment $env, $date)
    {
        ...
        return (new \Twig\Extra\Intl\IntlExtension())->formatDate($env, $date, 'medium', 'none');
    }

    /**
     * format_date('medium', 'short')のショートカット.
     *
    ...
    public function date_min(Environment $env, $date)
    {
        ...
        return (new \Twig\Extra\Intl\IntlExtension())->formatDate($env, $date, 'medium', 'short');
    }

    /**
     * format_date('medium', 'medium')のショートカット.
     *
    ...
    public function date_sec(Environment $env, $date)
    {
        ...
        return (new \Twig\Extra\Intl\IntlExtension())->formatDate($env, $date, 'medium', 'medium');
    }
    ...
    public function date_day_with_weekday(Environment $env, $date)
    {
        ...
        $date_day = (new \Twig\Extra\Intl\IntlExtension())->formatDate($env, $date, 'medium', 'none');
        // 曜日
