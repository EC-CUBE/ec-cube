...
class Version20150613000000 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql("INSERT INTO dtb_category (category_id, category_name, parent_category_id, hierarchy, rank, creator_id, create_date, update_date, del_flg, discriminator_type) VALUES (1, 'キッチンツール', NULL, 1, 5, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0, 'category');");
        $this->addSql("INSERT INTO dtb_category (category_id, category_name, parent_category_id, hierarchy, rank, creator_id, create_date, update_date, del_flg, discriminator_type) VALUES (2, 'インテリア', NULL, 1, 6, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0, 'category');");
        $this->addSql("INSERT INTO dtb_category (category_id, category_name, parent_category_id, hierarchy, rank, creator_id, create_date, update_date, del_flg, discriminator_type) VALUES (3, '食器', 1, 2, 3, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0, 'category');");
        $this->addSql("INSERT INTO dtb_category (category_id, category_name, parent_category_id, hierarchy, rank, creator_id, create_date, update_date, del_flg, discriminator_type) VALUES (4, '調理器具', 1, 2, 4, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0, 'category');");
        $this->addSql("INSERT INTO dtb_category (category_id, category_name, parent_category_id, hierarchy, rank, creator_id, create_date, update_date, del_flg, discriminator_type) VALUES (5, 'フォーク', 3, 3, 2, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0, 'category');");
        $this->addSql("INSERT INTO dtb_category (category_id, category_name, parent_category_id, hierarchy, rank, creator_id, create_date, update_date, del_flg, discriminator_type) VALUES (6, '新入荷', NULL, 1, 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0, 'category');");
