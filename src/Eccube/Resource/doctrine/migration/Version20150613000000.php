...
class Version20150613000000 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql("INSERT INTO dtb_block (device_type_id, block_id, block_name, file_name, create_date, update_date, logic_flg, deletable_flg) VALUES (10, 10, 'ギャラリー', 'gallery', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0, 0);");
