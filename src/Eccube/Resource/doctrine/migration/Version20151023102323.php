...
class Version20151023102323 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        if ($this->connection->getDatabasePlatform()->getName() == "postgresql") {
            // postfresqlの場合、pege_idを指 定する
            $this->addSql("INSERT INTO dtb_page_layout (page_id, device_type_id, page_name, url, file_name, edit_flg, author, description, keyword, update_url, create_date, update_date, meta_robots) VALUES (nextval('dtb_page_layout_page_id_seq'), 10, '商品購入/お届け先の追加', 'shopping_shipping_edit', 'Shopping/shipping_edit', 2, NULL, NULL, NULL, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'noindex') RETURNING page_id;");
            $this->addSql("INSERT INTO dtb_page_layout (page_id, device_type_id, page_name, url, file_name, edit_flg, author, description, keyword, update_url, create_date, update_date, meta_robots) VALUES (nextval('dtb_page_layout_page_id_seq'), 10, '商品購入/お届け先の複数指定(お届け先の追加)', 'shopping_shipping_multiple_edit', 'Shopping/shipping_multiple_edit', 2, NULL, NULL, NULL, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'noindex') RETURNING page_id;");
            $this->addSql("INSERT INTO dtb_page_layout (page_id, device_type_id, page_name, url, file_name, edit_flg, author, description, keyword, update_url, create_date, update_date, meta_robots) VALUES (nextval('dtb_page_layout_page_id_seq'), 10, '商品購入/購入エラー', 'shopping_error', 'Shopping/shopping_error', 2, NULL, NULL, NULL, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'noindex') RETURNING page_id;");
            $this->addSql("INSERT INTO dtb_page_layout (page_id, device_type_id, page_name, url, file_name, edit_flg, author, description, keyword, update_url, create_date, update_date, meta_robots) VALUES (nextval('dtb_page_layout_page_id_seq'), 10, 'ご利用ガイド', 'help_guide', 'Help/guide', 2, NULL, NULL, NULL, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL) RETURNING page_id;");
            $this->addSql("INSERT INTO dtb_page_layout (page_id, device_type_id, page_name, url, file_name, edit_flg, author, description, keyword, update_url, create_date, update_date, meta_robots) VALUES (nextval('dtb_page_layout_page_id_seq'), 10, 'パスワード再発行(入力ページ)', 'forgot', 'Forgot/index', 2, NULL, NULL, NULL, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL) RETURNING page_id;");
            $this->addSql("INSERT INTO dtb_page_layout (page_id, device_type_id, page_name, url, file_name, edit_flg, author, description, keyword, update_url, create_date, update_date, meta_robots) VALUES (nextval('dtb_page_layout_page_id_seq'), 10, 'パスワード再発行(完了ページ)', 'forgot_complete', 'Forgot/complete', 2, NULL, NULL, NULL, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL) RETURNING page_id;");
            $this->addSql("INSERT INTO dtb_page_layout (page_id, device_type_id, page_name, url, file_name, edit_flg, author, description, keyword, update_url, create_date, update_date, meta_robots) VALUES (nextval('dtb_page_layout_page_id_seq'), 10, 'パスワード変更(完了ページ)', 'forgot_reset', 'Forgot/reset', 2, NULL, NULL, NULL, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL) RETURNING page_id;");
        } else {
            // postgresql以外の場合、pege_idはauto increment項目なので指定しない
