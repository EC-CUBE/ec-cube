...
class AdminControllerProvider implements ControllerProviderInterface
{
    public function connect(Application $app)
    {
        ...
        $c->match('/store/plugin/authentication_setting_download', '\Eccube\Controller\Admin\Store\PluginController::download')->bind('admin_setting_system_authority_download');
