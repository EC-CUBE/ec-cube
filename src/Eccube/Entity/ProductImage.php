...
if (!class_exists(ProductImage::class)) {
    ...
    #[ORM\Entity(repositoryClass: \Eccube\Repository\ProductImageRepository::class)]
    class ProductImage extends AbstractEntity
    {
         ...
         * @var Product
         */
        #[ORM\ManyToOne(targetEntity: \Eccube\Entity\Product::class, inversedBy: 'ProductImage')]
