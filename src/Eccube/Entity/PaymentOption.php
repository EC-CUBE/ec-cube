...
if (!class_exists(PaymentOption::class)) {
    ...
    #[ORM\Entity(repositoryClass: \Eccube\Repository\PaymentOptionRepository::class)]
    class PaymentOption extends AbstractEntity
    {
         ...
         * @var Delivery
         */
        #[ORM\ManyToOne(targetEntity: \Eccube\Entity\Delivery::class, inversedBy: 'PaymentOptions')]
         ...
         * @var Payment
         */
        #[ORM\ManyToOne(targetEntity: \Eccube\Entity\Payment::class, inversedBy: 'PaymentOptions')]
