...
if (!class_exists(Order::class)) {
     ...
     * Order
     */
    #[ORM\Table(name: 'dtb_order', indexes: [new ORM\Index(name: 'dtb_order_email_idx', columns: ['email']), new ORM\Index(name: 'dtb_order_order_date_idx', columns: ['order_date']), new ORM\Index(name: 'dtb_order_payment_date_idx', columns: ['payment_date']), new ORM\Index(name: 'dtb_order_update_date_idx', columns: ['update_date']), new ORM\Index(name: 'dtb_order_order_no_idx', columns: ['order_no'])], uniqueConstraints: [new ORM\UniqueConstraint(name: 'dtb_order_pre_order_id_idx', columns: ['pre_order_id'])])]
    #[ORM\InheritanceType('SINGLE_TABLE')]
    #[ORM\DiscriminatorColumn(name: 'discriminator_type', type: 'string', length: 255)]
    #[ORM\HasLifecycleCallbacks]
    #[ORM\Entity(repositoryClass: \Eccube\Repository\OrderRepository::class)]
