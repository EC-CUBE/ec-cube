...
if (!class_exists(ProductClass::class)) {
     ...
     * ProductClass
     */
    #[ORM\Table(name: 'dtb_product_class', indexes: [new ORM\Index(name: 'dtb_product_class_price02_idx', columns: ['price02']), new ORM\Index(name: 'dtb_product_class_stock_stock_unlimited_idx', columns: ['stock', 'stock_unlimited'])])]
    #[ORM\InheritanceType('SINGLE_TABLE')]
    #[ORM\DiscriminatorColumn(name: 'discriminator_type', type: 'string', length: 255)]
    #[ORM\HasLifecycleCallbacks]
    #[ORM\Entity(repositoryClass: \Eccube\Repository\ProductClassRepository::class)]
    class ProductClass extends AbstractEntity
    {
         ...
         * @var string
         */
        #[ORM\Column(name: 'point_rate', type: 'decimal', precision: 10, scale: 0, nullable: true, options: ['unsigned' => true])]
        private $point_rate;
