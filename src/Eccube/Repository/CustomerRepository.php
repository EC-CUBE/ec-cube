...
//                ->setParameter('birth_month', $searchData['birth_month']);
        ...
        // buy_total
        if (isset($searchData['buy_total_start']) && Str::isBlank($searchData['buy_total_start'])) {
            $qb
                ->andWhere('c.buy_total >= :buy_total_start')
                ->setParameter('buy_total_start', $searchData['buy_total_start']);
        }
        if (isset($searchData['buy_total_end']) && Str::isBlank($searchData['buy_total_end'])) {
            $qb
        ...
        if (isset($searchData['buy_product_code']) && Str::isBlank($searchData['buy_product_code'])) {
            $qb
                ->leftJoin('c.Orders', 'o')
