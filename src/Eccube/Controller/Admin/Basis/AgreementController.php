...
class AgreementController extends AbstractController
{
    ...
    {
        $baseinfo = $app['eccube.repository.']->findAll();
        $baseinfo = $baseinfo[0];

        $form = $app['form.factory']->createBuilder('agreement', $baseinfo)->getForm();
        ...
        return $app['twig']->render('Admin/Basis/agreement.twig', array(
