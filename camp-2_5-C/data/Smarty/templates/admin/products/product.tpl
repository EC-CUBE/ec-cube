...
<div id="products" class="contents-main">
  ...
  <div class="btn-foot">
    ...
    <!--▲検索結果へ戻る-->
    <!--{/if}-->
    <button type="button" onClick=" fnModeSubmit('preview','',''); selectAll('category_id');">プレビュー</button><button type="button" onClick="selectAll('category_id') fnModeSubmit('confirm','',''); return false;"><span>登録する</span>
  </div>
</div>
</form>
