...
<div id="products" class="contents-main">
  ...
  <div class="btn">
    ...
    <!--▲検索結果へ戻る-->
    <!--{/if}-->
    <button type="submit" onClick="selectAll('category_id')"><span>確認ページへ</span></button><button type="button" onclic="fnChangeAction('<!--{$smarty.const.URL_DIR . "admin/products/products_preview.php"}-->'); fnModeSubmit('search','',''); return false;">プレビュー</button>
  </div>
</div>
</form>
