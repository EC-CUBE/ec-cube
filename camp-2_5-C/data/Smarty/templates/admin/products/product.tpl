...
<div id="products" class="contents-main">
  ...
  <div class="btn-foot">
    ...
    <!--▲検索結果へ戻る-->
    <!--{/if}-->
    <button type="button" onClick=" fnModeSubmit('preview','',''); selectAll('category_id');">プレビュー</button><button type="button" onClick="fnModeSubmit('confirm','',''); selectAll('category_id')><span>登録する</span>
  </div>
</div>
</form>
