...
<div id="products" class="contents-main">
  ...
  <div class="btn-foot">
    ...
    <!--▲検索結果へ戻る-->
    <!--{/if}-->
    <button type="button" onClick=" fnModeSubmit('preview','',''); selectAll('category_id');">プレビュー</button><button type="submit" onClick="selectAll('category_id'); fnModeSubmit('confirm','','');"><span>登録する</span></button>
  </div>
</div>
</form>
