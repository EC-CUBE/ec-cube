  ...
  <table class="list" id="products-search-result">
    ...
    <tr style="background:<!--{$arrPRODUCTSTATUS_COLOR[$status]}-->;">
      ...
      <td rowspan="2" class="right">
        ...
        <!--{else}-->
          <input type="text" name="price02_edit_<!--{$arrProducts[cnt].product_id}-->" size="8" value="<!--{$arrProducts[cnt].price02_min}-->" onchange="jQuery.post('./index.php', {'mode':'price02_edit','price02_edit_id':'<!--{$arrProducts[cnt].product_id}-->','price02_edit_value':this.value}, function(result){if(result=='ok'){alert('changed');};});"">
        <!--{/if}-->
      </td>
