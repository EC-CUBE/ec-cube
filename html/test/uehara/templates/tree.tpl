	...
	<tr>
		...
		<div id="file_view">
			<table>
				...
				<tr onclick="fnSetFormVal('form1', 'select_file', '<!--{$arrFileList[cnt].file_path|escape}-->');fnChangeBgColor('select_file<!--{$smarty.section.customer.index}-->', '3333FF');" style="" id="select_file<!--{$smarty.section.customer.index}-->">
