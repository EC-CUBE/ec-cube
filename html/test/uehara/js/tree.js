...
function fnTreeView(view_id, arrTree) {
	...
	for(i = 0; i < arrTree.length; i++) {
		...
		tree += '<a href="#tree_a'+ i +'" name="tree_a'+ i +'" onclick="javascript:fnTreeMenu(\'tree'+ i +'\',\''+ arrTree[i][1] +'\',\'tree_img'+ i +'\',\''+ arrTree[i][2] +'\')"><img src="'+ defalt_img +'" border="0" name="tree_img'+ i +'" ></a>'+ arrTree[i][2] +'<br/>';
