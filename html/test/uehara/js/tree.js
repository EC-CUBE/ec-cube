...
function fnTreeView(view_id, arrTree) {
	...
	for(i = 0; i < arrTree.length; i++) {
		...
		tree += '<input type="image" src="'+ defalt_img +'" border="0" name="tree_img'+ i +'">';
		//tree += '<input type="image" src="'+ defalt_img +'" border="0" name="tree_img'+ i +'" onclick="fnTreeMenu(\'tree'+ i +'\',\''+ arrTree[i][1] +'\',\'tree_img'+ i +'\',\''+ arrTree[i][2] +'\')">'+ arrTree[i][2] +'<br/>';
