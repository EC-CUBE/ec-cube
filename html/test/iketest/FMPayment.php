...
# ログ出力サンプル
$logger->logprint('DEBUG', '<<< 支払結果画面(FMPayment.php)処理開始... >>>');
...
<html>
  ...
  <body bgcolor="#FFFFFF" text="#000000">
    ...
    <p>企業コードは <?=$company_code?> です。</p>
    <p>注文番号は <?=$order_no?> です。</p>
    <p>支払金額は <?=$amount?> 円です。</p>
    <p>支払期限は <?=$pay_limit?> です。</p>
    <p>企業コード、注文番号を紙などに控えて全国のファミリーマートにてお支払ください。</p>
...
# ログ出力サンプル
$logger->logprint('DEBUG', '<<< 支払結果画面(FMPayment.php)処理終了. >>>');
?>
