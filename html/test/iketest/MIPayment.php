...
#       レスポンスを処理するサンプル
#       << ミニストップ/デイリーヤマザキ/ヤマザキデイリーストア用サンプル >>
######################################################
...
# ログ出力サンプル
$logger->logprint('DEBUG', '<<< 支払結果画面(MIPayment.php)処理開始... >>>');
...
<html>
  ...
  <body bgcolor="#FFFFFF" text="#000000">
    ...
    <p>決済サービス払込取扱票を印刷し全国のミニストップ・デイリーヤマザキ・ヤマザキデイリーストアーにてお支払ください。</p>
