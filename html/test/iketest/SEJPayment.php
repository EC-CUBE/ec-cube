...
# ログ出力サンプル
$logger->logprint('DEBUG', '<<< 支払結果画面(SEJPayment.php)処理開始... >>>');
...
<html>
  ...
  <body bgcolor="#FFFFFF" text="#000000">
    ...
    <p>振込票を印刷、もしくは振込票番号を紙などに控えて全国のセブンイレブンにてお支払ください。</p>
    <p>振込票番号を紙などでお持ちの場合は、お客様から店員に提示の際に「インターネット代金の支払い」とお伝え下さい。</p>
    <p><a href="http://pr.sej.co.jp/in/system.html" target="_blank">詳しくはこのページにてご確認ください。</a><br></p>
...
# ログ出力サンプル
$logger->logprint('DEBUG', '<<< 支払結果画面(MIPayment.php)処理終了. >>>');
?>
