...
function lfConvertParam() {
	...
	$arrConvList['search_buy_start_year'] = "n" ;		//　最終購入日 START 年
	$arrConvList['search_buy_start_month'] = "n" ;		//　最終購入日 START 月
	$arrConvList['search_buy_start_day'] = "n" ;		//　最終購入日 START 日
	$arrConvList['search_buy_end_year'] = "n" ;			//　最終購入日 END 年
	$arrConvList['search_buy_end_month'] = "n" ;		//　最終購入日 END 月
	$arrConvList['search_buy_end_day'] = "n" ;			//　最終購入日 END 日
	$arrConvList['search_buy_product_name'] = "aKV" ;	//　購入商品名
	$arrConvList['search_buy_product_code'] = "aKV" ;	//　購入商品コード
	$arrConvList['search_category_id'] = "" ;			//　カテゴリ
