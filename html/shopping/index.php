...
function lfInitParam() {
	...
	$objFormParam->addParam("年", "year", INT_LEN, "n", array("NUM_CHECK"), "", false);
	$objFormParam->addParam("月", "month", INT_LEN, "n", array("NUM_CHECK"), "", false);
	$objFormParam->addParam("日", "day", INT_LEN, "n", array("NUM_CHECK"), "", false);
