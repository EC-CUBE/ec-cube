...
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, rw_flg, status, create_date, update_date, mb_convert_kana_option) VALUES (107, 3, '(SELECT order_company_name FROM mtb_pref WHERE mtb_pref.id = dtb_order.order_pref) as company_name', '会社名', 8, 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'KVa');
