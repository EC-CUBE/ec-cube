...
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (119, 3, '(SELECT pref_name FROM mtb_pref WHERE pref_id = dtb_order.order_pref)', '都道府県', 17, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (137, 3, '(SELECT pref_name FROM mtb_pref WHERE pref_id = dtb_order.deliv_pref)', '都道府県', 35, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (173, 4, '(SELECT pref_name FROM mtb_pref WHERE pref_id = dtb_order.order_pref)', '都道府県', 18, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (191, 4, '(SELECT pref_name FROM mtb_pref WHERE pref_id = dtb_order.deliv_pref)', '都道府県', 36, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
