...
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (83, 2, 'pref', '都道府県', 8, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                                        
...
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (93, 2, 'sex', '性別', 18, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                                            
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (94, 2, 'job', '職業', 19, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                                            
...
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (103, 3, 'order_id', '注文番号', 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                                   
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (104, 3, 'customer_id', '顧客ID', 2, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                                  
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (105, 3, 'message', '要望等', 3, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                                      
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (106, 3, 'order_name01', '顧客名(姓)', 4, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                             
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (107, 3, 'order_name02', '顧客名(名)', 5, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                             
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (108, 3, 'order_kana01', '顧客名(フリガナ・姓)', 6, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                   
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (109, 3, 'order_kana02', '顧客名(フリガナ・名)', 7, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                   
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (110, 3, 'order_email', 'メールアドレス', 8, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                          
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (111, 3, 'order_tel01', '電話番号1', 9, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                               
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (112, 3, 'order_tel02', '電話番号2', 10, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                              
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (113, 3, 'order_tel03', '電話番号3', 11, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                              
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (114, 3, 'order_fax01', 'FAX1', 12, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                                   
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (115, 3, 'order_fax02', 'FAX2', 13, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                                   
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (116, 3, 'order_fax03', 'FAX3', 14, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                                   
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (117, 3, 'order_zip01', '郵便番号1', 15, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                              
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (118, 3, 'order_zip02', '郵便番号2', 16, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (119, 3, '(SELECT name FROM mtb_pref WHERE id = dtb_order.order_pref)', '都道府県', 17, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (120, 3, 'order_addr01', '住所1', 18, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                                 
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (121, 3, 'order_addr02', '住所2', 19, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                                 
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (122, 3, 'order_sex', '性別', 20, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                                     
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (123, 3, 'order_birth', '生年月日', 21, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                               
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (124, 3, 'order_job', '職種', 22, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                                     
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (125, 3, 'deliv_name01', 'お届け先名前(姓)', 23, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                      
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (126, 3, 'deliv_name02', 'お届け先名前(名)', 24, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                      
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (127, 3, 'deliv_kana01', 'お届け先(フリガナ・姓)', 25, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (128, 3, 'deliv_kana02', 'お届け先(フリガナ・名)', 26, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (129, 3, 'deliv_tel01', '電話番号1', 27, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                              
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (130, 3, 'deliv_tel02', '電話番号2', 28, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                              
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (131, 3, 'deliv_tel03', '電話番号3', 29, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                              
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (132, 3, 'deliv_fax01', 'FAX1', 30, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                                   
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (133, 3, 'deliv_fax02', 'FAX2', 31, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                                   
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (134, 3, 'deliv_fax03', 'FAX3', 32, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                                   
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (135, 3, 'deliv_zip01', '郵便番号1', 33, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                              
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (136, 3, 'deliv_zip02', '郵便番号2', 34, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (137, 3, '(SELECT name FROM mtb_pref WHERE id = dtb_order.deliv_pref)', '都道府県', 35, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (138, 3, 'deliv_addr01', '住所1', 36, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                                 
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (139, 3, 'deliv_addr02', '住所2', 37, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                                 
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (140, 3, 'subtotal', '小計', 38, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                                      
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (141, 3, 'discount', '値引き', 39, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                                    
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (142, 3, 'deliv_fee', '送料', 40, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                                     
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (143, 3, 'charge', '手数料', 41, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                                      
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (144, 3, 'use_point', '使用ポイント', 42, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                             
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (145, 3, 'add_point', '加算ポイント', 43, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                             
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (146, 3, 'tax', '税金', 44, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                                           
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (147, 3, 'total', '合計', 45, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                                         
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (148, 3, 'payment_total', 'お支払い合計', 46, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                         
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (149, 3, 'payment_method', '支払い方法', 47, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                          
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (150, 3, 'deliv_time', 'お届け時間', 48, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                              
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (151, 3, 'deliv_no', '配送伝票番号', 49, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                              
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (152, 3, 'note', 'SHOPメモ', 50, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                                      
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (153, 3, 'status', '対応状況', 51, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                                    
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (154, 3, 'create_date', '注文日時', 52, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                               
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (155, 3, 'update_date', '更新日時', 53, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                               
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (156, 3, 'deliv_date', 'お届け指定日', 54, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                            
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (157, 4, 'order_id', '注文番号', 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                                   
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (158, 4, 'customer_id', '顧客ID', 3, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                                  
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (159, 4, 'message', '要望等', 4, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                                      
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (160, 4, 'order_name01', '顧客名1', 5, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                                
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (161, 4, 'order_name02', '顧客名2', 6, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                                
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (162, 4, 'order_kana01', '顧客名カナ1', 7, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                            
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (163, 4, 'order_kana02', '顧客名カナ2', 8, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                            
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (164, 4, 'order_email', 'メールアドレス', 9, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                          
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (165, 4, 'order_tel01', '電話番号1', 10, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                              
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (166, 4, 'order_tel02', '電話番号2', 11, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                              
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (167, 4, 'order_tel03', '電話番号3', 12, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                              
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (168, 4, 'order_fax01', 'FAX1', 13, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                                   
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (169, 4, 'order_fax02', 'FAX2', 14, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                                   
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (170, 4, 'order_fax03', 'FAX3', 15, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                                   
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (171, 4, 'order_zip01', '郵便番号1', 16, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                              
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (172, 4, 'order_zip02', '郵便番号2', 17, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (173, 4, '(SELECT name FROM mtb_pref WHERE id = dtb_order.order_pref)', '都道府県', 18, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (174, 4, 'order_addr01', '住所1', 19, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                                 
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (175, 4, 'order_addr02', '住所2', 20, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                                 
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (176, 4, 'order_sex', '性別', 21, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                                     
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (177, 4, 'order_birth', '生年月日', 22, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                               
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (178, 4, 'order_job', '職種', 23, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                                     
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (179, 4, 'deliv_name01', 'お届け先名前', 24, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                          
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (180, 4, 'deliv_name02', 'お届け先名前', 25, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                          
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (181, 4, 'deliv_kana01', 'お届け先カナ', 26, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                          
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (182, 4, 'deliv_kana02', 'お届け先カナ', 27, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                          
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (183, 4, 'deliv_tel01', '電話番号1', 28, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                              
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (184, 4, 'deliv_tel02', '電話番号2', 29, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                              
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (185, 4, 'deliv_tel03', '電話番号3', 30, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                              
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (186, 4, 'deliv_fax01', 'FAX1', 31, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                                   
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (187, 4, 'deliv_fax02', 'FAX2', 32, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                                   
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (188, 4, 'deliv_fax03', 'FAX3', 33, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                                   
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (189, 4, 'deliv_zip01', '郵便番号1', 34, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                              
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (190, 4, 'deliv_zip02', '郵便番号2', 35, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (191, 4, '(SELECT name FROM mtb_pref WHERE id = dtb_order.deliv_pref)', '都道府県', 36, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (192, 4, 'deliv_addr01', '住所1', 37, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (193, 4, 'deliv_addr02', '住所2', 38, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (194, 4, 'payment_total', 'お支払い合計', 39, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (195, 5, 'category_id', 'カテゴリID', 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (196, 5, 'category_name', 'カテゴリ名', 2, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (197, 5, 'parent_category_id', '親カテゴリID', 3, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (198, 5, 'level', '階層', NULL, 2, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (199, 5, 'rank', '表示ランク', NULL, 2, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('USER_FILE_PATH', 'HTML_FILE_PATH . USER_DIR', 4, 'ユーザファイル保存先');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('USER_INC_PATH', 'USER_FILE_PATH . "include/"', 5, 'ユーザインクルードファイル保存先');
...
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('USER_TEMPLATE_PATH', 'USER_FILE_PATH . USER_PACKAGE_DIR', 18, 'テンプレートファイル保存先');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('TEMPLATE_TEMP_FILE_PATH', 'HTML_FILE_PATH . "upload/temp_template/"', 19, 'テンプレートファイル一時保存先');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('USER_DEF_PHP', 'USER_FILE_PATH . "__default.php"', 20, 'ユーザー作成画面のデフォルトPHPファイル');
...
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('MODULE_FILE_PATH', 'DATA_FILE_PATH . MODULE_DIR', 23, 'ダウンロードモジュール保存ディレクトリ');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('MAX_LIFETIME', '7200', 26, 'DBセッションの有効期限(秒)');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('MASTER_DATA_FILE_PATH', 'DATA_FILE_PATH . "cache/"', 27, 'マスタデータキャッシュディレクトリ');
...
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('GRAPH_FILE_PATH', 'HTML_FILE_PATH . "upload/graph_image/"', 49, 'グラフ格納ディレクトリ');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('GRAPH_URL', 'URL_PATH . "upload/graph_image/"', 50, 'グラフURL');
...
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('LOG_FILE', 'DATA_FILE_PATH . "logs/site.log"', 142, 'ログファイル');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('CUSTOMER_LOG_FILE', 'DATA_FILE_PATH . "logs/customer.log"', 143, '会員ログイン ログファイル');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('IMAGE_TEMP_FILE_PATH', 'HTML_FILE_PATH . "upload/temp_image/"', 150, '画像一時保存');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('IMAGE_SAVE_FILE_PATH', 'HTML_FILE_PATH . "upload/save_image/"', 151, '画像保存先');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('IMAGE_TEMP_URL', 'URL_PATH . "upload/temp_image/"', 152, '画像一時保存URL');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('IMAGE_SAVE_URL', 'URL_PATH . "upload/save_image/"', 153, '画像保存先URL');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('IMAGE_TEMP_URL_RSS', 'HTTP_URL . "upload/temp_image/"', 154, 'RSS用画像一時保存URL');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('IMAGE_SAVE_URL_RSS', 'HTTP_URL . "upload/save_image/"', 155, 'RSS用画像保存先URL');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('CSV_TEMP_FILE_PATH', 'DATA_FILE_PATH . "upload/csv/"', 156, 'エンコードCSVの一時保存先');
...
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('URL_SYSTEM_TOP', 'URL_PATH . ADMIN_DIR . "system/" . DIR_INDEX_URL', 159, 'システム管理トップ');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('URL_CLASS_REGIST', 'URL_PATH . ADMIN_DIR . "products/class.php"', 160, '規格登録');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('URL_INPUT_ZIP', 'URL_PATH . "input_zip.php"', 161, '郵便番号入力');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('URL_DELIVERY_TOP', 'URL_PATH . ADMIN_DIR . "basis/delivery.php"', 162, '配送業者登録');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('URL_PAYMENT_TOP', 'URL_PATH . ADMIN_DIR . "basis/payment.php"', 163, '支払い方法登録');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('URL_CONTROL_TOP', 'URL_PATH . ADMIN_DIR . "basis/control.php"', 164, 'サイト管理情報登録');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('URL_HOME', 'URL_PATH . ADMIN_DIR . "home.php"', 165, 'ホーム');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('URL_LOGIN', 'URL_PATH . ADMIN_DIR . "" . DIR_INDEX_URL', 166, 'ログインページ');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('URL_SEARCH_TOP', 'URL_PATH . ADMIN_DIR . "products/" . DIR_INDEX_URL', 167, '商品検索ページ');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('URL_ORDER_EDIT', 'URL_PATH . ADMIN_DIR . "order/edit.php"', 168, '注文編集ページ');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('URL_SEARCH_ORDER', 'URL_PATH . ADMIN_DIR . "order/" . DIR_INDEX_URL', 169, '注文編集ページ');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('URL_ORDER_MAIL', 'URL_PATH . ADMIN_DIR . "order/mail.php"', 170, '注文編集ページ');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('URL_LOGOUT', 'URL_PATH . ADMIN_DIR . "logout.php"', 171, 'ログアウトページ');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('URL_SYSTEM_CSV', 'URL_PATH . ADMIN_DIR . "system/member_csv.php"', 172, 'システム管理CSV出力ページ');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('URL_ADMIN_CSS', 'URL_PATH . ADMIN_DIR . "css/"', 173, '管理機能用CSS保管ディレクトリ');
...
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('URL_SHOP_TOP', 'HTTPS_URL . "shopping/" . DIR_INDEX_URL', 237, '会員情報入力');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('URL_ENTRY_TOP', 'HTTPS_URL . "entry/" . DIR_INDEX_URL', 238, '会員登録ページTOP');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('URL_SITE_TOP', 'URL_PATH . DIR_INDEX_URL', 239, 'サイトトップ');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('URL_CART_TOP', 'URL_PATH . "cart/" . DIR_INDEX_URL', 240, 'カートトップ');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('URL_DELIV_TOP', 'URL_PATH . "shopping/deliv.php"', 241, 'お届け先設定');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('URL_MYPAGE_TOP', 'HTTPS_URL . "mypage/login.php"', 242, 'Myページトップ');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('URL_SHOP_CONFIRM', 'URL_PATH . "shopping/confirm.php"', 243, '購入確認ページ');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('URL_SHOP_PAYMENT', 'URL_PATH . "shopping/payment.php"', 244, 'お支払い方法選択ページ');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('URL_SHOP_COMPLETE', 'URL_PATH . "shopping/complete.php"', 245, '購入完了画面');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('URL_SHOP_CREDIT', 'URL_PATH . "shopping/card.php"', 246, 'カード決済画面');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('URL_SHOP_LOAN', 'URL_PATH . "shopping/loan.php"', 247, 'ローン決済画面');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('URL_SHOP_CONVENIENCE', 'URL_PATH . "shopping/convenience.php"', 248, 'コンビニ決済画面');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('URL_SHOP_MODULE', 'URL_PATH . "shopping/load_payment_module.php"', 249, 'モジュール追加用画面');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('DETAIL_P_HTML', 'URL_PATH . "products/detail.php?product_id="', 253, '商品詳細(HTML出力)');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('MYPAGE_DELIVADDR_URL', 'URL_PATH . "mypage/delivery.php"', 254, 'マイページお届け先URL');
...
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('TRACKBACK_TO_URL', 'HTTP_URL . "tb/" . DIR_INDEX_URL . "?pid="', 282, 'トラックバック先URL');
...
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('SMARTY_TEMPLATES_FILE_PATH', ' DATA_FILE_PATH . "Smarty/templates/"', 304, 'SMARTYテンプレート');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('TEMPLATE_DIR', 'SMARTY_TEMPLATES_FILE_PATH . TEMPLATE_NAME . "/"', 305, 'SMARTYテンプレート(PC)');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('TEMPLATE_ADMIN_FILE_PATH', 'SMARTY_TEMPLATES_FILE_PATH . "admin/"', 306, 'SMARTYテンプレート(管理機能)');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('COMPILE_DIR', 'DATA_FILE_PATH . "Smarty/templates_c/" . TEMPLATE_NAME . "/"', 307, 'SMARTYコンパイル');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('COMPILE_ADMIN_FILE_PATH', 'DATA_FILE_PATH . "Smarty/templates_c/admin/"', 308, 'SMARTYコンパイル(管理機能)');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('BLOC_DIR', '"frontparts/bloc/"', 311, 'ブロックファイル保存先');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('MOBILE_TEMPLATE_DIR', 'SMARTY_TEMPLATES_FILE_PATH . MOBILE_TEMPLATE_NAME . "/"', 312, 'SMARTYテンプレート(mobile)');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('MOBILE_COMPILE_FILE_PATH', 'DATA_FILE_PATH . "Smarty/templates_c/" . MOBILE_TEMPLATE_NAME . "/"', 313, 'SMARTYコンパイル(mobile)');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('SMARTPHONE_TEMPLATE_DIR', 'SMARTY_TEMPLATES_FILE_PATH . SMARTPHONE_TEMPLATE_NAME . "/"', 314, 'SMARTYテンプレート(smart phone)');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('SMARTPHONE_COMPILE_FILE_PATH', 'DATA_FILE_PATH . "Smarty/templates_c/" . SMARTPHONE_TEMPLATE_NAME . "/"', 315, 'SMARTYコンパイル(smartphone)');
...
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('MOBILE_IMAGE_DIR', 'HTML_FILE_PATH . "upload/mobile_image/"', 408, '携帯電話向け変換画像保存ディレクトリ');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('MOBILE_IMAGE_URL', 'URL_PATH . "upload/mobile_image/"', 409, '携帯電話向け変換画像保存ディレクトリ');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('MOBILE_URL_SITE_TOP', 'MOBILE_URL_PATH . DIR_INDEX_URL', 410, 'モバイルURL');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('MOBILE_URL_CART_TOP', 'MOBILE_URL_PATH . "cart/" . DIR_INDEX_URL', 411, 'カートトップ');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('MOBILE_URL_SHOP_TOP', 'MOBILE_HTTPS_URL . "shopping/" . DIR_INDEX_URL', 412, '会員情報入力');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('MOBILE_URL_SHOP_CONFIRM', 'MOBILE_URL_PATH . "shopping/confirm.php"', 413, '購入確認ページ');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('MOBILE_URL_SHOP_PAYMENT', 'MOBILE_URL_PATH . "shopping/payment.php"', 414, 'お支払い方法選択ページ');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('MOBILE_DETAIL_P_HTML', 'MOBILE_URL_PATH . "products/detail.php?product_id="', 415, '商品詳細(HTML出力)');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('MOBILE_URL_SHOP_COMPLETE', 'MOBILE_URL_PATH . "shopping/complete.php"', 416, '購入完了画面');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('MOBILE_URL_SHOP_MODULE', 'MOBILE_URL_PATH . "shopping/load_payment_module.php"', 417, 'モジュール追加用画面');
...
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('OSTORE_LOG_FILE', 'DATA_FILE_PATH . "logs/ownersstore.log"', 502, 'オーナーズストアログパス');
...
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('PLUGIN_PATH', 'USER_FILE_PATH . PLUGIN_DIR', 601, 'プラグイン保存先');
...
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('DOWN_TEMP_FILE_PATH', 'DATA_FILE_PATH . "download/temp/"', 704, 'ダウンロードファイル一時保存');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('DOWN_SAVE_FILE_PATH', 'DATA_FILE_PATH . "download/save/"', 705, 'ダウンロードファイル保存先');
