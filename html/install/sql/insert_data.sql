...
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('USER_PATH', 'HTML_FILE_PATH . USER_DIR', 4, 'ユーザファイル保存先');
...
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('TEMPLATE_TEMP_DIR', 'HTML_FILE_PATH . "upload/temp_template/"', 19, 'テンプレートファイル一時保存先');
...
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('MODULE_PATH', 'DATA_FILE_PATH . MODULE_DIR', 23, 'ダウンロードモジュール保存ディレクトリ');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('MAX_LIFETIME', '7200', 26, 'DBセッションの有効期限(秒)');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('MASTER_DATA_DIR', 'DATA_FILE_PATH . "cache/"', 27, 'マスタデータキャッシュディレクトリ');
...
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('TTF_DIR', 'DATA_FILE_PATH . "fonts/"', 48, 'フォントのパス');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('GRAPH_DIR', 'HTML_FILE_PATH . "upload/graph_image/"', 49, 'グラフ格納ディレクトリ');
...
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('PDF_DIR', 'DATA_FILE_PATH . "pdf/"', 53, 'PDF格納ディレクトリ');
...
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('LOG_PATH', 'DATA_FILE_PATH . "logs/site.log"', 142, 'ログファイル');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('CUSTOMER_LOG_PATH', 'DATA_FILE_PATH . "logs/customer.log"', 143, '会員ログイン ログファイル');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('IMAGE_TEMP_DIR', 'HTML_FILE_PATH . "upload/temp_image/"', 150, '画像一時保存');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('IMAGE_SAVE_DIR', 'HTML_FILE_PATH . "upload/save_image/"', 151, '画像保存先');
...
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('CSV_TEMP_DIR', 'DATA_FILE_PATH . "upload/csv/"', 156, 'エンコードCSVの一時保存先');
...
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('SMARTY_TEMPLATES_DIR', ' DATA_FILE_PATH . "Smarty/templates/"', 304, 'SMARTYテンプレート');
...
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('COMPILE_ADMIN_DIR', 'DATA_FILE_PATH . "Smarty/templates_c/admin/"', 308, 'SMARTYコンパイル(管理機能)');
...
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('MOBILE_COMPILE_DIR', 'DATA_FILE_PATH . "Smarty/templates_c/" . MOBILE_TEMPLATE_NAME . "/"', 313, 'SMARTYコンパイル(mobile)');
...
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('SMARTPHONE_COMPILE_DIR', 'DATA_FILE_PATH . "Smarty/templates_c/" . SMARTPHONE_TEMPLATE_NAME . "/"', 315, 'SMARTYコンパイル(smartphone)');
...
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('OSTORE_LOG_PATH', 'DATA_FILE_PATH . "logs/ownersstore.log"', 502, 'オーナーズストアログパス');
...
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('DOWN_TEMP_DIR', 'DATA_FILE_PATH . "download/temp/"', 704, 'ダウンロードファイル一時保存');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('DOWN_SAVE_DIR', 'DATA_FILE_PATH . "download/save/"', 705, 'ダウンロードファイル保存先');
