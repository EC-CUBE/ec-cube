...
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('GRAPH_URL_PATH', 'URL_PATH . "upload/graph_image/"', 50, 'グラフURL');
...
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('IMAGE_TEMP_URL_PATH', 'URL_PATH . "upload/temp_image/"', 152, '画像一時保存URL');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('IMAGE_SAVE_URL_PATH', 'URL_PATH . "upload/save_image/"', 153, '画像保存先URL');
...
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('ADMIN_SYSTEM_URL_PATH', 'URL_PATH . ADMIN_DIR . "system/" . DIR_INDEX_URL', 159, 'システム管理トップ');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('ADMIN_CLASS_REGIST_URL_PATH', 'URL_PATH . ADMIN_DIR . "products/class.php"', 160, '規格登録');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('INPUT_ZIP_URL_PATH', 'URL_PATH . "input_zip.php"', 161, '郵便番号入力');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('ADMIN_DELIVERY_URL_PATH', 'URL_PATH . ADMIN_DIR . "basis/delivery.php"', 162, '配送業者登録');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('ADMIN_PAYMENT_URL_PATH', 'URL_PATH . ADMIN_DIR . "basis/payment.php"', 163, '支払い方法登録');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('ADMIN_HOME_URL_PATH', 'URL_PATH . ADMIN_DIR . "home.php"', 165, 'ホーム');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('ADMIN_LOGIN_URL_PATH', 'URL_PATH . ADMIN_DIR . DIR_INDEX_URL', 166, 'ログインページ');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('ADMIN_PRODUCTS_URL_PATH', 'URL_PATH . ADMIN_DIR . "products/" . DIR_INDEX_URL', 167, '商品検索ページ');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('ADMIN_ORDER_EDIT_URL_PATH', 'URL_PATH . ADMIN_DIR . "order/edit.php"', 168, '注文編集ページ');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('ADMIN_ORDER_URL_PATH', 'URL_PATH . ADMIN_DIR . "order/" . DIR_INDEX_URL', 169, '注文編集ページ');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('ADMIN_ORDER_MAIL_URL_PATH', 'URL_PATH . ADMIN_DIR . "order/mail.php"', 170, '注文編集ページ');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('ADMIN_LOGOUT_URL_PATH', 'URL_PATH . ADMIN_DIR . "logout.php"', 171, 'ログアウトページ');
...
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('MOBILE_IMAGE_URL_PATH', 'URL_PATH . "upload/mobile_image/"', 409, '携帯電話向け変換画像保存ディレクトリ');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('MOBILE_TOP_URL_PATH', 'MOBILE_URL_PATH . DIR_INDEX_URL', 410, 'モバイルURL');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('MOBILE_CART_URL_PATH', 'MOBILE_URL_PATH . "cart/" . DIR_INDEX_URL', 411, 'カートトップ');
...
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('MOBILE_SHOPPING_CONFIRM_URL_PATH', 'MOBILE_URL_PATH . "shopping/confirm.php"', 413, '購入確認ページ');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('MOBILE_SHOPPING_PAYMENT_URL_PATH', 'MOBILE_URL_PATH . "shopping/payment.php"', 414, 'お支払い方法選択ページ');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('MOBILE_P_DETAIL_URL_PATH', 'MOBILE_URL_PATH . "products/detail.php?product_id="', 415, '商品詳細(HTML出力)');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('MOBILE_SHOPPING_COMPLETE_URL_PATH', 'MOBILE_URL_PATH . "shopping/complete.php"', 416, '購入完了画面');
INSERT INTO mtb_constants (id, name, rank, remarks) VALUES ('MOBILE_SHOPPING_MODULE_URL_PATH', 'MOBILE_URL_PATH . "shopping/load_payment_module.php"', 417, 'モジュール追加用画面');
