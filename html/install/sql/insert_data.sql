...
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (83, 2, '(SELECT name FROM mtb_pref WHERE CAST(mtb_pref.id AS smallint) = dtb_customer.pref) as pref', '都道府県', 8, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                                        
...
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (93, 2, '(SELECT name FROM mtb_sex WHERE CAST(mtb_sex.id AS smallint) = dtb_customer.sex) as sex', '性別', 18, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                                            
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, status, create_date, update_date) VALUES (94, 2, '(SELECT name FROM mtb_job WHERE CAST(mtb_job.id AS smallint) = dtb_customer.job) as job', '職業', 19, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);                                            
