...
INSERT INTO dtb_csv (no, csv_id, col, disp_name, rank, rw_flg, status, create_date, update_date, mb_convert_kana_option, size_const_type, error_check_types) VALUES (110, 3, 'order_email', 'メールアドレス', 8, 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'a', 'STEXT_LEN', 'NO_SPTAB,MAX_LENGTH_CHECK,EMAIL_CHECK,EMAIL_CHAR_CHECK');
