...
INSERT INTO mtb_constants VALUES ('MOBILE_COMPILE_DIR', 'COMPILE_DIR . "mobile/"', 400,'SMARTYコンパイル(mobile)');
INSERT INTO mtb_constants VALUES ('MOBILE_SESSION_LIFETIME', '1800', 400,'セッションの存続時間 (秒)');
INSERT INTO mtb_constants VALUES ('MOBILE_USE_KARA_MAIL', 'false', 400,'空メール機能を使用するかどうか');
INSERT INTO mtb_constants VALUES ('MOBILE_KARA_MAIL_ADDRESS_USER', '"eccube"', 400,'空メール受け付けアドレスのユーザー名部分');
INSERT INTO mtb_constants VALUES ('MOBILE_KARA_MAIL_ADDRESS_DELIMITER', '"+"', 400,'空メール受け付けアドレスのユーザー名とコマンドの間の区切り文字 qmail の場合は -');
INSERT INTO mtb_constants VALUES ('MOBILE_KARA_MAIL_ADDRESS_DOMAIN', '"mobile.ec-cube.net"', 400,'空メール受け付けアドレスのドメイン部分');
INSERT INTO mtb_constants VALUES ('MOBILE_ADDITIONAL_MAIL_DOMAINS', '"rebelt.co.jp, lockon.co.jp"', 400,'携帯のメールアドレスではないが、携帯だとみなすドメインのリスト 任意の数の「,」「 」で区切る。');
INSERT INTO mtb_constants VALUES ('MOBILE_IMAGE_DIR', '"upload/mobile_image"', 400,'携帯電話向け変換画像保存ディレクトリ');
INSERT INTO mtb_constants VALUES ('MOBILE_IMAGE_URL', '"upload/mobile_image"', 400,'携帯電話向け変換画像保存ディレクトリ');
INSERT INTO mtb_constants VALUES ('MOBILE_URL_SITE_TOP', 'MOBILE_URL_DIR . "index.php"', 400,'モバイルURL');
INSERT INTO mtb_constants VALUES ('MOBILE_URL_CART_TOP', 'MOBILE_URL_DIR . "cart/index.php"', 400,'カートトップ');
INSERT INTO mtb_constants VALUES ('MOBILE_URL_SHOP_CONFIRM', 'MOBILE_SSL_URL . "shopping/index.php"', 400,'会員情報入力');
INSERT INTO mtb_constants VALUES ('MOBILE_URL_SHOP_CONFIRM', 'MOBILE_URL_DIR . "shopping/confirm.php"', 400,'購入確認ページ');
INSERT INTO mtb_constants VALUES ('MOBILE_URL_SHOP_PAYMENT', 'MOBILE_URL_DIR . "shopping/payment.php"', 400,'お支払い方法選択ページ');
INSERT INTO mtb_constants VALUES ('MOBILE_DETAIL_P_HTML', 'MOBILE_URL_DIR . "products/detail.php?product_id="', 400,'商品詳細(HTML出力)');
INSERT INTO mtb_constants VALUES ('MOBILE_URL_SHOP_COMPLETE', 'MOBILE_URL_DIR . "shopping/complete.php"', 400,'購入完了画面');
INSERT INTO mtb_constants VALUES ('MOBILE_URL_SHOP_MODULE', 'MOBILE_URL_DIR . "shopping/load_payment_module.php"', 400,'モジュール追加用画面');
