<table cellspacing="0" cellpadding="0" summary=" " id="search">
	...
	<tr>
		...
		<table width="168" cellspacing="0" cellpadding="0" summary=" ">
			<tr>
				<td><img src="../img/left/search_title.jpg" width="168" height="32" alt="商品検索" /></td>
			</tr>
		</table>
		...
		<table width="150" cellspacing="0" cellpadding="0" summary=" " border="0">
			...
			*}-->
			<tr><td height="5"></td></tr>
			<tr>
				<td align="center"><a href="#" onclick="document.search_form.submit();return false;"><img src="../img/left/search_button.gif" width="51" height="22" alt="検索" /></a></td>
			</tr>
			</form>
			<!--商品検索フォーム-->
		</table>
