...
<table width="780" border="0" cellspacing="0" cellpadding="0" summary=" ">
	<tr align="center">
		...
		<table width="762" border="0" cellspacing="0" cellpadding="0" summary=" ">
			<tr>
				<td><a href="/index.php"><img src="<!--{$TPL_PKG_URL}-->img/header/title.jpg" width="302" height="81" alt="おふとんのインターネットショッピング ふとん屋サン" border="0"></a></td>
				<td>
		...
		<table width="778" border="0" cellspacing="0" cellpadding="0" summary=" ">
			<tr><td bgcolor="#ffffff"><img src="/img/common/_.gif" width="778" height="1" alt=""></td></tr>
			<tr><td bgcolor="#ffffff"><img src="/img/common/_.gif" width="1" height="4" alt=""></td></tr>
			<tr><td bgcolor="#ffffff"><img src="/img/common/_.gif" width="778" height="1" alt=""></td></tr>
		</table>
		</td>
		<td bgcolor="#cccccc"><img src="/img/common/_.gif" width="1" height="10" alt=""></td>
