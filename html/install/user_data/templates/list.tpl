		...
		<table cellspacing="0" cellpadding="0" summary=" " id="container">
			<tr valign="top">
				...
				<tr valign="top">
					...
					<a href="<!--{$smarty.const.DETAIL_P_HTML}--><!--{$arrProducts[cnt].product_id}-->"><td align="center" valign="middle"><!--★画像★--><div id="picture"><!--商品写真--><img src="<!--{$smarty.const.IMAGE_SAVE_URL|sfTrimURL}-->/<!--{$arrProducts[cnt].main_list_image}-->" alt="<!--{$arrProducts[cnt].name|escape}-->" /></div></td></a>
					<td align="right">
