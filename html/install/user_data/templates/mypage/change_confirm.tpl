		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0" summary=" ">
			<tr valign="top">
				...
				<!--{/foreach}-->
					...
					<tr>
						<td align="center">
							<a href="<!--{$smarty.server.PHP_SELF}-->" onclick="fnModeSubmit('return', '', ''); return false;" onmouseover="chgImg('/img/common/b_back_on.gif','back');" onmouseout="chgImg('/img/common/b_back.gif','back');"><img src="<!--{$smarty.const.URL_DIR}-->img/common/b_back.gif" width="150" height="30" alt="戻る" name="change" id="change" /></a>
							<img src="<!--{$smarty.const.URL_DIR}-->img/_.gif" width="20" height="" alt="" />
							<input type="image" onmouseover="chgImgImageSubmit('/img/common/b_send_on.gif',this)" onmouseout="chgImgImageSubmit('/img/common/b_send.gif',this)" src="<!--{$smarty.const.URL_DIR}-->img/common/b_send.gif" width="150" height="30" alt="送信" name="complete" id="complete" />
						</td>
					</tr>
				</form>
				</table>
