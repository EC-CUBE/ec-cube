		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0" summary=" ">
			<tr valign="top">
				...
				<table width="515" border="0" cellspacing="0" cellpadding="0" summary=" ">
					...
					<tr>
						<td align="center"><a href="/index.php" onmouseover="chgImg('/img/common/b_toppage_on.gif','toppage');" onmouseout="chgImg('/img/common/b_toppage.gif','toppage');"><img src="<!--{$smarty.const.URL_DIR}-->img/common/b_toppage.gif" width="150" height="30" alt="トップページへ" border="0" name="toppage"></a></td>
					</tr>
				</table>
				</td>
			</tr>
