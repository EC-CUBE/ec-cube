		...
		<table width="700" border="0" cellspacing="0" cellpadding="0" summary=" ">
			<tr valign="top">
				...
				<table width="515" border="0" cellspacing="0" cellpadding="0" summary=" ">
					...
					<tr>
						<td align="center">
							<a href="./index.php" onmouseover="chgImg('/img/common/b_back_on.gif','change');" onmouseout="chgImg('/img/common/b_back.gif','change');"><img src="<!--{$smarty.const.URL_DIR}-->img/common/b_back.gif" width="150" height="30" alt="戻る" name="change" id="change" /></a>
						</td>
					</tr>
				</form>
				</table>
