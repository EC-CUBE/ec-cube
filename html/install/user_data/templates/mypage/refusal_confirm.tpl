						...
						<table width="505" border="0" cellspacing="0" cellpadding="0" summary=" ">
							...
							<tr>
								...
								<table width="465" border="0" cellspacing="0" cellpadding="0" summary=" ">
									...
									<tr>
										<td align="center">
											<a href="./refusal.php" onmouseover="chgImg('/img/mypage/b_no_on.gif','refusal_no');" onmouseout="chgImg('/img/mypage/b_no.gif','refusal_no');"><img src="/img/mypage/b_no.gif" width="180" height="30" alt="いいえ、退会しません" name="refusal_no" id="refusal_no" /></a>　
											<input type="image" onmouseover="chgImgImageSubmit('/img/mypage/b_yes_on.gif',this);" onmouseout="chgImgImageSubmit('/img/mypage/b_yes.gif',this);" src="/img/mypage/b_yes.gif" width="180" height="30" alt="はい、はい、退会します" name="refusal_yes" id="refusal_yes" />
										</td>
									</tr>
