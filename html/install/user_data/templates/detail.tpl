						...
						<table width="290" border="0" cellspacing="0" cellpadding="0" summary=" ">	
							<tr>
								...
								<!--{if $arrProduct.main_large_image != ""}-->
									<div id="picture"><a href="<!--{$smarty.server.PHP_SELF|escape}-->" onclick="win01('./detail_image.php?product_id=<!--{$arrProduct.product_id}-->&image=main_large_image<!--{if $smarty.get.admin == 'on'}-->&admin=on<!--{/if}-->','detail_image','<!--{$tpl_image_width}-->', '<!--{$tpl_image_height}-->'); return false;" target="_blank"><!--メイン画像--><!--{assign var=key value="main_image"}--><img src="<!--{$arrFile[$key].filepath}-->" alt="<!--{$arrProduct.name|escape}-->" /></a></div>
								<!--{else}-->
							...
							<tr>
								<td>
								<!--{if $arrProduct.main_large_image != ""}-->
									<!--★拡大する★--><a href="<!--{$smarty.server.PHP_SELF|escape}-->" onclick="win01('./detail_image.php?product_id=<!--{$arrProduct.product_id}-->&image=main_large_image<!--{if $smarty.get.admin == 'on'}-->&admin=on<!--{/if}-->','detail_image', '<!--{$tpl_image_width}-->', '<!--{$tpl_image_height}-->'); return false;" target="_blank"><img src="<!--{$smarty.const.URL_DIR}-->img/products/b_expansion.gif" width="85" height="13" alt="画像を拡大する" /></a>
								<!--{/if}-->
								</td>
							</tr>
						</table>		
