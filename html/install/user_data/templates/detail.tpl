	...
	<tr>
		...
		<table cellspacing="0" cellpadding="0" summary=" ">
			<tr valign="top">
				...
				<table width="580" border="0" cellspacing="0" cellpadding="0" summary=" ">
					...
					<tr valign="top">
						...
						<table width="280" border="0" cellspacing="0" cellpadding="0" summary=" ">
							...
							<tr><td height="5" colspan="2" align="center"><span class="red12st"><!--{if $arrErr.classcategory_id1 != ""}-->※ <!--{$tpl_class_name1}-->を入力して下さい。<!--{/if}--></span></td></tr>
							<tr>
							...
							<tr><td height="5" colspan="2" align="center"><span class="red12st"><!--{if $arrErr.classcategory_id2 != ""}-->※ <!--{$tpl_class_name2}-->を入力して下さい。<!--{/if}--></span></td></tr>
							<tr>
				...
				<!--{if $arrRecommend}-->
				<!--▼オススメ商品ここから-->
				<div id="osusumetitle"><img src="../img/right_product/recommend.jpg" width="570" height="33" alt="オススメ商品" /></div>
				<table cellspacing="0" cellpadding="0" summary=" " id="osusume">
					...
					<tr>
						<td height="25"><img src="/img/common/line_280.gif" width="270" height="1" alt="" /></td>
						<td id="spacer"></td>
						<td align="right"><img src="/img/common/line_280.gif" width="270" height="1" alt="" /></td>
					</tr>
					<!--{/if}-->
					<tr valign="top">
						<td>
