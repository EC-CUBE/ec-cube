		...
		<table cellspacing="0" cellpadding="0" summary=" " id="container">
			...
			<tr valign="top">
				...
				<table cellspacing="0" cellpadding="0" summary=" " id="contents">
					...
					<!--▼商品ここから-->
					<tr valign="top">
						<td id="left"><div id="picture"><a href="<!--{$smarty.const.DETAIL_P_HTML}--><!--{$arrProducts[cnt].product_id}-->.html"><!--商品写真--><img src="<!--{$smarty.const.IMAGE_SAVE_URL|sfTrimURL}-->/<!--{$arrProducts[cnt].main_list_image}-->" width="130" height="130" alt="<!--{$arrProducts[cnt].name|escape}-->" /></a></div></td>
						<td id="spacer"></td>
