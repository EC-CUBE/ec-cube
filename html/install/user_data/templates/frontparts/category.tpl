				...
				<table cellspacing="0" cellpadding="0" summary=" " id="category">
					...
					<tr>
						...
						<table width="168" cellspacing="0" cellpadding="0" summary=" ">
							<tr>
								<td><img src="<!--{$smarty.const.URL_DIR}-->img/left/category_title.jpg" width="168" height="32" alt="¥«¥Æ¥´¥ê" /></td>
							</tr>
						</table>
						</td>
						<td bgcolor="#cccccc"><img src="<!--{$smarty.const.URL_DIR}-->img/_.gif" width="1" height="10" alt="" /></td>
						...
						<table width="150" cellspacing="0" cellpadding="0" summary=" ">
							...
							<!--{if $arrCategory[cnt].level == 2}-->
								...
								<tr>
									...
									<!--{else}-->
									<td class="red12st"><a href="<!--{$smarty.const.LIST_C_HTML}--><!--{$arrCategory[cnt].category_id}-->.html" class="pan"><!--{$arrCategory[cnt].category_name|escape}-->(<!--{$arrCategory[cnt].product_count|default:0}-->)</a></td>
									<!--{/if}-->
								</tr>
							<!--{* ³¬ÁØ3 *}-->
							<!--{else}-->
								<tr>
									<td></td>
									<!--{if $arrCategory[cnt].category_id != $tpl_category_id}-->
									<td class="fs12"><a href="<!--{$smarty.const.LIST_C_HTML}--><!--{$arrCategory[cnt].category_id}-->.html" class="link01"><!--{$arrCategory[cnt].category_name|escape}-->(<!--{$arrCategory[cnt].product_count|default:0}-->)</a></td>
									<!--{else}-->
									<td class="red12st"><a href="<!--{$smarty.const.LIST_C_HTML}--><!--{$arrCategory[cnt].category_id}-->.html" class="pan"><!--{$arrCategory[cnt].category_name|escape}-->(<!--{$arrCategory[cnt].product_count|default:0}-->)</a></td>
									<!--{/if}-->
								</tr>
