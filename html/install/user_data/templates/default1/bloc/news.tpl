...
<table width="400" border="0" cellspacing="0" cellpadding="0" summary=" ">
	...
	<tr>
		<td height="10"><img src="/img/common/_.gif" width="16" height="1" alt=""></td>
		<td><img src="/img/common/_.gif" width="90" height="1" alt=""></td>
		<td><img src="/img/common/_.gif" width="294" height="1" alt=""></td>
	</tr>

	<!--{section name=data loop=$arrNews}-->
	<tr valign="top">
		<td><img src="/img/top/news_icon.gif" width="16" height="16" alt=""></td>
	...
	<tr><td colspan="3" height="20"><img src="/img/common/line_400.gif" width="400" height="1" alt=""></td></tr>
	<!--{/if}-->
	<!--{/section}-->
