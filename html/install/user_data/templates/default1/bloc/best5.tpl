...
<table width="400" border="0" cellspacing="0" cellpadding="0" summary=" ">
	<tr>
		<td colspan="2"><img src="/img/top/osusume.jpg" width="400" height="29" alt="おすすめ情報"></td>
	</tr>
	...
	<tr>
		<td height="20"><img src="/img/common/line_190.gif" width="190" height="1" alt=""></td>
		<td align="right"><img src="/img/common/line_190.gif" width="190" height="1" alt=""></td>
	</tr>
	<!--{/if}-->
