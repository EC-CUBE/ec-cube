...
<tr>
	...
	<table width="500" border="0" cellspacing="1" cellpadding="8" summary=" ">
		...
		<tr>
			...
			<input type="text" name="<!--{$key}-->" value="<!--{$arrForm[$key].value|escape}-->" maxlength="<!--{$arrForm[$key].length}-->" style="<!--{$arrErr[$key]|sfGetErrorColor}-->" <!--{if $arrForm.db_type.value == "pgsql"}-->disabled=false<!--{else}-->disabled=true<!--{/if}--> size="6" class="box6" />
			</td>
		</tr>
		<tr>
