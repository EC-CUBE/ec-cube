...
<div class="contents">
  ...
  <div class="result-info02">
        <p><!--{t string="t_You can log in to <a href='T_FIELD_01T_FIELD_02T_FIELD_03'>the management screen</a>._01" escape="none" T_FIELD_01=$tpl_sslurl T_FIELD_02=$smarty.const.ADMIN_DIR T_FIELD_03=$smarty.const.DIR_INDEX_PATH}--><br />
