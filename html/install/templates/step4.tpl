...
<div class="contents">
  ...
  <div class="result-info01">
          <ul class="site-info-list">
            ...
            <li><span class="bold">OS情報：</span><!--{""|php_uname|escape}--> <!--{$smarty.server.SERVER_SOFTWARE|escape}--></li>
          </ul>
  </div>
  <div class="result-info02">
<input type="radio" id="ok" name="send_info" checked value=true><label for="ok">はい(推奨)</label>　<input type="radio" id="ng" name="send_info" value=false><label for="ng">いいえ</label>
  </div>
</div>
<div class="btn-area-top"></div>
  <div class="btn-area">
    <ul>
        <li>
        <a class="btn-action" href="#" onclick="document.form1['mode'].value='return_step3';document.form1.submit();return false;" /><span class="btn-prev">前へ戻る</span></a></li>
         <li>
        <a class="btn-action" href="javascript:;" onclick="document.form1.submit(); return false;"><span class="btn-next">次へ進む</span></a></li>
   </ul>
