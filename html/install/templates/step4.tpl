...
<input type="hidden" name="site_url" value=<!--{$tpl_site_url}-->>
<input type="hidden" name="shop_name" value=<!--{$tpl_shop_name}-->>
<input type="hidden" name="cube_ver" value=<!--{$tpl_cube_ver}-->>
<input type="hidden" name="php_ver" value=<!--{$tpl_php_ver}-->>
<input type="hidden" name="db_ver" value=<!--{$tpl_db_ver}-->>
