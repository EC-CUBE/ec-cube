...
<tr>
	<tr><td align="left" class="fs12"><input type="checkbox" id="skip" name="db_skip" <!--{if $tpl_db_skip == "on"}-->checked<!--{/if}--> onclick="lfnOnCheckUpdate(this);"> <label for="skip">店舗情報を変更しない</label></td></tr><!--{$arrHidden.db_skip}-->
