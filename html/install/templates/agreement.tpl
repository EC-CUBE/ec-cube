	...
	<table width="500" border="0" cellspacing="1" cellpadding="8" summary=" ">
		<tr>
			...
			<div id="agreement">
				...
				<br/>
				株式会社ロックオン（以下「弊社」という）では、お客様が本ソフトウェアをご利用に<br/>
				なるためには、下記「ソフトウェア使用契約書」の内容を承諾して頂くことが条件になって<br/>
				おります。本ソフトウェアをインストールまたはコピー、ご使用になった時点で下記「ソフ<br/>
				トウェア使用許諾書」にご同意いただいたものとみなします。<br/><br/><br/>
				<br/>
				------------------------ ソフトウェア使用許諾書 ------------------------<br/><br/>
				<br/>
				1.ライセンス<br/>
				<br/>
				EC-CUBEでは製品の使用にあたって、無償のGPLライセンスと有償の商用ライセンスのどちらかを選択することができる「デュアルライセンス方式」を採用しております。各ライセンスの主な特徴は以下の通りです。<br/>
				<br/>
				1-1.GPLライセンス<br/>
				<br/>
				無償でEC-CUBEを使用することができ、複製、改変、頒布を行うことができるが、EC-CUBEを使用したアプリケーションを頒布する場合には、そのアプリケーションのソースコードを公開し、利用可能な状態にしなくてはならない。<br/>
				<br/>
				※ 改変（カスタマイズ）する際は、プログラムファイル（PHPファイル等）のヘッダー部分に記載しております著作権表示以外の箇所は全て改変いただけます。<br/>
				<br/>
				※ GPLライセンス（GNU 一般公衆利用許諾契約書)の正式な条件については、http://www.fsf.org/licenses/ （日本語訳http://www.opensource.jp/gpl/gpl.ja.html）を参照して下さい。<br/>
				<br/>
				1-2.商用ライセンス<br/>
				<br/>
				EC-CUBE商用ライセンスは、GPLライセンスに準拠したくない方向けのライセンスです。<br/>
				EC-CUBE商用ライセンスを購入いただけますと、商用ライセンスの範囲で、ご自身のアプリケーションをオープンソースにする必要はありません。<br/>
				<br/>
				※ GPLライセンスに準拠しない全てのご利用において、商用ライセンスが必要となります。<br/>
				<br/>
				※ 商用ライセンスの詳細に関しては、http://www.ec-cube.net/license/business.phpを参照して下さい。<br/>
				 <br/>
				2.免責<br/>
				<br/>
				2-1.利用者は、本ソフトウエアの使用に基づいて発生した一切の直接・間接の損害（データ滅失、サーバーダウン、業務停滞、第三者からのクレーム等）および危険はすべて利用者のみが負うことをここに確認し、同意するものとします。<br/>
				2-2.いかなる場合であっても、不法行為、契約その他いかなる法的根拠による場合でも、本ソフトウエアの供給者、再販売業者、および各情報コンテンツの提供会社は、お客様その他の第三者に対し、営業価値の喪失、業務の停止、コンピュータの故障による損害、その他あらゆる商業的損害・損失等を含め一切の直接的、間接的、特殊的、付随的または結果的損失、損害について責任を負いません。さらに、弊社は、第三者のいかなるクレームに対しても責任を負いません。<br/>
				<br/>
				3.サイト情報の収集<br/>
				<br/>
