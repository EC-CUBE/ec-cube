...
<form name="form1" id="form1" method="post" action="?">
    ...
    <table width="500" border="0" cellspacing="1" cellpadding="8" summary=" ">
        ...
        <tr>
            <td align="center">
            <a href="#" onmouseover="eccube.common.chgImg('../img/install/back_on.jpg','back')" onmouseout="eccube.common.chgImg('../img/install/back.jpg','back')" onclick="document.form1['mode'].value='return_welcome';document.form1.submit();" /><img  width="105" src="../img/install/back.jpg"  height="24" alt="前へ戻る" border="0" name="back"></a>
            <a href="#" onclick="document.form1.submit();"><input type='image' onMouseover="eccube.common.chgImgImageSubmit('../img/install/next_on.jpg',this)" onMouseout="eccube.common.chgImgImageSubmit('../img/install/next.jpg',this)" src="../img/install/next.jpg" width="105" height="24" alt="次へ進む" border="0" name="next" id="next"></a>
            </td>
        </tr>
        <tr><td height="30"></td></tr>
    </table>
