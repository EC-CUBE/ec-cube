...
<table width="500" border="0" cellspacing="1" cellpadding="8" summary=" ">
	...
	<tr>
		...
		<a href="#" onclick="document.form1.submit();" id="next_link"><image onMouseover="chgImgImageSubmit('../img/install/next_on.jpg',this)" onMouseout="chgImgImageSubmit('../img/install/next.jpg',this)" src="../img/install/next.jpg" width="105" height="24" alt="次へ進む" border="0" name="next" id="next"></a>
		</td>
	</tr>
	<tr><td height="30"></td></tr>
</from>
