...
<div class="btn-area-top"></div>
    <div class="btn-area">
        <ul>
            ...
            <li><a class="btn-action" href="javascript:;" onclick="document.body.style.cursor='wait'; document.form1.submit(); return false;"><span class="btn-next"><!--{t string="t_Next_01"}--></span></a></li>
        </ul>
    </div>
