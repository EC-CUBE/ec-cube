...
<!--
    ...
    function eccube.common.setModeAndSubmit(mode) {
        switch(mode) {
        case 'drop':
    ...
    <div class="contents">
        ...
        <div class="result-info02">
            <!--{if count($arrErr) > 0 || $tpl_message != ""}-->
                ...
                <!--{if $arrErr.all != ""}-->
                    <ul class="btn-area">
                        <li><a class="btn-normal" href="javascript:;" onclick="eccube.common.setModeAndSubmit('drop'); return false;">既存データを全て削除する</a></li>
                    </ul>
                <!--{/if}-->
            <!--{/if}-->
        </div>
