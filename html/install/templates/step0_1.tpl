...
<div class="contents">
    ...
    <div class="result-info02">
        <!--{if $hasErr}-->
            ...
            <div class="attention"><!--{t string="tpl_745"}--></div>
        <!--{else}-->
            <p class="action-message"><!--{t string="tpl_746"}--></p>
        <!--{/if}-->
    </div>
    ...
    <div class="btn-area">
        <ul>
            <li><a href="#" class="btn-action" onclick="document.form1['mode'].value='return_step0';document.form1.submit();return false;"><span class="btn-prev"><!--{t string="tpl_610"}--></span></a></li>
