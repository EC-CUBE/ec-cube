...
<table width="500" border="0" cellspacing="1" cellpadding="8" summary=" ">
	...
	<tr>
		<td align="center">
		<!--{if !$err_file}-->
		<a href="#" onmouseover="chgImg('../img/install/back_on.jpg','back')" onmouseout="chgImg('../img/install/back.jpg','back')" onclick="document.form1['mode'].value='return_agreement';document.form1.submit();" /><img  width="105" src="../img/install/back.jpg"  height="24" alt="前へ戻る" border="0" name="back"></a>
