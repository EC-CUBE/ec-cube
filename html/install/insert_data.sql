...
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(1,'product_id','商品ID',1,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(1,'product_class_id','規格ID',2,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(1,'classcategory_id1','規格名1',3,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(1,'classcategory_id2','規格名2',4,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(1,'name','商品名',5,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(1,'status','公開フラグ',6,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(1,'product_flag','商品ステータス',7,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(1,'product_code','商品コード',8,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(1,'price01','参考市場価格',9,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(1,'price02','価格',10,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(1,'stock','在庫数',11,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(1,'deliv_fee','送料',12,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(1,'point_rate','ポイント付与率',13,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(1,'sale_limit','購入制限',14,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(1,'comment1','メーカーURL',15,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(1,'comment3','検索ワード',16,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(1,'main_list_comment','一覧-メインコメント',17,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(1,'main_list_image','一覧-メイン画像',18,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(1,'main_comment','詳細-メインコメント',19,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(1,'main_image','詳細-メイン画像',20,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(1,'main_large_image','詳細-メイン拡大画像 ',21,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(1,'file1','カラー比較画像',22,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(1,'file2','商品詳細ファイル    ',23,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(1,'sub_title1','詳細-サブタイトル（1）',24,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(1,'sub_comment1','詳細-サブコメント（1）',25,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(1,'sub_image1','詳細-サブ画像（1）',26,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(1,'sub_large_image1','詳細-サブ拡大画像（1）',27,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(1,'sub_title2','詳細-サブタイトル（2）',28,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(1,'sub_comment2','詳細-サブコメント（2）',29,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(1,'sub_image2','詳細-サブ画像（2）',30,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(1,'sub_large_image2','詳細-サブ拡大画像（2）',31,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(1,'sub_title3','詳細-サブタイトル（3）',32,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(1,'sub_comment3','詳細-サブコメント（3）',33,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(1,'sub_image3','詳細-サブ画像（3）',34,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(1,'sub_large_image3','詳細-サブ拡大画像（3）',35,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(1,'sub_title4','詳細-サブタイトル（4）',36,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(1,'sub_comment4','詳細-サブコメント（4）',37,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(1,'sub_image4','詳細-サブ画像（4）',38,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(1,'sub_large_image4','詳細-サブ拡大画像（4）',39,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(1,'sub_title5','詳細-サブタイトル（5）',40,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(1,'sub_comment5','詳細-サブコメント（5）',41,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(1,'sub_image5','詳細-サブ画像（5）',42,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(1,'sub_large_image5','詳細-サブ拡大画像（5）',43,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(1,'deliv_date_id','発送日目安',44,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(1,'(SELECT recommend_product_id FROM dtb_recommend_products WHERE vw_product_class.product_id = dtb_recommend_products.product_id ORDER BY update_date DESC limit 1) AS recommend_product_id1','おすすめ商品(1)',45,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(1,'(SELECT comment FROM dtb_recommend_products WHERE vw_product_class.product_id = dtb_recommend_products.product_id ORDER BY update_date DESC limit 1) AS recommend_comment1','おすすめコメント(1)',46,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(1,'(SELECT recommend_product_id FROM dtb_recommend_products WHERE vw_product_class.product_id = dtb_recommend_products.product_id ORDER BY update_date DESC limit 1 offset 1) AS recommend_product_id2','おすすめ商品(2)',47,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(1,'(SELECT comment FROM dtb_recommend_products WHERE vw_product_class.product_id = dtb_recommend_products.product_id ORDER BY update_date DESC limit 1 offset 1) AS recommend_comment2','おすすめコメント(2)',48,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(1,'(SELECT recommend_product_id FROM dtb_recommend_products WHERE vw_product_class.product_id = dtb_recommend_products.product_id ORDER BY update_date DESC limit 1 offset 2) AS recommend_product_id3','おすすめ商品(3)',49,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(1,'(SELECT comment FROM dtb_recommend_products WHERE vw_product_class.product_id = dtb_recommend_products.product_id ORDER BY update_date DESC limit 1 offset 2) AS recommend_comment3','おすすめコメント(3)',50,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(1,'(SELECT recommend_product_id FROM dtb_recommend_products WHERE vw_product_class.product_id = dtb_recommend_products.product_id ORDER BY update_date DESC limit 1 offset 3) AS recommend_product_id4','おすすめ商品(4)',51,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(1,'(SELECT comment FROM dtb_recommend_products WHERE vw_product_class.product_id = dtb_recommend_products.product_id ORDER BY update_date DESC limit 1 offset 3) AS recommend_comment4','おすすめコメント(4)',52,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(2,'customer_id','顧客ID',1,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(2,'name01','名前1',2,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(2,'name02','名前2',3,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(2,'kana01','フリガナ1',4,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(2,'kana02','フリガナ2',5,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(2,'zip01', '郵便番号1',6,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(2,'zip02', '郵便番号2',7,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(2,'pref', '都道府県',8,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(2,'addr01', '住所1',9,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(2,'addr02', '住所2',10,now());
...
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(2,'sex', '性別',18,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(2,'job', '職業',19,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(2,'birth', '誕生日',20,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(2,'first_buy_date', '初回購入日',21,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(2,'last_buy_date', '最終購入日',22,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(2,'buy_times', '購入回数',23,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(2,'point', 'ポイント残高',24,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(2,'note', '備考',25,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(2,'create_date','登録日',26,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(2,'update_date','更新日',   27,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(3,'order_id','注文ID',1,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(3,'customer_id','顧客ID',2,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(3,'message','要望等',3,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(3,'order_name01','顧客名1',4,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(3,'order_name02','顧客名2',5,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(3,'order_kana01','顧客名カナ1',6,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(3,'order_kana02','顧客名カナ2',7,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(3,'order_email','メールアドレス',8,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(3,'order_tel01','電話番号1',9,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(3,'order_tel02','電話番号2',10,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(3,'order_tel03','電話番号3',11,now());
...
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(3,'order_zip01','郵便番号1',15,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(3,'order_zip02','郵便番号2',16,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(3,'order_pref','都道府県',17,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(3,'order_addr01','住所1',18,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(3,'order_addr02','住所2',19,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(3,'order_sex','性別',20,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(3,'order_birth','生年月日',21,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(3,'order_job','職種',22,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(3,'deliv_name01','配送先名前',23,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(3,'deliv_name02','配送先名前',24,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(3,'deliv_kana01','配送先カナ',25,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(3,'deliv_kana02','配送先カナ',26,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(3,'deliv_tel01','電話番号1',27,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(3,'deliv_tel02','電話番号2',28,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(3,'deliv_tel03','電話番号3',29,now());
...
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(3,'deliv_zip01','郵便番号1',33,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(3,'deliv_zip02','郵便番号2',34,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(3,'deliv_pref','都道府県',35,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(3,'deliv_addr01','住所1',36,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(3,'deliv_addr02','住所2',37,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(3,'subtotal','小計',38,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(3,'discount','値引き',39,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(3,'deliv_fee','送料',40,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(3,'charge','手数料',41,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(3,'use_point','使用ポイント',42,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(3,'add_point','加算ポイント',43,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(3,'tax','税金',44,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(3,'total','合計',45,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(3,'payment_total','お支払い合計',46,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(3,'payment_method','支払い方法',47,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(3,'deliv_time','配送時間',48,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(3,'deliv_no','配送伝票番号',49,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(3,'note','SHOPメモ',50,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(3,'status','対応状況',51,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(3,'create_date','注文日時',52,now());
insert into dtb_csv(csv_id,col,disp_name,rank,create_date)values(3,'update_date','更新日時',53,now());
