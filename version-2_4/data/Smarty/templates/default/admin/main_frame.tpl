...
<table width="912" border="0" cellspacing="0" cellpadding="0" summary=" ">
    <tr valign="top">
        <td><img src="<!--{$TPL_DIR}-->img/header/header_left.jpg" width="17" height="82" alt=""></td>
        <td>
        <table width="878" border="0" cellspacing="0" cellpadding="0" summary=" " background="<!--{$TPL_DIR}-->img/header/header_bg2.jpg">
            <tr valign="top">
                <td><a href="<!--{$smarty.const.URL_DIR}-->admin/home.php"><img src="<!--{$TPL_DIR}-->img/admin/header/logo.jpg" width="230" height="50" alt="EC CUBE" border="0"></a></td>
                ...
                <table border="0" cellspacing="0" cellpadding="0" summary=" ">
                    ...
                    <tr>
                        ...
                        <td><img src="<!--{$TPL_DIR}-->img/common/_.gif" width="10" height="1" alt=""></td>
                        <td><a href="<!--{$smarty.const.SITE_URL}-->" onmouseover="chgImg('<!--{$TPL_DIR}-->img/header/sitecheck_on.gif','sitecheck');" onmouseout="chgImg('<!--{$TPL_DIR}-->img/header/sitecheck.gif','sitecheck');" target="_blank"><img src="<!--{$TPL_DIR}-->img/header/sitecheck.gif" width="69" height="17" alt="SITE CHECK" border="0" name="sitecheck" id="sitecheck"></a></td>
                        <td><img src="<!--{$TPL_DIR}-->img/header/welcome.gif" width="91" height="17" alt="WELCOME!"></td>
                        <td class="fs12"><span class="whitest"><!--ログイン名--><!--{$smarty.session.login_name|escape}-->&nbsp;様</span></td>
                        <td><img src="<!--{$TPL_DIR}-->img/common/_.gif" width="10" height="1" alt=""></td>
                        <td><a href="<!--{$smarty.const.URL_LOGOUT}-->" onmouseover="chgImg('<!--{$TPL_DIR}-->img/admin/header/logout_on.gif','logout');" onmouseout="chgImg('<!--{$TPL_DIR}-->img/admin/header/logout.gif','logout');"><img src="<!--{$TPL_DIR}-->img/admin/header/logout.gif" width="56" height="15" alt="LOGOUT" border="0" name="logout" id="logout"></a></td>
                        <td><img src="<!--{$TPL_DIR}-->img/common/_.gif" width="15" height="1" alt=""></td>
                    </tr>
                </table>
                <!--ヘッダーナビ-->
            </tr>
        ...
        <td><img src="<!--{$TPL_DIR}-->img/header/header_right.jpg" width="17" height="82" alt=""></td>
    </tr>
</table>
<!--▲HEADER-->
...
<table width="912" border="0" cellspacing="0" cellpadding="0" summary=" ">
    <tr valign="top">
        ...
        <!--{if $smarty.server.PHP_SELF != $smarty.const.URL_HOME}-->
            ...
            <table width="878" border="0" cellspacing="0" cellpadding="0" summary=" ">
                <tr>
                    <!--{assign var=title_image value="`$TPL_DIR`img/title/title_`$tpl_mainno`.jpg"}-->
                    <td bgcolor="#525363"><!--タイトル画像--><img src="<!--{$title_image}-->" width="141" height="33" ></td>
                    <td background="<!--{$TPL_DIR}-->img/title/subtitle_bg.gif">
                    <table width="737" border="0" cellspacing="0" cellpadding="0" summary=" ">
                        <tr><td><img src="<!--{$TPL_DIR}-->img/title/subtitle_top.gif" width="737" height="8" alt=""></td></tr>
                        <tr>
                            <td class="fs14n"><span class="title"><!--サブタイトル--><!--{$tpl_subtitle}--></span></td>
                        </tr>
                        <tr><td><img src="<!--{$TPL_DIR}-->img/title/subtitle_bottom.gif" width="737" height="8" alt=""></td></tr>
                    </table>
                    </td>
                </tr>
                <tr><td colspan="2"><img src="<!--{$TPL_DIR}-->img/title/bar.gif" width="878" height="9" alt=""></td></tr>
            </table>
            <!--★★タイトル★★-->
        <!--{/if}-->
        <!--{include file=$tpl_mainpage}-->
        </td>
        <td background="<!--{$TPL_DIR}-->img/common/right_bg.jpg"><div align="justify" class="" id=""><img src="<!--{$TPL_DIR}-->img/common/right.jpg" width="17" height="443" alt=""></div></td>
    </tr>
</table>
<!--▲CONTENTS-->
...
<table width="912" border="0" cellspacing="0" cellpadding="0" summary=" ">
    <tr valign="top">
        <td background="<!--{$TPL_DIR}-->img/common/left_bg.jpg"><img src="<!--{$TPL_DIR}-->img/common/_.gif" width="17" height="1" alt=""></td>
        <td bgcolor="#636469">
        <table width="878" border="0" cellspacing="0" cellpadding="0" summary=" ">
            <tr>
                ...
                <table width="840" border="0" cellspacing="0" cellpadding="0" summary=" ">
                    <tr>
                        <td height="45" align="right"><a href="#top"><img src="<!--{$TPL_DIR}-->img/admin/common/pagetop.gif" width="105" height="17" alt="GO TO PAGE TOP" border="0"></a></td>
                    </tr>
                </table>
                </td>
            </tr>
        ...
        <td background="<!--{$TPL_DIR}-->img/common/right_bg.jpg"><img src="<!--{$TPL_DIR}-->img/common/_.gif" width="17" height="1" alt=""></td>
    </tr>
    <tr>
        <td colspan="3"><img src="<!--{$TPL_DIR}-->img/common/fotter.jpg" width="912" height="19" alt=""></td>
    </tr>
