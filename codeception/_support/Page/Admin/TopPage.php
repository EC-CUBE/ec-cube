...
class TopPage
{
    ...
    public static $受付状況_新規受付 = '#order-status .card-body .d-block:nth-child(1) .p-0 a'; // #order_info .link_list .tableish a:nth-child(1)
    ...
    public static $ショップ状況_在庫切れ商品 = '#shop-statistical .card-body div:nth-child(1) .p-0 a'; //'#shop_info .link_list .tableish a:nth-child(1)';
    public static $ショップ状況_会員数 = '#shop-statistical .card-body div:nth-child(3) .p-0 a'; //'#shop_info .link_list .tableish a:nth-child(2)';
