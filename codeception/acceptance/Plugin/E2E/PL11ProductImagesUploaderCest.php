...
class PL11ProductImagesUploaderCest
{
     ...
     * @return void
     */
    public function images_uploader_1(AcceptanceTester $I)
    {
    }
     ...
     * @return void
     */
    public function images_uploader_2(AcceptanceTester $I)
    {
        // 無効処理
     ...
     * @return void
     */
    public function images_uploader_3(AcceptanceTester $I)
    {
        $I->amOnPage('/admin/store/plugin');
        $recommendPluginRow = Locator::contains('//tr', '商品画像一括アップロードプラグイン');
        $I->see('商品画像一括アップロードプラグイン', $recommendPluginRow);
     ...
     * @return void
     */
    public function images_uploader_4(AcceptanceTester $I)
    {
     ...
     * @return void
     */
    public function images_uploader_5(AcceptanceTester $I)
    {
