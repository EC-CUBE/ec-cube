...
class EF02ProductCest
{
    ...
    public function product_商品詳細カート2(\AcceptanceTester $I)
    {
        ...
        $I->assertContains('「パーコレーター」は販売制限しております。一度に販売制限数を超える購入はできません。', $productPage->カートに追加());
    ...
    public function product_商品詳細カート5(\AcceptanceTester $I)
    {
        ...
        $I->assertContains('「ディナーフォーク - プラチナ - 150cm」は販売制限しております。一度に販売制限数を超える購入はできません。', $productPage->カートに追加());
